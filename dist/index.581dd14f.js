 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ot="9.17.1";function Mt(t,e={}){let n=t;if("object"!=typeof e){e={name:e}}const i=Object.assign({name:At,automaticDataCollectionEnabled:!1},e),s=i.name;if("string"!=typeof s||!s)throw Lt.create("bad-app-name",{appName:String(s)});if(n||(n=k()),!n)throw Lt.create("no-options");const r=St.get(s);if(r){if(M(n,r.options)&&M(i,r.config))return r;throw Lt.create("duplicate-app",{appName:s})}const o=new Q(s);for(const t of xt.values())o.addComponent(t);const a=new Dt(n,i,o);return St.set(s,a),a}function Pt(t=At){const e=St.get(t);if(!e&&t===At)return Mt();if(!e)throw Lt.create("no-app",{appName:t});return e}function Ut(t,e,n){var i;let s=null!==(i=Ct[t])&&void 0!==i?i:t;n&&(s+=`-${n}`);const r=s.match(/\s|\//),o=e.match(/\s|\//);if(r||o){const t=[`Unable to register library "${s}" with version "${e}":`];return r&&t.push(`library name "${s}" contains illegal characters (whitespace or "/")`),r&&o&&t.push("and"),o&&t.push(`version name "${e}" contains illegal characters (whitespace or "/")`),void It.warn(t.join(" "))}Rt(new K(`${s}-version`,(()=>({library:s,version:e})),"VERSION"))}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * limitations under the License.
 */
class Me{constructor(){this.refreshToken=null,this.accessToken=null,this.expirationTime=null}get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(t){ce(t.idToken,"internal-error"),ce(void 0!==t.idToken,"internal-error"),ce(void 0!==t.refreshToken,"internal-error");const e="expiresIn"in t&&void 0!==t.expiresIn?Number(t.expiresIn):function(t){const e=Re(t);return ce(e,"internal-error"),ce(void 0!==e.exp,"internal-error"),ce(void 0!==e.iat,"internal-error"),Number(e.exp)-Number(e.iat)}(t.idToken);this.updateTokensAndExpiration(t.idToken,t.refreshToken,e)}async getToken(t,e=!1){return ce(!this.accessToken||this.refreshToken,t,"user-token-expired"),e||!this.accessToken||this.isExpired?this.refreshToken?(await this.refresh(t,this.refreshToken),this.accessToken):null:this.accessToken}clearRefreshToken(){this.refreshToken=null}async refresh(t,e){const{accessToken:n,refreshToken:i,expiresIn:s}=await
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function tn(t,e=[]){let n;switch(t){case"Browser":n=$e(S());break;case"Worker":n=`${$e(S())}-${t}`;break;default:n=t}const i=e.length?e.join(","):"FirebaseCore-web";return`${n}/JsCore/${Ot}/${i}`}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Di=new ye(3e4,6e4);function Oi(){const t=Wn().___jsl;if(null==t?void 0:t.H)for(const e of Object.keys(t.H))if(t.H[e].r=t.H[e].r||[],t.H[e].L=t.H[e].L||[],t.H[e].r=[...t.H[e].L],t.CP)for(let e=0;e<t.CP.length;e++)t.CP[e]=null}let Mi=null;function Pi(t){return Mi=Mi||function(t){return new Promise(((e,n)=>{var i,s,r;function o(){Oi(),gapi.load("gapi.iframes",{callback:()=>{e(gapi.iframes.getContext())},ontimeout:()=>{Oi(),n(re(t,"network-request-failed"))},timeout:Di.get()})}if(null===(s=null===(i=Wn().gapi)||void 0===i?void 0:i.iframes)||void 0===s?void 0:s.Iframe)e(gapi.iframes.getContext());else{if(!(null===(r=Wn().gapi)||void 0===r?void 0:r.load)){const e=ci("iframefcb");return Wn()[e]=()=>{gapi.load?o():n(re(t,"network-request-failed"))},ai(`https://apis.google.com/js/api.js?onload=${e}`).catch((t=>n(t)))}o()}})).catch((t=>{throw Mi=null,t}))}(t),Mi}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Pc{static R(){const t="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",e=Math.floor(256/t.length)*t.length;let n="";for(;n.length<20;){const i=Mc(40);for(let s=0;s<i.length;++s)n.length<20&&i[s]<e&&(n+=t.charAt(i[s]%t.length))}return n}}function Uc(t,e){return t<e?-1:t>e?1:0}function Fc(t,e,n){return t.length===e.length&&t.every(((t,i)=>n(t,e[i])))}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Mu(t,e){if(t.wt){if(isNaN(e))return{doubleValue:"NaN"};if(e===1/0)return{doubleValue:"Infinity"};if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:ul(e)?"-0":e}}function Pu(t){return{integerValue:""+t}}function Uu(t,e){return hl(e)?Pu(e):Mu(t,e)}
/**
 * @license
 * Copyright 2018 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $d{constructor(t,e){this.Vs={},this.overlays={},this.Ss=new il(0),this.Ds=!1,this.Ds=!0,this.referenceDelegate=t(this),this.Cs=new Bd(this),this.indexManager=new Sd,this.remoteDocumentCache=function(t){return new Vd(t)}((t=>this.referenceDelegate.xs(t))),this.yt=new Id(e),this.Ns=new Od(this.yt)}start(){return Promise.resolve()}shutdown(){return this.Ds=!1,Promise.resolve()}get started(){return this.Ds}setDatabaseDeletedListener(){}setNetworkEnabled(){}getIndexManager(t){return this.indexManager}getDocumentOverlayCache(t){let e=this.overlays[t.toKey()];return e||(e=new Md,this.overlays[t.toKey()]=e),e}getMutationQueue(t,e){let n=this.Vs[t.toKey()];return n||(n=new Fd(e,this.referenceDelegate),this.Vs[t.toKey()]=n),n}getTargetCache(){return this.Cs}getRemoteDocumentCache(){return this.remoteDocumentCache}getBundleCache(){return this.Ns}runTransaction(t,e,n){vc("MemoryPersistence","Starting transaction:",t);const i=new Hd(this.Ss.next());return this.referenceDelegate.ks(),n(i).next((t=>this.referenceDelegate.Os(i).next((()=>t)))).toPromise().then((t=>(i.raiseOnCommittedEvent(),t)))}Ms(t,e){return el.or(Object.values(this.Vs).map((n=>()=>n.containsKey(t,e))))}}class Hd extends Zc{constructor(t){super(),this.currentSequenceNumber=t}}class zd{constructor(t){this.persistence=t,this.Fs=new Pd,this.$s=null}static Bs(t){return new zd(t)}get Ls(){if(this.$s)return this.$s;throw Tc()}addReference(t,e,n){return this.Fs.addReference(n,e),this.Ls.delete(n.toString()),el.resolve()}removeReference(t,e,n){return this.Fs.removeReference(n,e),this.Ls.add(n.toString()),el.resolve()}markPotentiallyOrphaned(t,e){return this.Ls.add(e.toString()),el.resolve()}removeTarget(t,e){this.Fs.ls(e.targetId).forEach((t=>this.Ls.add(t.toString())));const n=this.persistence.getTargetCache();return n.getMatchingKeysForTargetId(t,e.targetId).next((t=>{t.forEach((t=>this.Ls.add(t.toString())))})).next((()=>n.removeTargetData(t,e)))}ks(){this.$s=new Set}Os(t){const e=this.persistence.getRemoteDocumentCache().newChangeBuffer();return el.forEach(this.Ls,(n=>{const i=Kc.fromPath(n);return this.qs(t,i).next((t=>{t||e.removeEntry(i,jc.min())}))})).next((()=>(this.$s=null,e.apply(t))))}updateLimboDocument(t,e){return this.qs(t,e).next((t=>{t?this.Ls.delete(e.toString()):this.Ls.add(e.toString())}))}xs(t){return 0}qs(t,e){return el.or([()=>el.resolve(this.Fs.containsKey(e)),()=>this.persistence.getTargetCache().containsKey(t,e),()=>this.persistence.Ms(t,e)])}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function hg(t){t=Vp(t,zp);const e=Vp(t.firestore,cm);return sm(um(e),t._key).then((n=>_g(e,t,n)))}class dg extends sg{constructor(t){super(),this.firestore=t}convertBytes(t){return new dm(t)}convertReference(t){const e=this.convertDocumentKey(t,this.firestore._databaseId);return new zp(this.firestore,null,e)}}function fg(t){t=Vp(t,Kp);const e=Vp(t.firestore,cm),n=um(e),i=new dg(e);return $m(t._query),rm(n,t._query).then((n=>new lg(e,i,t,n)))}function pg(t,e,n){t=Vp(t,zp);const i=Vp(t.firestore,cm),s=rg(t.converter,e,n);return vg(i,[Em(Tm(i),"setDoc",t._key,s,null!==t.converter,n).toMutation(t._key,Zu.none())])}function mg(t,e,n,...i){t=Vp(t,zp);const s=Vp(t.firestore,cm),r=Tm(s);let o;return o="string"==typeof(e=z(e))||e instanceof fm?xm(r,"updateDoc",t._key,e,n,i):Sm(r,"updateDoc",t._key,e),vg(s,[o.toMutation(t._key,Zu.exists(!0))])}function gg(t,e){const n=Vp(t.firestore,cm),i=Qp(t),s=rg(t.converter,e);return vg(n,[Em(Tm(t.firestore),"addDoc",i._key,s,null!==t.converter,{}).toMutation(i._key,Zu.exists(!1))]).then((()=>i))}function yg(t,...e){var n,i,s;t=z(t);let r={includeMetadataChanges:!1},o=0;"object"!=typeof e[o]||am(e[o])||(r=e[o],o++);const a={includeMetadataChanges:r.includeMetadataChanges};if(am(e[o])){const t=e[o];e[o]=null===(n=t.next)||void 0===n?void 0:n.bind(t),e[o+1]=null===(i=t.error)||void 0===i?void 0:i.bind(t),e[o+2]=null===(s=t.complete)||void 0===s?void 0:s.bind(t)}let c,l,u;if(t instanceof zp)l=Vp(t.firestore,cm),u=wu(t._key.path),c={next:n=>{e[o]&&e[o](_g(l,t,n))},error:e[o+1],complete:e[o+2]};else{const n=Vp(t,Kp);l=Vp(n.firestore,cm),u=n._query;const i=new dg(l);c={next:t=>{e[o]&&e[o](new lg(l,i,n,t))},error:e[o+1],complete:e[o+2]},$m(t._query)}return function(t,e,n,i){const s=new Xp(i),r=new ap(e,s,n);return t.asyncQueue.enqueueAndForget((async()=>np(await im(t),r))),()=>{s.bc(),t.asyncQueue.enqueueAndForget((async()=>ip(await im(t),r)))}}(um(l),u,a,c)}function vg(t,e){return function(t,e){const n=new Cc;return t.asyncQueue.enqueueAndForget((async()=>async function(t,e,n){const i=Lp(t);try{const t=await function(t,e){const n=kc(t),i=Vc.now(),s=e.reduce(((t,e)=>t.add(e.key)),Nh());let r,o;return n.persistence.runTransaction("Locally write mutations","readwrite",(t=>{let a=bh(),c=Nh();return n.Gi.getEntries(t,s).next((t=>{a=t,a.forEach(((t,e)=>{e.isValidDocument()||(c=c.add(t))}))})).next((()=>n.localDocuments.getOverlayedDocuments(t,a))).next((s=>{r=s;const o=[];for(const t of e){const e=rh(t,r.get(t.key).overlayedDocument);null!=e&&o.push(new ch(t.key,e,hu(e.value.mapValue),Zu.exists(!0)))}return n.mutationQueue.addMutationBatch(t,i,o,e)})).next((e=>{o=e;const i=e.applyToLocalDocumentSet(r,c);return n.documentOverlayCache.saveOverlays(t,e.batchId,i)}))})).then((()=>({batchId:o.batchId,changes:kh(r)})))}(i.localStore,e);i.sharedClientState.addPendingMutation(t.batchId),function(t,e,n){let i=t.hc[t.currentUser.toKey()];i||(i=new su(Uc)),i=i.insert(e,n),t.hc[t.currentUser.toKey()]=i}(i,t.batchId,n),await xp(i,t.changes),await Mf(i.remoteStore)}catch(t){const e=Xf(t,"Failed to persist write");n.reject(e)}}(await nm(t),e,n))),n.promise}(um(t),e)}function _g(t,e,n){const i=n.docs.get(e._key),s=new dg(t);return new ag(t,s,e._key,i,new og(n.hasPendingWrites,n.fromCache),e.converter)}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wg(){return new Am("serverTimestamp")}function bg(...t){return new Cm("arrayUnion",t)}!function(t,e=!0){mc=Ot,Rt(new K("firestore",((t,{instanceIdentifier:n,options:i})=>{const s=t.getProvider("app").getImmediate(),r=new cm(new Rc(t.getProvider("auth-internal")),new Oc(t.getProvider("app-check-internal")),function(t,e){if(!Object.prototype.hasOwnProperty.apply(t.options,["projectId"]))throw new Ac(Ic.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new rl(t.options.projectId,e)}(s,n),s);return i=Object.assign({useFetchStreams:e},i),r._setSettings(i),r}),"PUBLIC").setMultipleInstances(!0)),Ut(fc,"3.8.3",t),Ut(fc,"3.8.3","esm2017")}();
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
const Tg="firebasestorage.googleapis.com",Eg="storageBucket";
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class kg extends q{constructor(t,e,n=0){super(xg(t),`Firebase Storage: ${e} (${xg(t)})`),this.status_=n,this.customData={serverResponse:null},this._baseMessage=this.message,Object.setPrototypeOf(this,kg.prototype)}get status(){return this.status_}set status(t){this.status_=t}_codeEquals(t){return xg(t)===this.code}get serverResponse(){return this.customData.serverResponse}set serverResponse(t){this.customData.serverResponse=t,this.customData.serverResponse?this.message=`${this._baseMessage}\n${this.customData.serverResponse}`:this.message=this._baseMessage}}var Ig,Ag,Cg,Sg;function xg(t){return"storage/"+t}function Ng(){return new kg(Ig.UNKNOWN,"An unknown error occurred, please check the error payload for server response.")}function Rg(){return new kg(Ig.RETRY_LIMIT_EXCEEDED,"Max retry time for operation exceeded, please try again.")}function qg(){return new kg(Ig.CANCELED,"User canceled the upload/download.")}function Lg(t){return new kg(Ig.INVALID_ARGUMENT,t)}function Dg(){return new kg(Ig.APP_DELETED,"The Firebase app was deleted.")}function Og(t){throw new kg(Ig.INTERNAL_ERROR,"Internal error: "+t)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ug(t){return"string"==typeof t||t instanceof String}function Fg(t,e,n,i){if(i<e)throw Lg(`Invalid value for '${t}'. Expected ${e} or greater.`);if(i>n)throw Lg(`Invalid value for '${t}'. Expected ${n} or less.`)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vg(t,e,n){let i=e;return null==n&&(i=`https://${e}`),`${n}://${i}/v0${t}`}function jg(t){const e=encodeURIComponent;let n="?";for(const i in t)if(t.hasOwnProperty(i)){n=n+(e(i)+"="+e(t[i]))+"&"}return n=n.slice(0,-1),n}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(Sg=Cg||(Cg={}))[Sg.NO_ERROR=0]="NO_ERROR",Sg[Sg.NETWORK_ERROR=1]="NETWORK_ERROR",Sg[Sg.ABORT=2]="ABORT";class $g{constructor(t,e,n,i,s,r,o,a,c,l,u,h=!0){this.url_=t,this.method_=e,this.headers_=n,this.body_=i,this.successCodes_=s,this.additionalRetryCodes_=r,this.callback_=o,this.errorCallback_=a,this.timeout_=c,this.progressCallback_=l,this.connectionFactory_=u,this.retry=h,this.pendingConnection_=null,this.backoffId_=null,this.canceled_=!1,this.appDelete_=!1,this.promise_=new Promise(((t,e)=>{this.resolve_=t,this.reject_=e,this.start_()}))}start_(){const t=(t,e)=>{const n=this.resolve_,i=this.reject_,s=e.connection;if(e.wasSuccessCode)try{const t=this.callback_(s,s.getResponse());void 0!==t?n(t):n()}catch(t){i(t)}else if(null!==s){const t=Ng();t.serverResponse=s.getErrorText(),this.errorCallback_?i(this.errorCallback_(s,t)):i(t)}else if(e.canceled){i(this.appDelete_?Dg():qg())}else{i(Rg())}};this.canceled_?t(0,new Hg(!1,null,!0)):this.backoffId_=function(t,e,n){let i=1,s=null,r=null,o=!1,a=0;function c(){return 2===a}let l=!1;function u(...t){l||(l=!0,e.apply(null,t))}function h(e){s=setTimeout((()=>{s=null,t(f,c())}),e)}function d(){r&&clearTimeout(r)}function f(t,...e){if(l)return void d();if(t)return d(),void u.call(null,t,...e);if(c()||o)return d(),void u.call(null,t,...e);let n;i<64&&(i*=2),1===a?(a=2,n=0):n=1e3*(i+Math.random()),h(n)}let p=!1;function m(t){p||(p=!0,d(),l||(null!==s?(t||(a=2),clearTimeout(s),h(0)):t||(a=1)))}return h(0),r=setTimeout((()=>{o=!0,m(!0)}),n),m}(((t,e)=>{if(e)return void t(!1,new Hg(!1,null,!0));const n=this.connectionFactory_();this.pendingConnection_=n;const i=t=>{const e=t.loaded,n=t.lengthComputable?t.total:-1;null!==this.progressCallback_&&this.progressCallback_(e,n)};null!==this.progressCallback_&&n.addUploadProgressListener(i),n.send(this.url_,this.method_,this.body_,this.headers_).then((()=>{null!==this.progressCallback_&&n.removeUploadProgressListener(i),this.pendingConnection_=null;const e=n.getErrorCode()===Cg.NO_ERROR,s=n.getStatus();if(!e||Bg(s,this.additionalRetryCodes_)&&this.retry){const e=n.getErrorCode()===Cg.ABORT;return void t(!1,new Hg(!1,null,e))}const r=-1!==this.successCodes_.indexOf(s);t(!0,new Hg(r,n))}))}),t,this.timeout_)}getPromise(){return this.promise_}cancel(t){this.canceled_=!0,this.appDelete_=t||!1,null!==this.backoffId_&&(0,this.backoffId_)(!1),null!==this.pendingConnection_&&this.pendingConnection_.abort()}}class Hg{constructor(t,e,n){this.wasSuccessCode=t,this.connection=e,this.canceled=!!n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Kg(t){const e=t.lastIndexOf("/",t.length-2);return-1===e?t:t.slice(e+1)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Gg(t,e){return e}class Wg{constructor(t,e,n,i){this.server=t,this.local=e||t,this.writable=!!n,this.xform=i||Gg}}let Qg=null;function Xg(){if(Qg)return Qg;const t=[];t.push(new Wg("bucket")),t.push(new Wg("generation")),t.push(new Wg("metageneration")),t.push(new Wg("name","fullPath",!0));const e=new Wg("name");e.xform=function(t,e){return function(t){return!Ug(t)||t.length<2?t:Kg(t)}(e)},t.push(e);const n=new Wg("size");return n.xform=function(t,e){return void 0!==e?Number(e):e},t.push(n),t.push(new Wg("timeCreated")),t.push(new Wg("updated")),t.push(new Wg("md5Hash",null,!0)),t.push(new Wg("cacheControl",null,!0)),t.push(new Wg("contentDisposition",null,!0)),t.push(new Wg("contentEncoding",null,!0)),t.push(new Wg("contentLanguage",null,!0)),t.push(new Wg("contentType",null,!0)),t.push(new Wg("metadata","customMetadata",!0)),Qg=t,Qg}function Yg(t,e,n){const i={type:"file"},s=n.length;for(let t=0;t<s;t++){const s=n[t];i[s.local]=s.xform(i,e[s.server])}return function(t,e){Object.defineProperty(t,"ref",{get:function(){const n=t.bucket,i=t.fullPath,s=new Mg(n,i);return e._makeStorageReference(s)}})}(i,t),i}function Jg(t,e,n){const i=zg(e);if(null===i)return null;return Yg(t,i,n)}class Zg{constructor(t,e,n,i){this.url=t,this.method=e,this.handler=n,this.timeout=i,this.urlParams={},this.headers={},this.body=null,this.errorHandler=null,this.progressCallback=null,this.successCodes=[200],this.additionalRetryCodes=[]}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ty(t){if(!t)throw Ng()}function ey(t,e){return function(n,i){const s=Jg(t,i,e);return ty(null!==s),function(t,e,n,i){const s=zg(e);if(null===s)return null;if(!Ug(s.downloadTokens))return null;const r=s.downloadTokens;if(0===r.length)return null;const o=encodeURIComponent;return r.split(",").map((e=>{const s=t.bucket,r=t.fullPath;return Vg("/b/"+o(s)+"/o/"+o(r),n,i)+jg({alt:"media",token:e})}))[0]}(s,i,t.host,t._protocol)}}function ny(t){return function(e,n){let i;var s,r;return 401===e.getStatus()?i=e.getErrorText().includes("Firebase App Check token is invalid")?new kg(Ig.UNAUTHORIZED_APP,"This app does not have permission to access Firebase Storage on this project."):new kg(Ig.UNAUTHENTICATED,"User is not authenticated, please authenticate using Firebase Authentication and try again."):402===e.getStatus()?(r=t.bucket,i=new kg(Ig.QUOTA_EXCEEDED,"Quota for bucket '"+r+"' exceeded, please view quota on https://firebase.google.com/pricing/.")):403===e.getStatus()?(s=t.path,i=new kg(Ig.UNAUTHORIZED,"User does not have permission to access '"+s+"'.")):i=n,i.status=e.getStatus(),i.serverResponse=n.serverResponse,i}}function iy(t){const e=ny(t);return function(n,i){let s=e(n,i);var r;return 404===n.getStatus()&&(r=t.path,s=new kg(Ig.OBJECT_NOT_FOUND,"Object '"+r+"' does not exist.")),s.serverResponse=i.serverResponse,s}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class cy{constructor(t,e){this._service=t,this._location=e instanceof Mg?e:Mg.makeFromUrl(e,t.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(t,e){return new cy(t,e)}get root(){const t=new Mg(this._location.bucket,"");return this._newRef(this._service,t)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return Kg(this._location.path)}get storage(){return this._service}get parent(){const t=function(t){if(0===t.length)return null;const e=t.lastIndexOf("/");return-1===e?"":t.slice(0,e)}(this._location.path);if(null===t)return null;const e=new Mg(this._location.bucket,t);return new cy(this._service,e)}_throwIfRoot(t){if(""===this._location.path)throw function(t){return new kg(Ig.INVALID_ROOT_OPERATION,"The operation '"+t+"' cannot be performed on a root reference, create a non-root reference using child, such as .child('file.png').")}(t)}}function ly(t){t._throwIfRoot("getDownloadURL");const e=function(t,e,n){const i=Vg(e.fullServerUrl(),t.host,t._protocol),s=t.maxOperationRetryTime,r=new Zg(i,"GET",ey(t,n),s);return r.errorHandler=iy(e),r}(t.storage,t._location,Xg());return t.storage.makeRequestWithTokens(e,ay).then((t=>{if(null===t)throw new kg(Ig.NO_DOWNLOAD_URL,"The given file does not have any download URLs.");return t}))}function uy(t,e){const n=function(t,e){const n=e.split("/").filter((t=>t.length>0)).join("/");return 0===t.length?n:t+"/"+n}(t._location.path,e),i=new Mg(t._location.bucket,n);return new cy(t.storage,i)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function hy(t,e){if(t instanceof py){const n=t;if(null==n._bucket)throw new kg(Ig.NO_DEFAULT_BUCKET,"No default bucket found. Did you set the '"+Eg+"' property when initializing the app?");const i=new cy(n,n._bucket);return null!=e?hy(i,e):i}return void 0!==e?uy(t,e):t}function dy(t,e){if(e&&/^[A-Za-z]+:\/\//.test(e)){if(t instanceof py)return new cy(t,e);throw Lg("To use ref(service, url), the first argument must be a Storage instance.")}return hy(t,e)}function fy(t,e){const n=null==e?void 0:e[Eg];return null==n?null:Mg.makeFromBucketSpec(n,t)}class py{constructor(t,e,n,i,s){this.app=t,this._authProvider=e,this._appCheckProvider=n,this._url=i,this._firebaseVersion=s,this._bucket=null,this._host=Tg,this._protocol="https",this._appId=null,this._deleted=!1,this._maxOperationRetryTime=12e4,this._maxUploadRetryTime=6e5,this._requests=new Set,this._bucket=null!=i?Mg.makeFromBucketSpec(i,this._host):fy(this._host,this.app.options)}get host(){return this._host}set host(t){this._host=t,null!=this._url?this._bucket=Mg.makeFromBucketSpec(this._url,t):this._bucket=fy(t,this.app.options)}get maxUploadRetryTime(){return this._maxUploadRetryTime}set maxUploadRetryTime(t){Fg("time",0,Number.POSITIVE_INFINITY,t),this._maxUploadRetryTime=t}get maxOperationRetryTime(){return this._maxOperationRetryTime}set maxOperationRetryTime(t){Fg("time",0,Number.POSITIVE_INFINITY,t),this._maxOperationRetryTime=t}async _getAuthToken(){if(this._overrideAuthToken)return this._overrideAuthToken;const t=this._authProvider.getImmediate({optional:!0});if(t){const e=await t.getToken();if(null!==e)return e.accessToken}return null}async _getAppCheckToken(){const t=this._appCheckProvider.getImmediate({optional:!0});if(t){return(await t.getToken()).token}return null}_delete(){return this._deleted||(this._deleted=!0,this._requests.forEach((t=>t.cancel())),this._requests.clear()),Promise.resolve()}_makeStorageReference(t){return new cy(this,t)}_makeRequest(t,e,n,i,s=!0){if(this._deleted)return new Pg(Dg());{const r=function(t,e,n,i,s,r,o=!0){const a=jg(t.urlParams),c=t.url+a,l=Object.assign({},t.headers);return function(t,e){e&&(t["X-Firebase-GMPID"]=e)}(l,e),function(t,e){null!==e&&e.length>0&&(t.Authorization="Firebase "+e)}(l,n),function(t,e){t["X-Firebase-Storage-Version"]="webjs/"+(null!=e?e:"AppManager")}(l,r),function(t,e){null!==e&&(t["X-Firebase-AppCheck"]=e)}(l,i),new $g(c,t.method,l,t.body,t.successCodes,t.additionalRetryCodes,t.handler,t.errorHandler,t.timeout,t.progressCallback,s,o)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(t,this._appId,n,i,e,this._firebaseVersion,s);return this._requests.add(r),r.getPromise().then((()=>this._requests.delete(r)),(()=>this._requests.delete(r))),r}}async makeRequestWithTokens(t,e){const[n,i]=await Promise.all([this._getAuthToken(),this._getAppCheckToken()]);return this._makeRequest(t,e,n,i).getPromise()}}const my="@firebase/storage",gy="0.11.1",yy="storage";function vy(t){return ly(t=z(t))}function _y(t,e){return dy(t=z(t),e)}function wy(t,{instanceIdentifier:e}){const n=t.getProvider("app").getImmediate(),i=t.getProvider("auth-internal"),s=t.getProvider("app-check-internal");return new py(n,i,s,e,Ot)}function by(t){return t}Rt(new K(yy,wy,"PUBLIC").setMultipleInstances(!0)),Ut(my,gy,""),Ut(my,gy,"esm2017");var Ty=1,Ey=2,ky=3,Iy=4,Ay=1e-6;function Cy(t){return"translate("+t+",0)"}function Sy(t){return"translate(0,"+t+")"}function xy(t){return e=>+t(e)}function Ny(t,e){return e=Math.max(0,t.bandwidth()-2*e)/2,t.round()&&(e=Math.round(e)),n=>+t(n)+e}function Ry(){return!this.__axis}function qy(t,e){var n=[],i=null,s=null,r=6,o=6,a=3,c="undefined"!=typeof window&&window.devicePixelRatio>1?0:.5,l=t===Ty||t===Iy?-1:1,u=t===Iy||t===Ey?"x":"y",h=t===Ty||t===ky?Cy:Sy;function d(d){var f=null==i?e.ticks?e.ticks.apply(e,n):e.domain():i,p=null==s?e.tickFormat?e.tickFormat.apply(e,n):by:s,m=Math.max(r,0)+a,g=e.range(),y=+g[0]+c,v=+g[g.length-1]+c,_=(e.bandwidth?Ny:xy)(e.copy(),c),w=d.selection?d.selection():d,b=w.selectAll(".domain").data([null]),T=w.selectAll(".tick").data(f,e).order(),E=T.exit(),k=T.enter().append("g").attr("class","tick"),I=T.select("line"),A=T.select("text");b=b.merge(b.enter().insert("path",".tick").attr("class","domain").attr("stroke","currentColor")),T=T.merge(k),I=I.merge(k.append("line").attr("stroke","currentColor").attr(u+"2",l*r)),A=A.merge(k.append("text").attr("fill","currentColor").attr(u,l*m).attr("dy",t===Ty?"0em":t===ky?"0.71em":"0.32em")),d!==w&&(b=b.transition(d),T=T.transition(d),I=I.transition(d),A=A.transition(d),E=E.transition(d).attr("opacity",Ay).attr("transform",(function(t){return isFinite(t=_(t))?h(t+c):this.getAttribute("transform")})),k.attr("opacity",Ay).attr("transform",(function(t){var e=this.parentNode.__axis;return h((e&&isFinite(e=e(t))?e:_(t))+c)}))),E.remove(),b.attr("d",t===Iy||t===Ey?o?"M"+l*o+","+y+"H"+c+"V"+v+"H"+l*o:"M"+c+","+y+"V"+v:o?"M"+y+","+l*o+"V"+c+"H"+v+"V"+l*o:"M"+y+","+c+"H"+v),T.attr("opacity",1).attr("transform",(function(t){return h(_(t)+c)})),I.attr(u+"2",l*r),A.attr(u,l*m).text(p),w.filter(Ry).attr("fill","none").attr("font-size",10).attr("font-family","sans-serif").attr("text-anchor",t===Ey?"start":t===Iy?"end":"middle"),w.each((function(){this.__axis=_}))}return d.scale=function(t){return arguments.length?(e=t,d):e},d.ticks=function(){return n=Array.from(arguments),d},d.tickArguments=function(t){return arguments.length?(n=null==t?[]:Array.from(t),d):n.slice()},d.tickValues=function(t){return arguments.length?(i=null==t?null:Array.from(t),d):i&&i.slice()},d.tickFormat=function(t){return arguments.length?(s=t,d):s},d.tickSize=function(t){return arguments.length?(r=o=+t,d):r},d.tickSizeInner=function(t){return arguments.length?(r=+t,d):r},d.tickSizeOuter=function(t){return arguments.length?(o=+t,d):o},d.tickPadding=function(t){return arguments.length?(a=+t,d):a},d.offset=function(t){return arguments.length?(c=+t,d):c},d}var Ly={value:()=>{}};function Dy(){for(var t,e=0,n=arguments.length,i={};e<n;++e){if(!(t=arguments[e]+"")||t in i||/[\s.]/.test(t))throw new Error("illegal type: "+t);i[t]=[]}return new Oy(i)}function Oy(t){this._=t}function My(t,e){for(var n,i=0,s=t.length;i<s;++i)if((n=t[i]).name===e)return n.value}function Py(t,e,n){for(var i=0,s=t.length;i<s;++i)if(t[i].name===e){t[i]=Ly,t=t.slice(0,i).concat(t.slice(i+1));break}return null!=n&&t.push({name:e,value:n}),t}Oy.prototype=Dy.prototype={constructor:Oy,on:function(t,e){var n,i,s=this._,r=(i=s,(t+"").trim().split(/^|\s+/).map((function(t){var e="",n=t.indexOf(".");if(n>=0&&(e=t.slice(n+1),t=t.slice(0,n)),t&&!i.hasOwnProperty(t))throw new Error("unknown type: "+t);return{type:t,name:e}}))),o=-1,a=r.length;if(!(arguments.length<2)){if(null!=e&&"function"!=typeof e)throw new Error("invalid callback: "+e);for(;++o<a;)if(n=(t=r[o]).type)s[n]=Py(s[n],t.name,e);else if(null==e)for(n in s)s[n]=Py(s[n],t.name,null);return this}for(;++o<a;)if((n=(t=r[o]).type)&&(n=My(s[n],t.name)))return n},copy:function(){var t={},e=this._;for(var n in e)t[n]=e[n].slice();return new Oy(t)},call:function(t,e){if((n=arguments.length-2)>0)for(var n,i,s=new Array(n),r=0;r<n;++r)s[r]=arguments[r+2];if(!this._.hasOwnProperty(t))throw new Error("unknown type: "+t);for(r=0,n=(i=this._[t]).length;r<n;++r)i[r].value.apply(e,s)},apply:function(t,e,n){if(!this._.hasOwnProperty(t))throw new Error("unknown type: "+t);for(var i=this._[t],s=0,r=i.length;s<r;++s)i[s].value.apply(e,n)}};var Uy=Dy;function Fy(){}function Vy(t){return null==t?Fy:function(){return this.querySelector(t)}}function jy(){return[]}function By(t){return null==t?jy:function(){return this.querySelectorAll(t)}}function $y(t){return function(){return null==(e=t.apply(this,arguments))?[]:Array.isArray(e)?e:Array.from(e);var e}}function Hy(t){return function(){return this.matches(t)}}function zy(t){return function(e){return e.matches(t)}}var Ky=Array.prototype.find;function Gy(){return this.firstElementChild}var Wy=Array.prototype.filter;function Qy(){return Array.from(this.children)}function Xy(t){return new Array(t.length)}function Yy(t,e){this.ownerDocument=t.ownerDocument,this.namespaceURI=t.namespaceURI,this._next=null,this._parent=t,this.__data__=e}function Jy(t,e,n,i,s,r){for(var o,a=0,c=e.length,l=r.length;a<l;++a)(o=e[a])?(o.__data__=r[a],i[a]=o):n[a]=new Yy(t,r[a]);for(;a<c;++a)(o=e[a])&&(s[a]=o)}function Zy(t,e,n,i,s,r,o){var a,c,l,u=new Map,h=e.length,d=r.length,f=new Array(h);for(a=0;a<h;++a)(c=e[a])&&(f[a]=l=o.call(c,c.__data__,a,e)+"",u.has(l)?s[a]=c:u.set(l,c));for(a=0;a<d;++a)l=o.call(t,r[a],a,r)+"",(c=u.get(l))?(i[a]=c,c.__data__=r[a],u.delete(l)):n[a]=new Yy(t,r[a]);for(a=0;a<h;++a)(c=e[a])&&u.get(f[a])===c&&(s[a]=c)}function tv(t){return t.__data__}function ev(t){return"object"==typeof t&&"length"in t?t:Array.from(t)}function nv(t,e){return t<e?-1:t>e?1:t>=e?0:NaN}Yy.prototype={constructor:Yy,appendChild:function(t){return this._parent.insertBefore(t,this._next)},insertBefore:function(t,e){return this._parent.insertBefore(t,e)},querySelector:function(t){return this._parent.querySelector(t)},querySelectorAll:function(t){return this._parent.querySelectorAll(t)}};var iv="http://www.w3.org/1999/xhtml",sv={svg:"http://www.w3.org/2000/svg",xhtml:iv,xlink:"http://www.w3.org/1999/xlink",xml:"http://www.w3.org/XML/1998/namespace",xmlns:"http://www.w3.org/2000/xmlns/"};function rv(t){var e=t+="",n=e.indexOf(":");return n>=0&&"xmlns"!==(e=t.slice(0,n))&&(t=t.slice(n+1)),sv.hasOwnProperty(e)?{space:sv[e],local:t}:t}function ov(t){return function(){this.removeAttribute(t)}}function av(t){return function(){this.removeAttributeNS(t.space,t.local)}}function cv(t,e){return function(){this.setAttribute(t,e)}}function lv(t,e){return function(){this.setAttributeNS(t.space,t.local,e)}}function uv(t,e){return function(){var n=e.apply(this,arguments);null==n?this.removeAttribute(t):this.setAttribute(t,n)}}function hv(t,e){return function(){var n=e.apply(this,arguments);null==n?this.removeAttributeNS(t.space,t.local):this.setAttributeNS(t.space,t.local,n)}}function dv(t){return t.ownerDocument&&t.ownerDocument.defaultView||t.document&&t||t.defaultView}function fv(t){return function(){this.style.removeProperty(t)}}function pv(t,e,n){return function(){this.style.setProperty(t,e,n)}}function mv(t,e,n){return function(){var i=e.apply(this,arguments);null==i?this.style.removeProperty(t):this.style.setProperty(t,i,n)}}function gv(t,e){return t.style.getPropertyValue(e)||dv(t).getComputedStyle(t,null).getPropertyValue(e)}function yv(t){return function(){delete this[t]}}function vv(t,e){return function(){this[t]=e}}function _v(t,e){return function(){var n=e.apply(this,arguments);null==n?delete this[t]:this[t]=n}}function wv(t){return t.trim().split(/^|\s+/)}function bv(t){return t.classList||new Tv(t)}function Tv(t){this._node=t,this._names=wv(t.getAttribute("class")||"")}function Ev(t,e){for(var n=bv(t),i=-1,s=e.length;++i<s;)n.add(e[i])}function kv(t,e){for(var n=bv(t),i=-1,s=e.length;++i<s;)n.remove(e[i])}function Iv(t){return function(){Ev(this,t)}}function Av(t){return function(){kv(this,t)}}function Cv(t,e){return function(){(e.apply(this,arguments)?Ev:kv)(this,t)}}function Sv(){this.textContent=""}function xv(t){return function(){this.textContent=t}}function Nv(t){return function(){var e=t.apply(this,arguments);this.textContent=null==e?"":e}}function Rv(){this.innerHTML=""}function qv(t){return function(){this.innerHTML=t}}function Lv(t){return function(){var e=t.apply(this,arguments);this.innerHTML=null==e?"":e}}function Dv(){this.nextSibling&&this.parentNode.appendChild(this)}function Ov(){this.previousSibling&&this.parentNode.insertBefore(this,this.parentNode.firstChild)}function Mv(t){return function(){var e=this.ownerDocument,n=this.namespaceURI;return n===iv&&e.documentElement.namespaceURI===iv?e.createElement(t):e.createElementNS(n,t)}}function Pv(t){return function(){return this.ownerDocument.createElementNS(t.space,t.local)}}function Uv(t){var e=rv(t);return(e.local?Pv:Mv)(e)}function Fv(){return null}function Vv(){var t=this.parentNode;t&&t.removeChild(this)}function jv(){var t=this.cloneNode(!1),e=this.parentNode;return e?e.insertBefore(t,this.nextSibling):t}function Bv(){var t=this.cloneNode(!0),e=this.parentNode;return e?e.insertBefore(t,this.nextSibling):t}function $v(t){return function(){var e=this.__on;if(e){for(var n,i=0,s=-1,r=e.length;i<r;++i)n=e[i],t.type&&n.type!==t.type||n.name!==t.name?e[++s]=n:this.removeEventListener(n.type,n.listener,n.options);++s?e.length=s:delete this.__on}}}function Hv(t,e,n){return function(){var i,s=this.__on,r=function(t){return function(e){t.call(this,e,this.__data__)}}(e);if(s)for(var o=0,a=s.length;o<a;++o)if((i=s[o]).type===t.type&&i.name===t.name)return this.removeEventListener(i.type,i.listener,i.options),this.addEventListener(i.type,i.listener=r,i.options=n),void(i.value=e);this.addEventListener(t.type,r,n),i={type:t.type,name:t.name,value:e,listener:r,options:n},s?s.push(i):this.__on=[i]}}function zv(t,e,n){var i=dv(t),s=i.CustomEvent;"function"==typeof s?s=new s(e,n):(s=i.document.createEvent("Event"),n?(s.initEvent(e,n.bubbles,n.cancelable),s.detail=n.detail):s.initEvent(e,!1,!1)),t.dispatchEvent(s)}function Kv(t,e){return function(){return zv(this,t,e)}}function Gv(t,e){return function(){return zv(this,t,e.apply(this,arguments))}}Tv.prototype={add:function(t){this._names.indexOf(t)<0&&(this._names.push(t),this._node.setAttribute("class",this._names.join(" ")))},remove:function(t){var e=this._names.indexOf(t);e>=0&&(this._names.splice(e,1),this._node.setAttribute("class",this._names.join(" ")))},contains:function(t){return this._names.indexOf(t)>=0}};var Wv=[null];function Qv(t,e){this._groups=t,this._parents=e}function Xv(){return new Qv([[document.documentElement]],Wv)}Qv.prototype=Xv.prototype={constructor:Qv,select:function(t){"function"!=typeof t&&(t=Vy(t));for(var e=this._groups,n=e.length,i=new Array(n),s=0;s<n;++s)for(var r,o,a=e[s],c=a.length,l=i[s]=new Array(c),u=0;u<c;++u)(r=a[u])&&(o=t.call(r,r.__data__,u,a))&&("__data__"in r&&(o.__data__=r.__data__),l[u]=o);return new Qv(i,this._parents)},selectAll:function(t){t="function"==typeof t?$y(t):By(t);for(var e=this._groups,n=e.length,i=[],s=[],r=0;r<n;++r)for(var o,a=e[r],c=a.length,l=0;l<c;++l)(o=a[l])&&(i.push(t.call(o,o.__data__,l,a)),s.push(o));return new Qv(i,s)},selectChild:function(t){return this.select(null==t?Gy:function(t){return function(){return Ky.call(this.children,t)}}("function"==typeof t?t:zy(t)))},selectChildren:function(t){return this.selectAll(null==t?Qy:function(t){return function(){return Wy.call(this.children,t)}}("function"==typeof t?t:zy(t)))},filter:function(t){"function"!=typeof t&&(t=Hy(t));for(var e=this._groups,n=e.length,i=new Array(n),s=0;s<n;++s)for(var r,o=e[s],a=o.length,c=i[s]=[],l=0;l<a;++l)(r=o[l])&&t.call(r,r.__data__,l,o)&&c.push(r);return new Qv(i,this._parents)},data:function(t,e){if(!arguments.length)return Array.from(this,tv);var n,i=e?Zy:Jy,s=this._parents,r=this._groups;"function"!=typeof t&&(n=t,t=function(){return n});for(var o=r.length,a=new Array(o),c=new Array(o),l=new Array(o),u=0;u<o;++u){var h=s[u],d=r[u],f=d.length,p=ev(t.call(h,h&&h.__data__,u,s)),m=p.length,g=c[u]=new Array(m),y=a[u]=new Array(m);i(h,d,g,y,l[u]=new Array(f),p,e);for(var v,_,w=0,b=0;w<m;++w)if(v=g[w]){for(w>=b&&(b=w+1);!(_=y[b])&&++b<m;);v._next=_||null}}return(a=new Qv(a,s))._enter=c,a._exit=l,a},enter:function(){return new Qv(this._enter||this._groups.map(Xy),this._parents)},exit:function(){return new Qv(this._exit||this._groups.map(Xy),this._parents)},join:function(t,e,n){var i=this.enter(),s=this,r=this.exit();return"function"==typeof t?(i=t(i))&&(i=i.selection()):i=i.append(t+""),null!=e&&(s=e(s))&&(s=s.selection()),null==n?r.remove():n(r),i&&s?i.merge(s).order():s},merge:function(t){for(var e=t.selection?t.selection():t,n=this._groups,i=e._groups,s=n.length,r=i.length,o=Math.min(s,r),a=new Array(s),c=0;c<o;++c)for(var l,u=n[c],h=i[c],d=u.length,f=a[c]=new Array(d),p=0;p<d;++p)(l=u[p]||h[p])&&(f[p]=l);for(;c<s;++c)a[c]=n[c];return new Qv(a,this._parents)},selection:function(){return this},order:function(){for(var t=this._groups,e=-1,n=t.length;++e<n;)for(var i,s=t[e],r=s.length-1,o=s[r];--r>=0;)(i=s[r])&&(o&&4^i.compareDocumentPosition(o)&&o.parentNode.insertBefore(i,o),o=i);return this},sort:function(t){function e(e,n){return e&&n?t(e.__data__,n.__data__):!e-!n}t||(t=nv);for(var n=this._groups,i=n.length,s=new Array(i),r=0;r<i;++r){for(var o,a=n[r],c=a.length,l=s[r]=new Array(c),u=0;u<c;++u)(o=a[u])&&(l[u]=o);l.sort(e)}return new Qv(s,this._parents).order()},call:function(){var t=arguments[0];return arguments[0]=this,t.apply(null,arguments),this},nodes:function(){return Array.from(this)},node:function(){for(var t=this._groups,e=0,n=t.length;e<n;++e)for(var i=t[e],s=0,r=i.length;s<r;++s){var o=i[s];if(o)return o}return null},size:function(){let t=0;for(const e of this)++t;return t},empty:function(){return!this.node()},each:function(t){for(var e=this._groups,n=0,i=e.length;n<i;++n)for(var s,r=e[n],o=0,a=r.length;o<a;++o)(s=r[o])&&t.call(s,s.__data__,o,r);return this},attr:function(t,e){var n=rv(t);if(arguments.length<2){var i=this.node();return n.local?i.getAttributeNS(n.space,n.local):i.getAttribute(n)}return this.each((null==e?n.local?av:ov:"function"==typeof e?n.local?hv:uv:n.local?lv:cv)(n,e))},style:function(t,e,n){return arguments.length>1?this.each((null==e?fv:"function"==typeof e?mv:pv)(t,e,null==n?"":n)):gv(this.node(),t)},property:function(t,e){return arguments.length>1?this.each((null==e?yv:"function"==typeof e?_v:vv)(t,e)):this.node()[t]},classed:function(t,e){var n=wv(t+"");if(arguments.length<2){for(var i=bv(this.node()),s=-1,r=n.length;++s<r;)if(!i.contains(n[s]))return!1;return!0}return this.each(("function"==typeof e?Cv:e?Iv:Av)(n,e))},text:function(t){return arguments.length?this.each(null==t?Sv:("function"==typeof t?Nv:xv)(t)):this.node().textContent},html:function(t){return arguments.length?this.each(null==t?Rv:("function"==typeof t?Lv:qv)(t)):this.node().innerHTML},raise:function(){return this.each(Dv)},lower:function(){return this.each(Ov)},append:function(t){var e="function"==typeof t?t:Uv(t);return this.select((function(){return this.appendChild(e.apply(this,arguments))}))},insert:function(t,e){var n="function"==typeof t?t:Uv(t),i=null==e?Fv:"function"==typeof e?e:Vy(e);return this.select((function(){return this.insertBefore(n.apply(this,arguments),i.apply(this,arguments)||null)}))},remove:function(){return this.each(Vv)},clone:function(t){return this.select(t?Bv:jv)},datum:function(t){return arguments.length?this.property("__data__",t):this.node().__data__},on:function(t,e,n){var i,s,r=function(t){return t.trim().split(/^|\s+/).map((function(t){var e="",n=t.indexOf(".");return n>=0&&(e=t.slice(n+1),t=t.slice(0,n)),{type:t,name:e}}))}(t+""),o=r.length;if(!(arguments.length<2)){for(a=e?Hv:$v,i=0;i<o;++i)this.each(a(r[i],e,n));return this}var a=this.node().__on;if(a)for(var c,l=0,u=a.length;l<u;++l)for(i=0,c=a[l];i<o;++i)if((s=r[i]).type===c.type&&s.name===c.name)return c.value},dispatch:function(t,e){return this.each(("function"==typeof e?Gv:Kv)(t,e))},[Symbol.iterator]:function*(){for(var t=this._groups,e=0,n=t.length;e<n;++e)for(var i,s=t[e],r=0,o=s.length;r<o;++r)(i=s[r])&&(yield i)}};var Yv=Xv;function Jv(t,e,n){t.prototype=e.prototype=n,n.constructor=t}function Zv(t,e){var n=Object.create(t.prototype);for(var i in e)n[i]=e[i];return n}function t_(){}var e_=.7,n_=1.4285714285714286,i_="\\s*([+-]?\\d+)\\s*",s_="\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*",r_="\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*",o_=/^#([0-9a-f]{3,8})$/,a_=new RegExp(`^rgb\\(${i_},${i_},${i_}\\)$`),c_=new RegExp(`^rgb\\(${r_},${r_},${r_}\\)$`),l_=new RegExp(`^rgba\\(${i_},${i_},${i_},${s_}\\)$`),u_=new RegExp(`^rgba\\(${r_},${r_},${r_},${s_}\\)$`),h_=new RegExp(`^hsl\\(${s_},${r_},${r_}\\)$`),d_=new RegExp(`^hsla\\(${s_},${r_},${r_},${s_}\\)$`),f_={aliceblue:15792383,antiquewhite:16444375,aqua:65535,aquamarine:8388564,azure:15794175,beige:16119260,bisque:16770244,black:0,blanchedalmond:16772045,blue:255,blueviolet:9055202,brown:10824234,burlywood:14596231,cadetblue:6266528,chartreuse:8388352,chocolate:13789470,coral:16744272,cornflowerblue:6591981,cornsilk:16775388,crimson:14423100,cyan:65535,darkblue:139,darkcyan:35723,darkgoldenrod:12092939,darkgray:11119017,darkgreen:25600,darkgrey:11119017,darkkhaki:12433259,darkmagenta:9109643,darkolivegreen:5597999,darkorange:16747520,darkorchid:10040012,darkred:9109504,darksalmon:15308410,darkseagreen:9419919,darkslateblue:4734347,darkslategray:3100495,darkslategrey:3100495,darkturquoise:52945,darkviolet:9699539,deeppink:16716947,deepskyblue:49151,dimgray:6908265,dimgrey:6908265,dodgerblue:2003199,firebrick:11674146,floralwhite:16775920,forestgreen:2263842,fuchsia:16711935,gainsboro:14474460,ghostwhite:16316671,gold:16766720,goldenrod:14329120,gray:8421504,green:32768,greenyellow:11403055,grey:8421504,honeydew:15794160,hotpink:16738740,indianred:13458524,indigo:4915330,ivory:16777200,khaki:15787660,lavender:15132410,lavenderblush:16773365,lawngreen:8190976,lemonchiffon:16775885,lightblue:11393254,lightcoral:15761536,lightcyan:14745599,lightgoldenrodyellow:16448210,lightgray:13882323,lightgreen:9498256,lightgrey:13882323,lightpink:16758465,lightsalmon:16752762,lightseagreen:2142890,lightskyblue:8900346,lightslategray:7833753,lightslategrey:7833753,lightsteelblue:11584734,lightyellow:16777184,lime:65280,limegreen:3329330,linen:16445670,magenta:16711935,maroon:8388608,mediumaquamarine:6737322,mediumblue:205,mediumorchid:12211667,mediumpurple:9662683,mediumseagreen:3978097,mediumslateblue:8087790,mediumspringgreen:64154,mediumturquoise:4772300,mediumvioletred:13047173,midnightblue:1644912,mintcream:16121850,mistyrose:16770273,moccasin:16770229,navajowhite:16768685,navy:128,oldlace:16643558,olive:8421376,olivedrab:7048739,orange:16753920,orangered:16729344,orchid:14315734,palegoldenrod:15657130,palegreen:10025880,paleturquoise:11529966,palevioletred:14381203,papayawhip:16773077,peachpuff:16767673,peru:13468991,pink:16761035,plum:14524637,powderblue:11591910,purple:8388736,rebeccapurple:6697881,red:16711680,rosybrown:12357519,royalblue:4286945,saddlebrown:9127187,salmon:16416882,sandybrown:16032864,seagreen:3050327,seashell:16774638,sienna:10506797,silver:12632256,skyblue:8900331,slateblue:6970061,slategray:7372944,slategrey:7372944,snow:16775930,springgreen:65407,steelblue:4620980,tan:13808780,teal:32896,thistle:14204888,tomato:16737095,turquoise:4251856,violet:15631086,wheat:16113331,white:16777215,whitesmoke:16119285,yellow:16776960,yellowgreen:10145074};function p_(){return this.rgb().formatHex()}function m_(){return this.rgb().formatRgb()}function g_(t){var e,n;return t=(t+"").trim().toLowerCase(),(e=o_.exec(t))?(n=e[1].length,e=parseInt(e[1],16),6===n?y_(e):3===n?new w_(e>>8&15|e>>4&240,e>>4&15|240&e,(15&e)<<4|15&e,1):8===n?v_(e>>24&255,e>>16&255,e>>8&255,(255&e)/255):4===n?v_(e>>12&15|e>>8&240,e>>8&15|e>>4&240,e>>4&15|240&e,((15&e)<<4|15&e)/255):null):(e=a_.exec(t))?new w_(e[1],e[2],e[3],1):(e=c_.exec(t))?new w_(255*e[1]/100,255*e[2]/100,255*e[3]/100,1):(e=l_.exec(t))?v_(e[1],e[2],e[3],e[4]):(e=u_.exec(t))?v_(255*e[1]/100,255*e[2]/100,255*e[3]/100,e[4]):(e=h_.exec(t))?A_(e[1],e[2]/100,e[3]/100,1):(e=d_.exec(t))?A_(e[1],e[2]/100,e[3]/100,e[4]):f_.hasOwnProperty(t)?y_(f_[t]):"transparent"===t?new w_(NaN,NaN,NaN,0):null}function y_(t){return new w_(t>>16&255,t>>8&255,255&t,1)}function v_(t,e,n,i){return i<=0&&(t=e=n=NaN),new w_(t,e,n,i)}function __(t,e,n,i){return 1===arguments.length?((s=t)instanceof t_||(s=g_(s)),s?new w_((s=s.rgb()).r,s.g,s.b,s.opacity):new w_):new w_(t,e,n,null==i?1:i);var s}function w_(t,e,n,i){this.r=+t,this.g=+e,this.b=+n,this.opacity=+i}function b_(){return`#${I_(this.r)}${I_(this.g)}${I_(this.b)}`}function T_(){const t=E_(this.opacity);return`${1===t?"rgb(":"rgba("}${k_(this.r)}, ${k_(this.g)}, ${k_(this.b)}${1===t?")":`, ${t})`}`}function E_(t){return isNaN(t)?1:Math.max(0,Math.min(1,t))}function k_(t){return Math.max(0,Math.min(255,Math.round(t)||0))}function I_(t){return((t=k_(t))<16?"0":"")+t.toString(16)}function A_(t,e,n,i){return i<=0?t=e=n=NaN:n<=0||n>=1?t=e=NaN:e<=0&&(t=NaN),new S_(t,e,n,i)}function C_(t){if(t instanceof S_)return new S_(t.h,t.s,t.l,t.opacity);if(t instanceof t_||(t=g_(t)),!t)return new S_;if(t instanceof S_)return t;var e=(t=t.rgb()).r/255,n=t.g/255,i=t.b/255,s=Math.min(e,n,i),r=Math.max(e,n,i),o=NaN,a=r-s,c=(r+s)/2;return a?(o=e===r?(n-i)/a+6*(n<i):n===r?(i-e)/a+2:(e-n)/a+4,a/=c<.5?r+s:2-r-s,o*=60):a=c>0&&c<1?0:o,new S_(o,a,c,t.opacity)}function S_(t,e,n,i){this.h=+t,this.s=+e,this.l=+n,this.opacity=+i}function x_(t){return(t=(t||0)%360)<0?t+360:t}function N_(t){return Math.max(0,Math.min(1,t||0))}function R_(t,e,n){return 255*(t<60?e+(n-e)*t/60:t<180?n:t<240?e+(n-e)*(240-t)/60:e)}function q_(t,e,n,i,s){var r=t*t,o=r*t;return((1-3*t+3*r-o)*e+(4-6*r+3*o)*n+(1+3*t+3*r-3*o)*i+o*s)/6}Jv(t_,g_,{copy(t){return Object.assign(new this.constructor,this,t)},displayable(){return this.rgb().displayable()},hex:p_,formatHex:p_,formatHex8:function(){return this.rgb().formatHex8()},formatHsl:function(){return C_(this).formatHsl()},formatRgb:m_,toString:m_}),Jv(w_,__,Zv(t_,{brighter(t){return t=null==t?n_:Math.pow(n_,t),new w_(this.r*t,this.g*t,this.b*t,this.opacity)},darker(t){return t=null==t?e_:Math.pow(e_,t),new w_(this.r*t,this.g*t,this.b*t,this.opacity)},rgb(){return this},clamp(){return new w_(k_(this.r),k_(this.g),k_(this.b),E_(this.opacity))},displayable(){return-.5<=this.r&&this.r<255.5&&-.5<=this.g&&this.g<255.5&&-.5<=this.b&&this.b<255.5&&0<=this.opacity&&this.opacity<=1},hex:b_,formatHex:b_,formatHex8:function(){return`#${I_(this.r)}${I_(this.g)}${I_(this.b)}${I_(255*(isNaN(this.opacity)?1:this.opacity))}`},formatRgb:T_,toString:T_})),Jv(S_,(function(t,e,n,i){return 1===arguments.length?C_(t):new S_(t,e,n,null==i?1:i)}),Zv(t_,{brighter(t){return t=null==t?n_:Math.pow(n_,t),new S_(this.h,this.s,this.l*t,this.opacity)},darker(t){return t=null==t?e_:Math.pow(e_,t),new S_(this.h,this.s,this.l*t,this.opacity)},rgb(){var t=this.h%360+360*(this.h<0),e=isNaN(t)||isNaN(this.s)?0:this.s,n=this.l,i=n+(n<.5?n:1-n)*e,s=2*n-i;return new w_(R_(t>=240?t-240:t+120,s,i),R_(t,s,i),R_(t<120?t+240:t-120,s,i),this.opacity)},clamp(){return new S_(x_(this.h),N_(this.s),N_(this.l),E_(this.opacity))},displayable(){return(0<=this.s&&this.s<=1||isNaN(this.s))&&0<=this.l&&this.l<=1&&0<=this.opacity&&this.opacity<=1},formatHsl(){const t=E_(this.opacity);return`${1===t?"hsl(":"hsla("}${x_(this.h)}, ${100*N_(this.s)}%, ${100*N_(this.l)}%${1===t?")":`, ${t})`}`}}));var L_=t=>()=>t;function D_(t,e){return function(n){return t+n*e}}function O_(t){return 1==(t=+t)?M_:function(e,n){return n-e?function(t,e,n){return t=Math.pow(t,n),e=Math.pow(e,n)-t,n=1/n,function(i){return Math.pow(t+i*e,n)}}(e,n,t):L_(isNaN(e)?n:e)}}function M_(t,e){var n=e-t;return n?D_(t,n):L_(isNaN(t)?e:t)}var P_=function t(e){var n=O_(e);function i(t,e){var i=n((t=__(t)).r,(e=__(e)).r),s=n(t.g,e.g),r=n(t.b,e.b),o=M_(t.opacity,e.opacity);return function(e){return t.r=i(e),t.g=s(e),t.b=r(e),t.opacity=o(e),t+""}}return i.gamma=t,i}(1);function U_(t){return function(e){var n,i,s=e.length,r=new Array(s),o=new Array(s),a=new Array(s);for(n=0;n<s;++n)i=__(e[n]),r[n]=i.r||0,o[n]=i.g||0,a[n]=i.b||0;return r=t(r),o=t(o),a=t(a),i.opacity=1,function(t){return i.r=r(t),i.g=o(t),i.b=a(t),i+""}}}U_((function(t){var e=t.length-1;return function(n){var i=n<=0?n=0:n>=1?(n=1,e-1):Math.floor(n*e),s=t[i],r=t[i+1],o=i>0?t[i-1]:2*s-r,a=i<e-1?t[i+2]:2*r-s;return q_((n-i/e)*e,o,s,r,a)}})),U_((function(t){var e=t.length;return function(n){var i=Math.floor(((n%=1)<0?++n:n)*e),s=t[(i+e-1)%e],r=t[i%e],o=t[(i+1)%e],a=t[(i+2)%e];return q_((n-i/e)*e,s,r,o,a)}}));function F_(t,e){return t=+t,e=+e,function(n){return t*(1-n)+e*n}}var V_=/[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g,j_=new RegExp(V_.source,"g");function B_(t,e){var n,i,s,r=V_.lastIndex=j_.lastIndex=0,o=-1,a=[],c=[];for(t+="",e+="";(n=V_.exec(t))&&(i=j_.exec(e));)(s=i.index)>r&&(s=e.slice(r,s),a[o]?a[o]+=s:a[++o]=s),(n=n[0])===(i=i[0])?a[o]?a[o]+=i:a[++o]=i:(a[++o]=null,c.push({i:o,x:F_(n,i)})),r=j_.lastIndex;return r<e.length&&(s=e.slice(r),a[o]?a[o]+=s:a[++o]=s),a.length<2?c[0]?function(t){return function(e){return t(e)+""}}(c[0].x):function(t){return function(){return t}}(e):(e=c.length,function(t){for(var n,i=0;i<e;++i)a[(n=c[i]).i]=n.x(t);return a.join("")})}var $_,H_,z_=0,K_=0,G_=0,W_=1e3,Q_=0,X_=0,Y_=0,J_="object"==typeof performance&&performance.now?performance:Date,Z_="object"==typeof window&&window.requestAnimationFrame?window.requestAnimationFrame.bind(window):function(t){setTimeout(t,17)};function tw(){return X_||(Z_(ew),X_=J_.now()+Y_)}function ew(){X_=0}function nw(){this._call=this._time=this._next=null}function iw(t,e,n){var i=new nw;return i.restart(t,e,n),i}function sw(){X_=(Q_=J_.now())+Y_,z_=K_=0;try{!function(){tw(),++z_;for(var t,e=$_;e;)(t=X_-e._time)>=0&&e._call.call(void 0,t),e=e._next;--z_}()}finally{z_=0,function(){var t,e,n=$_,i=1/0;for(;n;)n._call?(i>n._time&&(i=n._time),t=n,n=n._next):(e=n._next,n._next=null,n=t?t._next=e:$_=e);H_=t,ow(i)}(),X_=0}}function rw(){var t=J_.now(),e=t-Q_;e>W_&&(Y_-=e,Q_=t)}function ow(t){z_||(K_&&(K_=clearTimeout(K_)),t-X_>24?(t<1/0&&(K_=setTimeout(sw,t-J_.now()-Y_)),G_&&(G_=clearInterval(G_))):(G_||(Q_=J_.now(),G_=setInterval(rw,W_)),z_=1,Z_(sw)))}function aw(t,e,n){var i=new nw;return e=null==e?0:+e,i.restart((n=>{i.stop(),t(n+e)}),e,n),i}nw.prototype=iw.prototype={constructor:nw,restart:function(t,e,n){if("function"!=typeof t)throw new TypeError("callback is not a function");n=(null==n?tw():+n)+(null==e?0:+e),this._next||H_===this||(H_?H_._next=this:$_=this,H_=this),this._call=t,this._time=n,ow()},stop:function(){this._call&&(this._call=null,this._time=1/0,ow())}};var cw=Uy("start","end","cancel","interrupt"),lw=[],uw=0,hw=1,dw=2,fw=3,pw=4,mw=5,gw=6;function yw(t,e,n,i,s,r){var o=t.__transition;if(o){if(n in o)return}else t.__transition={};!function(t,e,n){var i,s=t.__transition;function r(t){n.state=hw,n.timer.restart(o,n.delay,n.time),n.delay<=t&&o(t-n.delay)}function o(r){var l,u,h,d;if(n.state!==hw)return c();for(l in s)if((d=s[l]).name===n.name){if(d.state===fw)return aw(o);d.state===pw?(d.state=gw,d.timer.stop(),d.on.call("interrupt",t,t.__data__,d.index,d.group),delete s[l]):+l<e&&(d.state=gw,d.timer.stop(),d.on.call("cancel",t,t.__data__,d.index,d.group),delete s[l])}if(aw((function(){n.state===fw&&(n.state=pw,n.timer.restart(a,n.delay,n.time),a(r))})),n.state=dw,n.on.call("start",t,t.__data__,n.index,n.group),n.state===dw){for(n.state=fw,i=new Array(h=n.tween.length),l=0,u=-1;l<h;++l)(d=n.tween[l].value.call(t,t.__data__,n.index,n.group))&&(i[++u]=d);i.length=u+1}}function a(e){for(var s=e<n.duration?n.ease.call(null,e/n.duration):(n.timer.restart(c),n.state=mw,1),r=-1,o=i.length;++r<o;)i[r].call(t,s);n.state===mw&&(n.on.call("end",t,t.__data__,n.index,n.group),c())}function c(){for(var i in n.state=gw,n.timer.stop(),delete s[e],s)return;delete t.__transition}s[e]=n,n.timer=iw(r,0,n.time)}(t,n,{name:e,index:i,group:s,on:cw,tween:lw,time:r.time,delay:r.delay,duration:r.duration,ease:r.ease,timer:null,state:uw})}function vw(t,e){var n=ww(t,e);if(n.state>uw)throw new Error("too late; already scheduled");return n}function _w(t,e){var n=ww(t,e);if(n.state>fw)throw new Error("too late; already running");return n}function ww(t,e){var n=t.__transition;if(!n||!(n=n[e]))throw new Error("transition not found");return n}function bw(t,e){var n,i,s,r=t.__transition,o=!0;if(r){for(s in e=null==e?null:e+"",r)(n=r[s]).name===e?(i=n.state>dw&&n.state<mw,n.state=gw,n.timer.stop(),n.on.call(i?"interrupt":"cancel",t,t.__data__,n.index,n.group),delete r[s]):o=!1;o&&delete t.__transition}}var Tw,Ew=180/Math.PI,kw={translateX:0,translateY:0,rotate:0,skewX:0,scaleX:1,scaleY:1};function Iw(t,e,n,i,s,r){var o,a,c;return(o=Math.sqrt(t*t+e*e))&&(t/=o,e/=o),(c=t*n+e*i)&&(n-=t*c,i-=e*c),(a=Math.sqrt(n*n+i*i))&&(n/=a,i/=a,c/=a),t*i<e*n&&(t=-t,e=-e,c=-c,o=-o),{translateX:s,translateY:r,rotate:Math.atan2(e,t)*Ew,skewX:Math.atan(c)*Ew,scaleX:o,scaleY:a}}function Aw(t,e,n,i){function s(t){return t.length?t.pop()+" ":""}return function(r,o){var a=[],c=[];return r=t(r),o=t(o),function(t,i,s,r,o,a){if(t!==s||i!==r){var c=o.push("translate(",null,e,null,n);a.push({i:c-4,x:F_(t,s)},{i:c-2,x:F_(i,r)})}else(s||r)&&o.push("translate("+s+e+r+n)}(r.translateX,r.translateY,o.translateX,o.translateY,a,c),function(t,e,n,r){t!==e?(t-e>180?e+=360:e-t>180&&(t+=360),r.push({i:n.push(s(n)+"rotate(",null,i)-2,x:F_(t,e)})):e&&n.push(s(n)+"rotate("+e+i)}(r.rotate,o.rotate,a,c),function(t,e,n,r){t!==e?r.push({i:n.push(s(n)+"skewX(",null,i)-2,x:F_(t,e)}):e&&n.push(s(n)+"skewX("+e+i)}(r.skewX,o.skewX,a,c),function(t,e,n,i,r,o){if(t!==n||e!==i){var a=r.push(s(r)+"scale(",null,",",null,")");o.push({i:a-4,x:F_(t,n)},{i:a-2,x:F_(e,i)})}else 1===n&&1===i||r.push(s(r)+"scale("+n+","+i+")")}(r.scaleX,r.scaleY,o.scaleX,o.scaleY,a,c),r=o=null,function(t){for(var e,n=-1,i=c.length;++n<i;)a[(e=c[n]).i]=e.x(t);return a.join("")}}}var Cw=Aw((function(t){const e=new("function"==typeof DOMMatrix?DOMMatrix:WebKitCSSMatrix)(t+"");return e.isIdentity?kw:Iw(e.a,e.b,e.c,e.d,e.e,e.f)}),"px, ","px)","deg)"),Sw=Aw((function(t){return null==t?kw:(Tw||(Tw=document.createElementNS("http://www.w3.org/2000/svg","g")),Tw.setAttribute("transform",t),(t=Tw.transform.baseVal.consolidate())?Iw((t=t.matrix).a,t.b,t.c,t.d,t.e,t.f):kw)}),", ",")",")");function xw(t,e){var n,i;return function(){var s=_w(this,t),r=s.tween;if(r!==n)for(var o=0,a=(i=n=r).length;o<a;++o)if(i[o].name===e){(i=i.slice()).splice(o,1);break}s.tween=i}}function Nw(t,e,n){var i,s;if("function"!=typeof n)throw new Error;return function(){var r=_w(this,t),o=r.tween;if(o!==i){s=(i=o).slice();for(var a={name:e,value:n},c=0,l=s.length;c<l;++c)if(s[c].name===e){s[c]=a;break}c===l&&s.push(a)}r.tween=s}}function Rw(t,e,n){var i=t._id;return t.each((function(){var t=_w(this,i);(t.value||(t.value={}))[e]=n.apply(this,arguments)})),function(t){return ww(t,i).value[e]}}function qw(t,e){var n;return("number"==typeof e?F_:e instanceof g_?P_:(n=g_(e))?(e=n,P_):B_)(t,e)}function Lw(t){return function(){this.removeAttribute(t)}}function Dw(t){return function(){this.removeAttributeNS(t.space,t.local)}}function Ow(t,e,n){var i,s,r=n+"";return function(){var o=this.getAttribute(t);return o===r?null:o===i?s:s=e(i=o,n)}}function Mw(t,e,n){var i,s,r=n+"";return function(){var o=this.getAttributeNS(t.space,t.local);return o===r?null:o===i?s:s=e(i=o,n)}}function Pw(t,e,n){var i,s,r;return function(){var o,a,c=n(this);if(null!=c)return(o=this.getAttribute(t))===(a=c+"")?null:o===i&&a===s?r:(s=a,r=e(i=o,c));this.removeAttribute(t)}}function Uw(t,e,n){var i,s,r;return function(){var o,a,c=n(this);if(null!=c)return(o=this.getAttributeNS(t.space,t.local))===(a=c+"")?null:o===i&&a===s?r:(s=a,r=e(i=o,c));this.removeAttributeNS(t.space,t.local)}}function Fw(t,e){var n,i;function s(){var s=e.apply(this,arguments);return s!==i&&(n=(i=s)&&function(t,e){return function(n){this.setAttributeNS(t.space,t.local,e.call(this,n))}}(t,s)),n}return s._value=e,s}function Vw(t,e){var n,i;function s(){var s=e.apply(this,arguments);return s!==i&&(n=(i=s)&&function(t,e){return function(n){this.setAttribute(t,e.call(this,n))}}(t,s)),n}return s._value=e,s}function jw(t,e){return function(){vw(this,t).delay=+e.apply(this,arguments)}}function Bw(t,e){return e=+e,function(){vw(this,t).delay=e}}function $w(t,e){return function(){_w(this,t).duration=+e.apply(this,arguments)}}function Hw(t,e){return e=+e,function(){_w(this,t).duration=e}}var zw=Yv.prototype.constructor;function Kw(t){return function(){this.style.removeProperty(t)}}var Gw=0;function Ww(t,e,n,i){this._groups=t,this._parents=e,this._name=n,this._id=i}function Qw(){return++Gw}var Xw=Yv.prototype;Ww.prototype=function(t){return Yv().transition(t)}.prototype={constructor:Ww,select:function(t){var e=this._name,n=this._id;"function"!=typeof t&&(t=Vy(t));for(var i=this._groups,s=i.length,r=new Array(s),o=0;o<s;++o)for(var a,c,l=i[o],u=l.length,h=r[o]=new Array(u),d=0;d<u;++d)(a=l[d])&&(c=t.call(a,a.__data__,d,l))&&("__data__"in a&&(c.__data__=a.__data__),h[d]=c,yw(h[d],e,n,d,h,ww(a,n)));return new Ww(r,this._parents,e,n)},selectAll:function(t){var e=this._name,n=this._id;"function"!=typeof t&&(t=By(t));for(var i=this._groups,s=i.length,r=[],o=[],a=0;a<s;++a)for(var c,l=i[a],u=l.length,h=0;h<u;++h)if(c=l[h]){for(var d,f=t.call(c,c.__data__,h,l),p=ww(c,n),m=0,g=f.length;m<g;++m)(d=f[m])&&yw(d,e,n,m,f,p);r.push(f),o.push(c)}return new Ww(r,o,e,n)},selectChild:Xw.selectChild,selectChildren:Xw.selectChildren,filter:function(t){"function"!=typeof t&&(t=Hy(t));for(var e=this._groups,n=e.length,i=new Array(n),s=0;s<n;++s)for(var r,o=e[s],a=o.length,c=i[s]=[],l=0;l<a;++l)(r=o[l])&&t.call(r,r.__data__,l,o)&&c.push(r);return new Ww(i,this._parents,this._name,this._id)},merge:function(t){if(t._id!==this._id)throw new Error;for(var e=this._groups,n=t._groups,i=e.length,s=n.length,r=Math.min(i,s),o=new Array(i),a=0;a<r;++a)for(var c,l=e[a],u=n[a],h=l.length,d=o[a]=new Array(h),f=0;f<h;++f)(c=l[f]||u[f])&&(d[f]=c);for(;a<i;++a)o[a]=e[a];return new Ww(o,this._parents,this._name,this._id)},selection:function(){return new zw(this._groups,this._parents)},transition:function(){for(var t=this._name,e=this._id,n=Qw(),i=this._groups,s=i.length,r=0;r<s;++r)for(var o,a=i[r],c=a.length,l=0;l<c;++l)if(o=a[l]){var u=ww(o,e);yw(o,t,n,l,a,{time:u.time+u.delay+u.duration,delay:0,duration:u.duration,ease:u.ease})}return new Ww(i,this._parents,t,n)},call:Xw.call,nodes:Xw.nodes,node:Xw.node,size:Xw.size,empty:Xw.empty,each:Xw.each,on:function(t,e){var n=this._id;return arguments.length<2?ww(this.node(),n).on.on(t):this.each(function(t,e,n){var i,s,r=function(t){return(t+"").trim().split(/^|\s+/).every((function(t){var e=t.indexOf(".");return e>=0&&(t=t.slice(0,e)),!t||"start"===t}))}(e)?vw:_w;return function(){var o=r(this,t),a=o.on;a!==i&&(s=(i=a).copy()).on(e,n),o.on=s}}(n,t,e))},attr:function(t,e){var n=rv(t),i="transform"===n?Sw:qw;return this.attrTween(t,"function"==typeof e?(n.local?Uw:Pw)(n,i,Rw(this,"attr."+t,e)):null==e?(n.local?Dw:Lw)(n):(n.local?Mw:Ow)(n,i,e))},attrTween:function(t,e){var n="attr."+t;if(arguments.length<2)return(n=this.tween(n))&&n._value;if(null==e)return this.tween(n,null);if("function"!=typeof e)throw new Error;var i=rv(t);return this.tween(n,(i.local?Fw:Vw)(i,e))},style:function(t,e,n){var i="transform"==(t+="")?Cw:qw;return null==e?this.styleTween(t,function(t,e){var n,i,s;return function(){var r=gv(this,t),o=(this.style.removeProperty(t),gv(this,t));return r===o?null:r===n&&o===i?s:s=e(n=r,i=o)}}(t,i)).on("end.style."+t,Kw(t)):"function"==typeof e?this.styleTween(t,function(t,e,n){var i,s,r;return function(){var o=gv(this,t),a=n(this),c=a+"";return null==a&&(this.style.removeProperty(t),c=a=gv(this,t)),o===c?null:o===i&&c===s?r:(s=c,r=e(i=o,a))}}(t,i,Rw(this,"style."+t,e))).each(function(t,e){var n,i,s,r,o="style."+e,a="end."+o;return function(){var c=_w(this,t),l=c.on,u=null==c.value[o]?r||(r=Kw(e)):void 0;l===n&&s===u||(i=(n=l).copy()).on(a,s=u),c.on=i}}(this._id,t)):this.styleTween(t,function(t,e,n){var i,s,r=n+"";return function(){var o=gv(this,t);return o===r?null:o===i?s:s=e(i=o,n)}}(t,i,e),n).on("end.style."+t,null)},styleTween:function(t,e,n){var i="style."+(t+="");if(arguments.length<2)return(i=this.tween(i))&&i._value;if(null==e)return this.tween(i,null);if("function"!=typeof e)throw new Error;return this.tween(i,function(t,e,n){var i,s;function r(){var r=e.apply(this,arguments);return r!==s&&(i=(s=r)&&function(t,e,n){return function(i){this.style.setProperty(t,e.call(this,i),n)}}(t,r,n)),i}return r._value=e,r}(t,e,null==n?"":n))},text:function(t){return this.tween("text","function"==typeof t?function(t){return function(){var e=t(this);this.textContent=null==e?"":e}}(Rw(this,"text",t)):function(t){return function(){this.textContent=t}}(null==t?"":t+""))},textTween:function(t){var e="text";if(arguments.length<1)return(e=this.tween(e))&&e._value;if(null==t)return this.tween(e,null);if("function"!=typeof t)throw new Error;return this.tween(e,function(t){var e,n;function i(){var i=t.apply(this,arguments);return i!==n&&(e=(n=i)&&function(t){return function(e){this.textContent=t.call(this,e)}}(i)),e}return i._value=t,i}(t))},remove:function(){return this.on("end.remove",(t=this._id,function(){var e=this.parentNode;for(var n in this.__transition)if(+n!==t)return;e&&e.removeChild(this)}));var t},tween:function(t,e){var n=this._id;if(t+="",arguments.length<2){for(var i,s=ww(this.node(),n).tween,r=0,o=s.length;r<o;++r)if((i=s[r]).name===t)return i.value;return null}return this.each((null==e?xw:Nw)(n,t,e))},delay:function(t){var e=this._id;return arguments.length?this.each(("function"==typeof t?jw:Bw)(e,t)):ww(this.node(),e).delay},duration:function(t){var e=this._id;return arguments.length?this.each(("function"==typeof t?$w:Hw)(e,t)):ww(this.node(),e).duration},ease:function(t){var e=this._id;return arguments.length?this.each(function(t,e){if("function"!=typeof e)throw new Error;return function(){_w(this,t).ease=e}}(e,t)):ww(this.node(),e).ease},easeVarying:function(t){if("function"!=typeof t)throw new Error;return this.each(function(t,e){return function(){var n=e.apply(this,arguments);if("function"!=typeof n)throw new Error;_w(this,t).ease=n}}(this._id,t))},end:function(){var t,e,n=this,i=n._id,s=n.size();return new Promise((function(r,o){var a={value:o},c={value:function(){0==--s&&r()}};n.each((function(){var n=_w(this,i),s=n.on;s!==t&&((e=(t=s).copy())._.cancel.push(a),e._.interrupt.push(a),e._.end.push(c)),n.on=e})),0===s&&r()}))},[Symbol.iterator]:Xw[Symbol.iterator]};var Yw={time:null,delay:0,duration:250,ease:function(t){return((t*=2)<=1?t*t*t:(t-=2)*t*t+2)/2}};function Jw(t,e){for(var n;!(n=t.__transition)||!(n=n[e]);)if(!(t=t.parentNode))throw new Error(`transition ${e} not found`);return n}Yv.prototype.interrupt=function(t){return this.each((function(){bw(this,t)}))},Yv.prototype.transition=function(t){var e,n;t instanceof Ww?(e=t._id,t=t._name):(e=Qw(),(n=Yw).time=tw(),t=null==t?null:t+"");for(var i=this._groups,s=i.length,r=0;r<s;++r)for(var o,a=i[r],c=a.length,l=0;l<c;++l)(o=a[l])&&yw(o,t,e,l,a,n||Jw(o,e));return new Ww(i,this._parents,t,e)};const{abs:Zw,max:tb,min:eb}=Math;function nb(t){return[+t[0],+t[1]]}function ib(t){return[nb(t[0]),nb(t[1])]}["w","e"].map(sb),["n","s"].map(sb),["n","w","e","s","nw","ne","sw","se"].map(sb);function sb(t){return{type:t}}Math.sqrt(50),Math.sqrt(10),Math.sqrt(2);function rb(t,e){return null==t||null==e?NaN:t<e?-1:t>e?1:t>=e?0:NaN}function ob(t,e){return null==t||null==e?NaN:e<t?-1:e>t?1:e>=t?0:NaN}function ab(t){let e,n,i;function s(t,i,s=0,r=t.length){if(s<r){if(0!==e(i,i))return r;do{const e=s+r>>>1;n(t[e],i)<0?s=e+1:r=e}while(s<r)}return s}return 2!==t.length?(e=rb,n=(e,n)=>rb(t(e),n),i=(e,n)=>t(e)-n):(e=t===rb||t===ob?t:cb,n=t,i=t),{left:s,center:function(t,e,n=0,r=t.length){const o=s(t,e,n,r-1);return o>n&&i(t[o-1],e)>-i(t[o],e)?o-1:o},right:function(t,i,s=0,r=t.length){if(s<r){if(0!==e(i,i))return r;do{const e=s+r>>>1;n(t[e],i)<=0?s=e+1:r=e}while(s<r)}return s}}}function cb(){return 0}const lb=ab(rb);lb.right,lb.left,ab((function(t){return null===t?NaN:+t})).center;function ub(t,e){if((n=(t=e?t.toExponential(e-1):t.toExponential()).indexOf("e"))<0)return null;var n,i=t.slice(0,n);return[i.length>1?i[0]+i.slice(2):i,+t.slice(n+1)]}function hb(t){return(t=ub(Math.abs(t)))?t[1]:NaN}function db(t){return function(e){return e.replace(/[0-9]/g,(function(e){return t[+e]}))}}var fb,pb=/^(?:(.)?([<>=^]))?([+\-( ])?([$#])?(0)?(\d+)?(,)?(\.\d+)?(~)?([a-z%])?$/i;function mb(t){if(!(e=pb.exec(t)))throw new Error("invalid format: "+t);var e;return new gb({fill:e[1],align:e[2],sign:e[3],symbol:e[4],zero:e[5],width:e[6],comma:e[7],precision:e[8]&&e[8].slice(1),trim:e[9],type:e[10]})}function gb(t){this.fill=void 0===t.fill?" ":t.fill+"",this.align=void 0===t.align?">":t.align+"",this.sign=void 0===t.sign?"-":t.sign+"",this.symbol=void 0===t.symbol?"":t.symbol+"",this.zero=!!t.zero,this.width=void 0===t.width?void 0:+t.width,this.comma=!!t.comma,this.precision=void 0===t.precision?void 0:+t.precision,this.trim=!!t.trim,this.type=void 0===t.type?"":t.type+""}function yb(t){t:for(var e,n=t.length,i=1,s=-1;i<n;++i)switch(t[i]){case".":s=e=i;break;case"0":0===s&&(s=i),e=i;break;default:if(!+t[i])break t;s>0&&(s=0)}return s>0?t.slice(0,s)+t.slice(e+1):t}function vb(t,e){var n=ub(t,e);if(!n)return t+"";var i=n[0],s=n[1];return s<0?"0."+new Array(-s).join("0")+i:i.length>s+1?i.slice(0,s+1)+"."+i.slice(s+1):i+new Array(s-i.length+2).join("0")}mb.prototype=gb.prototype,gb.prototype.toString=function(){return this.fill+this.align+this.sign+this.symbol+(this.zero?"0":"")+(void 0===this.width?"":Math.max(1,0|this.width))+(this.comma?",":"")+(void 0===this.precision?"":"."+Math.max(0,0|this.precision))+(this.trim?"~":"")+this.type};var _b={"%":(t,e)=>(100*t).toFixed(e),b:t=>Math.round(t).toString(2),c:t=>t+"",d:function(t){return Math.abs(t=Math.round(t))>=1e21?t.toLocaleString("en").replace(/,/g,""):t.toString(10)},e:(t,e)=>t.toExponential(e),f:(t,e)=>t.toFixed(e),g:(t,e)=>t.toPrecision(e),o:t=>Math.round(t).toString(8),p:(t,e)=>vb(100*t,e),r:vb,s:function(t,e){var n=ub(t,e);if(!n)return t+"";var i=n[0],s=n[1],r=s-(fb=3*Math.max(-8,Math.min(8,Math.floor(s/3))))+1,o=i.length;return r===o?i:r>o?i+new Array(r-o+1).join("0"):r>0?i.slice(0,r)+"."+i.slice(r):"0."+new Array(1-r).join("0")+ub(t,Math.max(0,e+r-1))[0]},X:t=>Math.round(t).toString(16).toUpperCase(),x:t=>Math.round(t).toString(16)};function wb(t){return t}var bb,Tb=Array.prototype.map,Eb=["y","z","a","f","p","n","µ","m","","k","M","G","T","P","E","Z","Y"];function kb(t){var e,n,i=void 0===t.grouping||void 0===t.thousands?wb:(e=Tb.call(t.grouping,Number),n=t.thousands+"",function(t,i){for(var s=t.length,r=[],o=0,a=e[0],c=0;s>0&&a>0&&(c+a+1>i&&(a=Math.max(1,i-c)),r.push(t.substring(s-=a,s+a)),!((c+=a+1)>i));)a=e[o=(o+1)%e.length];return r.reverse().join(n)}),s=void 0===t.currency?"":t.currency[0]+"",r=void 0===t.currency?"":t.currency[1]+"",o=void 0===t.decimal?".":t.decimal+"",a=void 0===t.numerals?wb:db(Tb.call(t.numerals,String)),c=void 0===t.percent?"%":t.percent+"",l=void 0===t.minus?"−":t.minus+"",u=void 0===t.nan?"NaN":t.nan+"";function h(t){var e=(t=mb(t)).fill,n=t.align,h=t.sign,d=t.symbol,f=t.zero,p=t.width,m=t.comma,g=t.precision,y=t.trim,v=t.type;"n"===v?(m=!0,v="g"):_b[v]||(void 0===g&&(g=12),y=!0,v="g"),(f||"0"===e&&"="===n)&&(f=!0,e="0",n="=");var _="$"===d?s:"#"===d&&/[boxX]/.test(v)?"0"+v.toLowerCase():"",w="$"===d?r:/[%p]/.test(v)?c:"",b=_b[v],T=/[defgprs%]/.test(v);function E(t){var s,r,c,d=_,E=w;if("c"===v)E=b(t)+E,t="";else{var k=(t=+t)<0||1/t<0;if(t=isNaN(t)?u:b(Math.abs(t),g),y&&(t=yb(t)),k&&0==+t&&"+"!==h&&(k=!1),d=(k?"("===h?h:l:"-"===h||"("===h?"":h)+d,E=("s"===v?Eb[8+fb/3]:"")+E+(k&&"("===h?")":""),T)for(s=-1,r=t.length;++s<r;)if(48>(c=t.charCodeAt(s))||c>57){E=(46===c?o+t.slice(s+1):t.slice(s))+E,t=t.slice(0,s);break}}m&&!f&&(t=i(t,1/0));var I=d.length+t.length+E.length,A=I<p?new Array(p-I+1).join(e):"";switch(m&&f&&(t=i(A+t,A.length?p-E.length:1/0),A=""),n){case"<":t=d+t+E+A;break;case"=":t=d+A+t+E;break;case"^":t=A.slice(0,I=A.length>>1)+d+t+E+A.slice(I);break;default:t=A+d+t+E}return a(t)}return g=void 0===g?6:/[gprs]/.test(v)?Math.max(1,Math.min(21,g)):Math.max(0,Math.min(20,g)),E.toString=function(){return t+""},E}return{format:h,formatPrefix:function(t,e){var n=h(((t=mb(t)).type="f",t)),i=3*Math.max(-8,Math.min(8,Math.floor(hb(e)/3))),s=Math.pow(10,-i),r=Eb[8+i/3];return function(t){return n(s*t)+r}}}}bb=kb({thousands:",",grouping:[3],currency:["$",""]}),bb.format,bb.formatPrefix;class Ib extends Map{constructor(t,e=$85729e8e64a60b52$var$keyof){if(super(),Object.defineProperties(this,{_intern:{value:new Map},_key:{value:e}}),null!=t)for(const[e,n]of t)this.set(e,n)}get(t){return super.get($85729e8e64a60b52$var$intern_get(this,t))}has(t){return super.has($85729e8e64a60b52$var$intern_get(this,t))}set(t,e){return super.set($85729e8e64a60b52$var$intern_set(this,t),e)}delete(t){return super.delete($85729e8e64a60b52$var$intern_delete(this,t))}}class Ab extends Set{constructor(t,e=$85729e8e64a60b52$var$keyof){if(super(),Object.defineProperties(this,{_intern:{value:new Map},_key:{value:e}}),null!=t)for(const e of t)this.add(e)}has(t){return super.has($85729e8e64a60b52$var$intern_get(this,t))}add(t){return super.add($85729e8e64a60b52$var$intern_set(this,t))}delete(t){return super.delete($85729e8e64a60b52$var$intern_delete(this,t))}}Symbol("implicit");var Cb=1e-12;function Sb(t){return((t=Math.exp(t))+1/t)/2}(function t(e,n,i){function s(t,s){var r,o,a=t[0],c=t[1],l=t[2],u=s[0],h=s[1],d=s[2],f=u-a,p=h-c,m=f*f+p*p;if(m<Cb)o=Math.log(d/l)/e,r=function(t){return[a+t*f,c+t*p,l*Math.exp(e*t*o)]};else{var g=Math.sqrt(m),y=(d*d-l*l+i*m)/(2*l*n*g),v=(d*d-l*l-i*m)/(2*d*n*g),_=Math.log(Math.sqrt(y*y+1)-y),w=Math.log(Math.sqrt(v*v+1)-v);o=(w-_)/e,r=function(t){var i,s=t*o,r=Sb(_),u=l/(n*g)*(r*(i=e*s+_,((i=Math.exp(2*i))-1)/(i+1))-function(t){return((t=Math.exp(t))-1/t)/2}(_));return[a+u*f,c+u*p,l*r/Sb(e*s+_)]}}return r.duration=1e3*o*e/Math.SQRT2,r}return s.rho=function(e){var n=Math.max(.001,+e),i=n*n;return t(n,i,i*i)},s})(Math.SQRT2,2,4);function xb(t,e,n){this.k=t,this.x=e,this.y=n}xb.prototype={constructor:xb,scale:function(t){return 1===t?this:new xb(this.k*t,this.x,this.y)},translate:function(t,e){return 0===t&0===e?this:new xb(this.k,this.x+this.k*t,this.y+this.k*e)},apply:function(t){return[t[0]*this.k+this.x,t[1]*this.k+this.y]},applyX:function(t){return t*this.k+this.x},applyY:function(t){return t*this.k+this.y},invert:function(t){return[(t[0]-this.x)/this.k,(t[1]-this.y)/this.k]},invertX:function(t){return(t-this.x)/this.k},invertY:function(t){return(t-this.y)/this.k},rescaleX:function(t){return t.copy().domain(t.range().map(this.invertX,this).map(t.invert,t))},rescaleY:function(t){return t.copy().domain(t.range().map(this.invertY,this).map(t.invert,t))},toString:function(){return"translate("+this.x+","+this.y+") scale("+this.k+")"}};new xb(1,0,0);xb.prototype;Mt({apiKey:"AIzaSyDN8T7Pmw5e-LzmC3nAHEqI0Uk7FF7y6fc",authDomain:"quarkz.firebaseapp.com",projectId:"quarkz",storageBucket:"quarkz.appspot.d3",messagingSenderId:"1050835442263",appId:"1:1050835442263:web:e7d05ca9373f2f6083a112",measurementId:"G-1Y3S45VWFH"});const Nb=lm(),Rb=cs();
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
var qb,Lb;(qb=Rb,Lb=Bn,z(qb).setPersistence(Lb)).then((()=>Pn(Rb,email,password))).catch((t=>{}));const Db=function(t=Pt(),e){const n=qt(t=z(t),yy).getImmediate({identifier:e}),i=E("storage");return i&&function(t,e,n,i={}){!function(t,e,n,i={}){t.host=`${e}:${n}`,t._protocol="http";const{mockUserToken:s}=i;s&&(t._overrideAuthToken="string"==typeof s?s:C(s,t.app.options.projectId))}(t,e,n,i)}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(n,...i),n}();function Ob(t){t=Number(t);var e=Math.floor(t/86400),n=Math.floor(t%86400/3600),i=Math.floor(t%3600/60),s=Math.floor(t%60);return(e>0?e+(1==e?" day, ":" days, "):"")+(n>0?n+(1==n?" hour, ":" hours, "):"")+(i>0?i+(1==i?" minute, ":" minutes, "):"")+(s>0?s+(1==s?" second":" seconds"):"")}function Mb(t,e){let n=t.length;if(n!=e.length)return!1;t.sort(),e.sort();for(let i=0;i<n;i++)if(t[i]!=e[i])return!1;return!0}function Pb(t,e){const n=Object.keys,i=typeof t;return t&&e&&"object"===i&&i===typeof e?n(t).length===n(e).length&&n(t).every((n=>Pb(t[n],e[n]))):t===e}function Ub(t){fetch(t).then((t=>{var e;for(var n of t.headers.entries())"date"===n[0]&&(e=new Date(n[1]).getTime());return e}))}function Fb(t){t.requestFullscreen?t.requestFullscreen():t.mozRequestFullScreen?t.mozRequestFullScreen():t.webkitRequestFullscreen?t.webkitRequestFullscreen():t.msRequestFullscreen&&t.msRequestFullscreen()}function Vb(t){return document.getElementById(t)}function jb(t,e,n,i){Vb("msg_popup").style.visibility="visible",Vb("msg_popup").style.opacity="1",Vb("msg_action").style.display="none",document.getElementById("msg_popup_txt").innerText=t,document.getElementById("msg_popup_content").innerText=e,null==n?n=function(){}:Vb("msg_action").style.display="block",null==i&&(i=""),Vb("msg_action").onclick=n,Vb("msg_action").innerText=i}const Bb=(t,e)=>t.map((t=>({...e.find((e=>e.qid===t.qid&&e)),...t})));let $b,Hb;function zb(t,e){let n=[];const i=new MediaRecorder(t);return i.ondataavailable=function(t){t.data.size>0&&n.push(t.data)},i.onstop=function(){!function(t){const e=new Blob(t,{type:"video/webm"});let n=window.prompt("Enter file name"),i=document.createElement("a");i.href=URL.createObjectURL(e),i.download=`${n}.webm`,document.body.appendChild(i),i.click(),URL.revokeObjectURL(e),document.body.removeChild(i)}(n),n=[]},i.start(200),i}async function Kb(){var t=Vb("lg_uname").value,e=Vb("lg_pass").value;Pn(Rb,t,e).then((e=>{e.user;aE.email=t,Qb("dashboard",1)})).catch((t=>{t.code,t.message;Vb("lgn_err").style.display="block",Vb("lg_pass").value=""}))}function Gb(){Un(cs()),aE=[]}function Wb(){var t=Vb("rg_uname").value,e=Vb("rg_pass").value,n=Vb("rg_name").value,i=Vb("rg_mbleno").value,s=Vb("rg_class").value,r=Vb("rg_gender").value;""!=t&&""!=e&&""!=n&&""!=i&&""!=s||alert("Details Cannot Be Empty"),e!=Vb("rg_pass1").value||Mn(Rb,t,e).then((e=>{const o=e.user;!async function(){try{await pg(Qp(Nb,"users",o.uid),{name:n,class:s,mblno:i,email:t,spoints:0,gen:r,sgndon:wg(),roles:{user:!0}}).then((function(){window.location.hash="#/dashboard",window.location.reload()}))}catch(t){console.error("Error Adding New User",t)}}()})).catch((t=>{t.code,t.message}))}function Qb(t,e){var n=1==XT||1==QT;switch(n?(Vb("adminonly").style.display="flex",Vb("tp_pnt").style.display="block",Vb("tp_edt").style.display="block",Vb("sms_edit").style.display="block"):(Vb("adminonly").style.display="none",Vb("sms_edit").style.display="none"),Vb(eE).classList.remove("_open"),1==e&&(window.location.hash="#/"+t),eE=t,nE=window.location.hash.split("#/")[1]){case"profile":eE="profile";break;case"about":eE="aboutus";break;case"login":eE="login";break;case"dashboard":eE="dashboard";break;case"timetable":eE="schedule";break;case"logout":Un();break;case"mainsformulas":eE="mainsformulas",bT(1);break;case"downloads":eE="downloads",bT(2);break;case"livequiz":eE="livequiz";break;case"register":eE="register";break;case"testinfo":eE="testinfo",OT("active");break;case"legal":eE="legal";break;case"appinfo":eE="appinfo",Vb("ren_appinf").textContent=JSON.stringify(tE,void 0,2);break;case"forum":eE="forum";break;case"testing":eE="testing";break;case"bugreport":eE="bugreport";break;case"simlist":eE="simlist",aT();break;case"testend":eE="test_end";break;case"add/question":eE="fu_question";break;case"add/lesson":eE="fu_lesson",newLesson();break;case"add/tpc":eE="fu_topic",async function(){try{Qb("edit_tpc/"+(await gg(Wp(Nb,"topic"),{name:"",qllist:[],level:"jee",chid:"",chname:"",subject:""})).id,1)}catch{}}();break;case"add/images":eE="fu_images";break;case"add/qubank":eE="fu_topic",async function(){try{Qb("edit_qubank/"+(await gg(Wp(Nb,"qbank"),{name:"",qllist:[],level:"jee",chid:"",chname:"",subject:""})).id,1)}catch{}}();break;case"add/simulation":eE="fu_simulation",async function(){try{Qb("edit_sim/"+(await gg(Wp(Nb,"sims"),{name:"",license:"",provider:"",url:""})).id,1)}catch{}}();break;case"add/tests":eE="fu_topic",async function(){try{const t=await gg(Wp(Nb,"tests"),{title:"",totalmarks:0,timeallotted:0,syllabus:"",strton:wg(),endon:wg(),questionnos:0,finished:[],batch:[]});await pg(Qp(Nb,"tests",t.id,"questions","questions"),{questions:[]}),await pg(Qp(Nb,"tests",t.id,"questions","answers"),{questions:[]}),await pg(Qp(Nb,"tests",t.id,"responses","finished"),{finished:[],leaderboard:[]});Qb("edit_tests/"+t.id,1)}catch{}}();break;case"chplist":eE="chapterlist",_T();break;default:eE="error_page"}nE.includes("instructions")&&(eE="test_instructions"),nE.includes("cyberhunt")&&(eE="cyberhunt",async function(){""==window.location.hash.split("/cyberhunt/")[1]||""==window.location.hash.split("/cyberhunt")[1]?(Vb("cyb_code").style.display="flex",Vb("cyb_viewer").style.display="none",Vb("cyb_edit").style.display="none"):(Vb("cyb_code").style.display="none",Vb("cyb_viewer").style.display="flex",Vb("cyb_edit").style.display="none")}()),nE.includes("notes")&&!nE.includes("usernotes")&&(eE="notes",async function(){var t=window.location.hash.split("notes/")[1];vy(_y(Db,"public/"+t+".pdf")).then((t=>{Vb("nt_id").src=t+""})).catch((t=>{switch(t.code){case"storage/object-not-found":Vb("nt_id").src="https://firebasestorage.googleapis.com/v0/b/quarkz.appspot.com/o/public%2F404.pdf?alt=media&token=8cc8f23a-6e24-41d6-984b-6d2cc9b89d11";break;case"storage/unauthorized":jb("Unauthorised","You dont have necessary permissions to The file you requested.")}}))}()),nE.includes("sims")&&(eE="simulations",async function(){var t=window.location.hash.split("sims/")[1],e=Qp(Nb,"sims",t),n=await hg(e);if(!n.exists())throw Qb("error_page",1),new Error;var i=n.data();Vb("sms_name").innerText=i.name,Vb("sms_prov").innerText=i.provider,Vb("sim_frame").src=i.url}()),nE.includes("chapter")&&(eE="chapter",async function(){Vb("chp_chaptername").innerHTML="",Vb("chp_qbk_list").innerHTML="",Vb("chp_tpc_list").innerHTML="";var t=Qp(Nb,"chapter",window.location.hash.split("#/chapter/")[1]),e=await hg(t);if(e.exists()){var n=e.data();Vb("chp_chaptername").innerText=n.name;try{for(let t of n.qbanks)Vb("chp_qbk_list").insertAdjacentHTML("beforeend",'<span class="tlinks rpl" style = "color:pink" id="chpqbk'+btoa(t.id)+'">'+t.title+"</span>"),Vb("chpqbk"+btoa(t.id)).addEventListener("click",mT)}catch{}try{for(let t of n.topics)Vb("chp_tpc_list").insertAdjacentHTML("beforeend",'<span class="tlinks rpl" style = "color:pink" id="chptpc'+btoa(t.id)+'">'+t.title+"</span>"),Vb("chptpc"+btoa(t.id)).addEventListener("click",gT)}catch{}}}()),nE.includes("qbanks")&&(eE="topic",yT(2)),nE.includes("usernotes")&&(eE="usernotes",async function(){Vb("un_rendermode").value="edit";try{window.notesUIHandler()}catch{}if(window.location.hash.includes("usernotes/add")){var t=await gg(Wp(Nb,"usernotes"),{title:"Notes Title",notes:"",uuid:WT.uuid,crton:wg(),type:"private",lastupdated:wg()});await mg(Qp(Nb,"users",WT.uuid),{usernotes:bg({color:"black",id:t.id,title:"Notes Title"})}),Qb("#/usernotes/"+t.id,1)}else if(window.location.hash.includes("usernotes/delete"))await deleteDoc(Qp(Nb,"usernotes",window.location.hash.split("usernotes/delete/")[1]));else if("#/usernotes/"==window.location.hash);else{t=Qp(Nb,"usernotes",window.location.hash.split("usernotes/")[1]);var e=await hg(t);if(e.exists()){t=e.data();Vb("un_title").value=t.title,GT("un_editable",t.notes),Vb("un_viewership").value=t.type}}}()),nE.includes("qbnk_vid")&&(eE="qbnk_vid",Vb("qbnk_vid_btn").style.display="block"),nE.includes("attempt")&&(eE="testv1",async function(){Vb("tt_footer").style.display="flex",Vb("tt_sub").style.display="block",Vb("tt_timeleft").style.display="block",Vb("tt_marksaward").style.display="none";var t=window.location.hash.split("#/attempt/")[1],e=Qp(Nb,"tests",t),n=await hg(e);if(n.exists()&&(gE=n.data(),e=Qp(Nb,"tests",t,"responses","finished"),(n=await hg(e)).exists()))for(var i of n.data().finished)if(Rb.currentUser.uid==i)return Qb("testend",1),Vb("te_title").innerText="You Have Already Attempted This Test",0;try{e=Qp(Nb,"tests",t,"questions","questions"),(n=await hg(e)).exists()&&(vE=n.data())}catch{return Vb("te_title").innerText="The Test Hasnt Started Yet",Qb("testend",1),0}if(e=Qp(Nb,"tests",t,"responses",Rb.currentUser.uid),(n=await hg(e)).exists()){var s=n.data().answers;for(var r in bE=n.data().actions,s)_E.push({qid:r,ans:s[r].ans,type:s[r].type,time:s[r].time})}else{for(var o={},a=0;a<vE.questions.length;a++)o[`${vE.questions[a].qid}`]={type:"tts_notvisit",answer:[]},_E.push({qid:vE.questions[a].qid,type:"tts_notvisit",answer:[],timetaken:0});var c=new Date;await pg(Qp(Nb,"tests",t,"responses",Rb.currentUser.uid),{answers:o,strton:wg(),warning:[],actions:[{type:"start",time:c,value:"1"}],testversion:"1"}),bE.push({type:"start",time:c,value:"1"})}window.location.hash.includes("/attempt/")&&(eT=setInterval((function(){var t=gE.timeallotted-1;gE.timeallotted-=1,Vb("tt_timeleft").innerText=Math.floor(t%86400/3600)+":"+Math.floor(t%3600/60)+":"+Math.floor(t%60),yE+=1,Vb("tt_timespent").innerText=Math.floor(yE%86400/3600)+":"+Math.floor(yE%3600/60)+":"+Math.floor(yE%60),0==t&&BT()}),1e3));window.onbeforeunload=function(t){t.preventDefault,BT()},window.onhashchange=function(t){Qb(),BT()},Vb("tt_testname").innerText=gE.title,Vb("dsh_btn").style.display="none",Vb("tp_pnt").style.display="none",Vb("tp_pnt").style.display="none";var l=Vb("testv1");try{Fb(l)}catch{}VT()}()),nE.includes("finished")&&(eE="finishedtestinfo",async function(){var t=window.location.hash.split("#/finished/")[1],e=Qp(Nb,"tests",t),n=await hg(e);if(n.exists()){gE=n.data();var i=0;if(Vb("fti_title").innerText=gE.title,e=Qp(Nb,"tests",t,"responses","finished"),(n=await hg(e)).exists())for(var s of n.data().finished)if(Rb.currentUser.uid==s){i=1;break}if(0==i)Qb("testend",1),Vb("te_title").innerText="You Have NOT Attempted This Test";else try{try{UT(1)}catch{}try{e=Qp(Nb,"tests",t,"responses",Rb.currentUser.uid);var r=(n=await hg(e)).data();if(n.exists()){function o(t,e,n,i,s){var r=s-(e-4*n);return"<div><span>"+t+"("+(e+n)+' Marks)</span><div style = "width:40vw;height:30px;display:flex;flex-direction:row;"><div style="width:'+e/s*40+'vw;background-color:green;height:30px;text-align:center;color:white">'+e+"/"+s+'</div><div style="width:'+Math.abs(4*n/s*40)+'vw;background-color:red;height:30px;text-align:center;color:white">'+n+"/"+s+'</div><div style="width:'+40*(1-(e-4*n)/s)+'vw;background-color:orange;height:30px;text-align:center;color:black">'+r+"/"+s+"</div></div></div>"}Vb("fto_total").innerText=r.info.usermarks+"/"+r.info.total,Vb("fto_correct").innerText=r.info.correct,Vb("fto_incorrect").innerText=r.info.incorrect,Vb("fto_unanswered").innerText=r.info.unattempted,bE=r.actions,JT=r.info.mList,Vb("fto_rank").innerText="0";var a=["Physics","Chemistry","Math","Biology","Statistics","Computer","Unfiled"];for(var c of(Vb("fto_percents").innerHTML="",a)){var l=r.info.subjectmarks[c];Pb(l,{correct:0,unattempted:0,incorrect:0,total:0})||Vb("fto_percents").insertAdjacentHTML("beforeend",o(c,l.correct,l.incorrect,l.unattempted,l.total))}MT(1).then((function(){function t(t,e,n,i,s){var r=s-(e+n);return"<div><span>"+t+"("+Ob(s)+')</span><div style = "width:80vw;height:30px;display:flex;flex-direction:row;"><div style="width:'+e/s*80+'vw;background-color:green;height:30px;text-align:center;color:white">'+Ob(e)+'</div><div style="width:'+n/s*80+'vw;background-color:red;height:30px;text-align:center;color:white">'+Ob(n)+'</div><div style="width:'+80*(1-(e+n)/s)+'vw;background-color:orange;height:30px;text-align:center;color:black">'+Ob(r)+"</div></div></div>"}var e=["Physics","Chemistry","Math","Biology","Statistics","Computer","Unfiled"];for(var n of(Vb("fto_time").innerHTML="",e)){var i=ZT.subject[n];Pb(i,{correct:0,unattempted:0,incorrect:0,total:0})||Vb("fto_time").insertAdjacentHTML("beforeend",t(n,i.correct,i.incorrect,i.unattempted,i.total))}}))}try{var u;e=Qp(Nb,"tests",t,"responses","finished"),(n=await hg(e)).exists()&&(u=n.data().leaderboard),Vb("fto_leaderboard").innerHTML="",p="marks",0==(m=1)&&(g=t=>(e,n)=>e[t]>n[t]?1:-1),1==m&&(g=t=>(e,n)=>e[t]>n[t]?-1:1),u=u.sort(g(p));for(var h=0;h<u.length;h++){var d=h+1;WT.uuid==u[h].uid&&(Vb("fto_rank").innerText=d),Vb("fto_leaderboard").insertAdjacentHTML("beforeend",'<div class = "tlinks" style = "flex-direction:row;width:25vw;justify-content:space-between;"><span class = "t_gre">&nbsp;'+d+'</span><span class = "t_name">'+u[h].name+'</span><span class = "t_gre">&nbsp;&nbsp;'+u[h].marks+"</span></div>")}}catch{}var f=[];for(h=0;h<JT.length;h++)null==ZT.questions[JT[h].qid]?f.push({qid:JT[h].qid,type:JT[h].type,time:0,no:h+1}):f.push({qid:JT[h].qid,type:JT[h].type,time:ZT.questions[JT[h].qid].time,no:h+1});console.log(f),function(t,e){try{const i={top:20,right:20,bottom:50,left:50},s=800-i.left-i.right,r=400-i.top-i.bottom;Vb(t).innerHTML="";const o=$60335d5fa2b61a3a$exports.select("#"+t).append("svg").attr("width",s+i.left+i.right).attr("height",r+i.top+i.bottom).append("g").attr("transform",`translate(${i.left}, ${i.top})`),a=$60335d5fa2b61a3a$exports.scaleOrdinal().domain(["correct","incorrect","unattempted"]).range(["#2ecc71","#e74c3c","#f39c12"]),c=$60335d5fa2b61a3a$exports.scaleLinear().domain([0,$60335d5fa2b61a3a$exports.max(e,(t=>t.time))]).range([5,30]),l=$60335d5fa2b61a3a$exports.scaleLinear().domain([1,e.length]).range([0,s]),u=$60335d5fa2b61a3a$exports.scaleLinear().domain([0,$60335d5fa2b61a3a$exports.max(e,(t=>t.time))]).range([r,0]);o.append("text").attr("class","axis-label").attr("text-anchor","middle").attr("x",s-120).attr("y",r+40).attr("color","white").text("Question Number"),o.append("text").attr("class","axis-label").attr("text-anchor","middle").attr("transform","rotate(-90)").attr("x",-innerHeight/2+40).attr("y",25-i.left).text("Time Taken(in s)").attr("color","white"),o.append("g").attr("transform",`translate(0, ${r})`).call(qy(ky,l)),o.append("g").call(function(t){return qy(Iy,t)}(u)),o.selectAll("circle").data(e).enter().append("circle").attr("cx",((t,e)=>l(e+1))).attr("cy",(t=>u(t.time))).attr("r",(t=>c(t.time))).attr("fill",(t=>a(t.type))).append("text").text((function(t){return t.no}));var n=o.selectAll("g").data(e).enter().append("g").attr("transform",(function(t){return"translate("+l(t.time)+","+u(t.questionNumber)+")"}));n.append("circle").attr("r",(function(t){return sizeScale(t.time)})).attr("fill",(function(t){return"correct"==t.result?"green":"incorrect"==t.result?"red":"gray"})),n.append("text").text((function(t){return"Q"+t.no})).attr("x",(function(t){return sizeScale(t.time)+5})).attr("y",5)}catch{}}("fto_draw",f)}catch{return Vb("te_title").innerText="ERROR",Qb("testend",1),0}}catch{}}var p,m,g}()),nE.includes("testreport")&&(eE="testv1",async function(){Vb("tt_footer").style.display="none",Vb("tt_sub").style.display="none",Vb("tt_timeleft").style.display="none",Vb("tt_marksaward").style.display="block";var t=window.location.hash.split("#/testreport/")[1],e=Qp(Nb,"tests",t),n=await hg(e);if(n.exists()){gE=n.data();var i=0;if(Vb("tt_testname").innerText=gE.title,e=Qp(Nb,"tests",t,"responses","finished"),(n=await hg(e)).exists())for(var s of n.data().finished)if(Rb.currentUser.uid==s){i=1;break}if(0==i)Qb("testend",1),Vb("te_title").innerText="You Have NOT Attempted This Test";else if(Date.now()/1e3<=gE.endon.seconds&&0==gE.noresult)Qb("testend",1),Vb("te_title").innerText="Detailed Test Reports will be available after deadline";else{try{if(e=Qp(Nb,"tests",t,"questions","questions"),(n=await hg(e)).exists()&&(vE=n.data()),e=Qp(Nb,"tests",t,"responses",Rb.currentUser.uid),(n=await hg(e)).exists()){var r=n.data().answers;for(var o in bE=n.data().actions,r)_E.push({qid:o,ans:r[o].ans,type:r[o].type,time:r[o].time})}e=Qp(Nb,"tests",t,"questions","answers"),(n=await hg(e)).exists()&&(TE=n.data())}catch{return Vb("te_title").innerText="ERROR",Qb("testend",1),0}VT()}}}()),nE.includes("printable/qbank")&&1==n&&(eE="printable",wT(1)),nE.includes("ARIEL")&&1==n&&(eE="Ariel"),nE.includes("printable/tests")&&1==n&&(eE="printable",wT(3)),"functions"==nE&&1==n&&(eE="functions",lT()),nE.includes("users")&&1==n&&(eE="users",userUpdate()),nE.includes("topic")&&(eE="topic",yT(1)),nE.includes("printable/topic")&&1==n&&(eE="printable",wT(2)),nE.includes("livequiz")&&(eE="livequiz",async function(){lquizcode=nE.split("livequiz")[1];var t=Qp(Nb,"livequiz",lquizcode),e=await hg(t);if(!e.exists())throw new Error;e.data()}()),nE.includes("edit_sim")&&1==n&&(eE="fu_simulation",async function(){try{let e=await hg(Qp(Nb,"sims",window.location.hash.split("edit_sim/")[1]));if(e.exists()){var t=e.data();Vb("aq_simname").value=t.name,Vb("aq_simprov").value=t.provider,Vb("aq_simurl").value=t.url,Vb("aq_simlicense").value=t.license,Vb("aq_simsubj").value=t.subject}}catch{}}()),nE.includes("edit_lesson")&&1==n&&(eE="fu_simulation",prepareLesson()),nE.includes("edit_tpc")&&1==n&&(eE="fu_topic",dT(1)),nE.includes("edit_test")&&1==n&&(eE="fu_topic",dT(3)),nE.includes("edit_qubank")&&1==n&&(eE="fu_topic",dT(2)),nE.includes("edit_exams")&&1==n&&(eE="fu_topic",dT(4)),0!=YT&&null!=YT&&null!=YT||"login"==nE||"register"==nE||nE.includes("notes")||"legal"==nE||"about"==nE||"bugreport"==nE||"appinfo"==nE||"mainsformulas"==nE||"downloads"==nE||(eE="error_page"),Vb(eE).classList.add("_open"),zT(),uE=[],"forum"==nE?tT(1):(tT(2),nT=1,iT="afterbegin"),vE=[],_E=[],gE=[],wE=""}async function Xb(){await mg(Qp(Nb,"usernotes",window.location.hash.split("usernotes/")[1]),{title:Vb("un_title").value,notes:KT("un_editable"),lastupdated:wg(),type:Vb("un_viewership").value})}function Yb(){}function Jb(){window.location.hash="#/usernotes/"+this.id.split("uno")[1]}let Zb=function(){};async function tT(t){1==t?(Vb("forum_live").innerHTML="",Hb=Km(Wp(lm(),"forum"),Ym("sgndon","desc"),Zm(10)),Zb=yg(Hb,(function(t){t.docChanges().forEach((function(t){if("removed"===t.type)Vb("dM"+t.doc.id).remove();else if("added"==t.type){nT>=11&&(iT="beforeend");var e=t.doc.data();!function(t,e,n,i,s){if("shh5oUIhRpdBkEKQ3GCZwoKE9u42"==s){var r="<div id = 'dM"+t+"'><span class = 'dmName'>"+n+"👑: </span><span class = 'dmText'>"+i+"</span><span class = 'dmtime'>"+e+"</span></div>";Vb("forum_live").insertAdjacentHTML(iT,r)}else r="<div id = 'dM"+t+"'><span class = 'dmName'>"+n+": </span><span class = 'dmText'>"+i+"</span><span class = 'dmtime'>"+e+"</span></div>",Vb("forum_live").insertAdjacentHTML(iT,r)}(t.doc.id,"",e.name,e.message,e.userid),nT+=1}}))}))):2==t&&(Zb(),Zb=function(){})}Vb("fm_send").addEventListener("click",(async function(){var t=Vb("fm_message").value;if(t.includes("/pinned")){t=t.split("/pinned")[1];try{await mg(Qp(Nb,"forum","pinned"),{message:t})}catch{alert("You Dont Have The Privilages For This Command")}var e=await Ub("http://localhost:5500/time.html").then(async function(e){await mg(Qp(Nb,"forum","ppinned"),{ppinned:bg({message:t,user:WT.uuid,time:e})})}(e))}else""!=t&&null!=t?(await gg(Wp(Nb,"forum"),{name:WT.name,message:t,userid:WT.uuid,sgndon:wg()}),Vb("fm_message").value=""):alert("Message Cannot Be Empty")}));var eT,nT=1,iT="afterbegin";async function sT(){Vb("qbnk_vid_btn").style.display="none",Vb("qbnk_vid_btn_e").style.display="none";try{let o=await hg(Qp(Nb,"qbank",window.location.hash.split("qbnk_vid/")[1]));if(o.exists()){var t=o.data();Vb("tb_q_title").innerText=t.name,Vb("qb_vid_ti").innerText=t.name,Vb("qbnk_vid_q").style.display="none",Vb("qbnk_vid_ans").style.display="none",Vb("qbnk_vid_title").style.display="flex",Vb("qbnk_vid_end").style.display="none",Vb("watermark").style.display="none";let a=t.qllist,c=await async function(){return await navigator.mediaDevices.getDisplayMedia({audio:!0,video:{mediaSource:"screen"}})}();Fb(Vb("qbnk_vid")),$b=zb(c);var e,n=0,i=0,s=0,r=setInterval((function(){if(Vb("qbnk_vid_q").style.display="none",Vb("qbnk_vid_ans").style.display="none",Vb("qbnk_vid_title").style.display="none",Vb("qbnk_vid_end").style.display="none",0==i)Vb("qbnk_vid_title").style.display="flex",i++;else if(s==a.length-1)Vb("qbnk_vid_end").style.display="flex",setTimeout((function(){$b.stop(),Vb("qbnk_vid_btn").style.display="block"}),5e3),clearInterval(r);else if(0==n||1==n){!function(t){function e(t){t.style.display="none"}function n(t){t.style.display="block"}function i(t){t.style.display="flex"}var s=Vb("tb_q_mcq_con"),r=Vb("tb_q_matrix"),o=Vb("tb_q_answer");if(s.innerHTML="",Vb("tb_q_qtext").innerHTML=t.title+"<span class = 'sp_txt'>("+t.type+")</span>","mcq"==t.type||"mcq_multiple"==t.type){i(s),e(r),e(o);var a=t.op,c="";for(let t of a)c+='<div class="tb_q_mcq_p rpl">'+t+"</div>";Vb("tb_q_mcq_con").insertAdjacentHTML("beforeend",c)}else if("matrix"==t.type){e(s),n(r),e(o);for(var l=t.op1,u=t.op2,h=l.length,d=0;d<h;d++)document.getElementsByClassName("tp_i1")[d].innerHTML=l[d];for(d=0;d<h;d++)document.getElementsByClassName("tp_i2")[d].innerHTML=u[d]}else"numerical"==t.type||"fill"==t.type?(e(s),e(r),n(o)):"taf"==t.type?(i(s),e(r),e(o),c='<div class="tp_mcq_p rpl">True</div><div class="tp_mcq_p rpl">False</div>',Vb("tp_mcq_con").insertAdjacentHTML("beforeend",c)):(e(s),e(r),e(o));renderMathInElement(Vb("tp_ans_hold")),renderMathInElement(Vb("tp_qtext"))}(a[s]);var t=s+1;0==n&&(Vb("qbnk_timer").innerText=10,e=setInterval((function(){Vb("qbnk_timer").innerText=Vb("qbnk_timer").innerText-1}),1e3)),Vb("tb_q_qno").innerText="Question "+t+":",Vb("qbnk_vid_q").style.display="flex",n++}else if(2==n){Vb("qbnk_vid_ans").style.display="flex",clearInterval(e);for(var o="",c=0;c<a[s].answer.length;c++)o+='<div class="tb_q_mcq_p rpl" style = "background-color:green">'+a[s].answer[c]+"</div>";Vb("tb_q_ans").innerHTML=o,Vb("tb_q_hint").innerHTML=a[s].hint,Vb("tb_q_expl").innerHTML=a[s].expl,n=0,s++}}),5e3)}}catch{}}async function rT(){try{await mg(Qp(Nb,"sims",window.location.hash.split("edit_sim/")[1]),{name:Vb("aq_simname").value,license:Vb("aq_simlicense").value,provider:Vb("aq_simprov").value,url:Vb("aq_simurl").value,subject:Vb("aq_simsubj").value});var t=Vb("aq_simsubj").value;"physics"==t&&await mg(Qp(Nb,"sims","sims"),{physics:bg(Vb("aq_simname").value)}),"chemistry"==t&&await mg(Qp(Nb,"sims","sims"),{chemistry:bg(Vb("aq_simname").value)}),"maths"==t&&await mg(Qp(Nb,"sims","sims"),{maths:bg(Vb("aq_simname").value)}),"computer"==t&&await mg(Qp(Nb,"sims","sims"),{computer:bg(Vb("aq_simname").value)}),"biology"==t&&await mg(Qp(Nb,"sims","sims"),{biology:bg(Vb("aq_simname").value)}),"statistics"==t&&await mg(Qp(Nb,"sims","sims"),{statistics:bg(Vb("aq_simname").value)}),"unfiled"==t&&await mg(Qp(Nb,"sims","sims"),{unfiled:bg(Vb("aq_simname").value)}),function(){GT("aq_qtext",""),GT("aq_expl",""),Vb("aq_answer").value="",Vb("aq_yurl").value="",Vb("aq_hint").value="";for(var t=0;t<document.getElementsByClassName("aq_mcq").length;t++)document.getElementsByClassName("aq_mcq")[t].value="";for(t=0;t<document.getElementsByClassName("aq_i1").length;t++)document.getElementsByClassName("aq_i1")[t].value="";for(t=0;t<document.getElementsByClassName("aq_i2").length;t++)document.getElementsByClassName("aq_i2")[t].value=""}()}catch(t){console.error("Error writing new message to Firebase Database",t)}}function oT(){!async function(t){var e;const n=Km(Wp(Nb,"sims"),Wm("name","==",t));(await fg(n)).forEach((t=>{e=t.id})),Qb("sims/"+e,1)}(this.innerText)}async function aT(t){if(Vb("sim_cont").innerHTML="",0==rE.length){var e=Qp(Nb,"sims","sims"),n=await hg(e);if(!n.exists())throw Qb("error_page",1),new Error;var i=n.data();rE=i}if("physics"==t)try{for(let t of rE.physics)""!=t&&(Vb("sim_cont").insertAdjacentHTML("beforeend",'<span class="tlinks rpl" style = "color:pink" id="sim'+btoa(t)+'">'+t+"</span>"),Vb("sim"+btoa(t)).addEventListener("click",oT))}catch{}if("chemistry"==t)try{for(let t of rE.chemistry)""!=t&&(Vb("sim_cont").insertAdjacentHTML("beforeend",'<span class="tlinks rpl" style = "color:crimson" id="sim'+btoa(t)+'">'+t+"</span>"),Vb("sim"+btoa(t)).addEventListener("click",oT))}catch{}if("maths"==t)try{for(let t of rE.maths)""!=t&&(Vb("sim_cont").insertAdjacentHTML("beforeend",'<span class="tlinks rpl" style = "color:turquoise" id="sim'+btoa(t)+'">'+t+"</span>"),Vb("sim"+btoa(t)).addEventListener("click",oT))}catch{}if("biology"==t)try{for(let t of rE.biology)""!=t&&(Vb("sim_cont").insertAdjacentHTML("beforeend",'<span class="tlinks rpl" style = "color:lime" id="sim'+btoa(t)+'">'+t+"</span>"),Vb("sim"+btoa(t)).addEventListener("click",oT))}catch{}if("computer"==t)try{for(let t of rE.computer)""!=t&&(Vb("sim_cont").insertAdjacentHTML("beforeend",'<span class="tlinks rpl" style = "color:violet" id="sim'+btoa(t)+'">'+t+"</span>"),Vb("sim"+btoa(t)).addEventListener("click",oT))}catch{}if("statistics"==t)try{for(let t of rE.statistics)""!=t&&(Vb("sim_cont").insertAdjacentHTML("beforeend",'<span class="tlinks rpl" style = "color:orange" id="sim'+btoa(t)+'">'+t+"</span>"),Vb("sim"+btoa(t)).addEventListener("click",oT))}catch{}if("unfiled"==t)try{for(let t of rE.unfiled)""!=t&&(Vb("sim_cont").insertAdjacentHTML("beforeend",'<span class="tlinks rpl" style = "color:white" id="sim'+btoa(t)+'">'+t+"</span>"),Vb("sim"+btoa(t)).addEventListener("click",oT))}catch{}}function cT(){var t=[Vb("aq_answer").value],e=Vb("aq_type").value,n=[],i=[],s=[];if("mcq"==e||"mcq_multiple"==e)for(t=[],o=0;o<document.getElementsByClassName("aq_mcq_ans").length;o++){var r=document.getElementsByClassName("aq_mcq_ans")[o].value;t[o]=r}for(var o=0;o<document.getElementsByClassName("aq_mcq").length;o++)n.push(document.getElementsByClassName("aq_mcq")[o].value);for(o=0;o<document.getElementsByClassName("aq_i1").length;o++)i.push(document.getElementsByClassName("aq_i1")[o].value);for(o=0;o<document.getElementsByClassName("aq_i2").length;o++)s.push(document.getElementsByClassName("aq_i2")[o].value);if(nE.includes("edit_test"))var a={qid:lE,mode:Vb("aq_mode").value,title:KT("aq_qtext"),y_url:Vb("aq_yurl").value,hint:Vb("aq_hint").value,expl:KT("aq_expl"),type:e,answer:t,op:n,op1:i,op2:s,section:Vb("aq_section").value,pm:Vb("aq_posmrks").value,nm:Vb("aq_negmrks").value};else if(nE.includes("edit_exams"))a={id:lE,name:Vb("aq_examname").value,date:Vb("aq_examdate").value,info:Vb("aq_examinfo").value,syllabus:Vb("aq_examsyllabus").value,mode:"exams"};else a={id:lE,mode:Vb("aq_mode").value,title:KT("aq_qtext"),y_url:Vb("aq_yurl").value,hint:Vb("aq_hint").value,expl:KT("aq_expl"),type:e,answer:t,op:n,op1:i,op2:s,section:Vb("aq_section").value,pm:Vb("aq_posmrks").value,nm:Vb("aq_negmrks").value};return a}async function lT(t){function e(t){t.style.display="none"}function n(t){t.style.display="block"}function i(t){t.style.display="flex"}var s=Vb("aq_mode").value,r=Vb("aq_ans_hold"),o=Vb("aq_type"),a=Vb("aq_answer"),c=Vb("aq_yurl"),l=Vb("aq_mcq_con"),u=Vb("aq_matrix"),h=(Vb("aq_upl"),Vb("aq_all"));Vb("aq_tpc"),Vb("aq_qbk"),Vb("aq_sims");"question"==s?(e(c),n(r),n(o),n(a),i(h)):"lesson"==s?(n(c),e(r),e(o),e(a),i(h)):"exams"==s&&(e(c),e(r),e(o),e(a),e(h)),"mcq"==o.value||"mcq_multiple"==o.value?(i(l),e(u),e(a)):"matrix"==o.value?(n(u),e(l),e(a)):(e(u),e(l),n(a))}function uT(t){hT(this.innerText)}function hT(t){if("+"==t){let e=uE.length;window.location.hash.includes("edit_exams")?uE[e]={id:Date.now()+Math.random().toString(36).substr(2),name:"",date:"",info:"",syllabus:"",mode:"exams"}:uE[e]={id:Date.now()+Math.random().toString(36).substr(2),mode:"",title:"",y_url:"",img:"",hint:"",expl:"",type:"mcq",answer:["1"],op:["1","2","3","4"],op1:[],op2:[],section:"Unfiled",pm:4,nm:-1},(window.location.hash.includes("edit_qubank")||window.location.hash.includes("edit_test"))&&(uE[e].mode="question"),nE.includes("edit_test")&&(uE[e].qid=uE[e].id),t=e}Vb("question_list").innerHTML="";for(var e=1;e<uE.length+1;e++)Vb("question_list").insertAdjacentHTML("beforeend",'<span class = "t_no_qno" id = "t_no_qno_'+e+'">'+e+"</span>"),Vb("t_no_qno_"+e).addEventListener("click",uT);Vb("question_list").insertAdjacentHTML("beforeend",'<span class = "t_no_qno" id = "t_no_qno_add">+</span>'),Vb("t_no_qno_add").addEventListener("click",uT),0!=t&&(uE[cE-1]=cT(),cE=t);var n=uE[cE-1];if(window.location.href.includes("edit_exams"))return Vb("aq_examname").value=n.name,Vb("aq_examdate").value=n.date,Vb("aq_examinfo").value=n.info,Vb("aq_examsyllabus").value=n.syllabus,void lT();if(lE=nE.includes("edit_test")?n.qid:n.id,Vb("aq_mode").value=n.mode,GT("aq_qtext",n.title),Vb("aq_yurl").value=n.y_url,Vb("aq_type").value=n.type,Vb("aq_hint").value=n.hint,Vb("aq_section").value=n.section,Vb("aq_posmrks").value=n.pm,Vb("aq_negmrks").value=n.nm,GT("aq_expl",n.expl),"mcq"==n.type||"mcq_multiple"==n.type){Vb("aq_mcq_con").innerHTML="";for(var i=0;i<n.op.length;i++){kT(),document.getElementsByClassName("aq_mcq")[i].value=n.op[i];for(var s=0;s<n.answer.length;s++)n.op[i]==n.answer[s]&&(document.getElementsByClassName("aq_mcq")[i].classList.add("aq_mcq_ans"),document.getElementsByClassName("aq_mcq_p")[i].style.borderColor="lime")}}else"numerical"!=n.type&&"explain"!=n.type&&"fill"!=n.type&&"taf"!=n.type||(Vb("aq_answer").value=n.answer[0]);lT()}async function dT(t){var e,n;1==t?(e="topic",n=window.location.hash.split("edit_tpc/")[1],Vb("fu_topic_title").innerText="Add/Edit Topic",Vb("aq_mode").innerHTML='<option value="question">Question</option><option value="lesson">Lesson</option>',Vb("aq_tpc_save").style.display="block",Vb("aq_qbc_save").style.display="none",Vb("aq_tst_save").style.display="none",Vb("aq_test_extra").style.display="none",Vb("aq_exam_save").style.display="none",Vb("aq_exams").style.display="none",Vb("aq_all").style.display="flex",Vb("aq_ans_hold").style.display="flex"):2==t?(e="qbank",n=window.location.hash.split("edit_qubank/")[1],Vb("fu_topic_title").innerText="Add/Edit QBank",Vb("aq_mode").innerHTML='<option value="question">Question</option>',Vb("aq_tpc_save").style.display="none",Vb("aq_tst_save").style.display="none",Vb("aq_test_extra").style.display="none",Vb("aq_qbc_save").style.display="block",Vb("aq_exam_save").style.display="none",Vb("aq_exams").style.display="none",Vb("aq_all").style.display="flex",Vb("aq_ans_hold").style.display="flex"):3==t?(e="tests",n=window.location.hash.split("edit_tests/")[1],Vb("fu_topic_title").innerText="Add/Edit Tests",Vb("aq_mode").innerHTML='<option value="question">Question</option>',Vb("aq_tpc_save").style.display="none",Vb("aq_qbc_save").style.display="none",Vb("aq_test_extra").style.display="flex",Vb("aq_tst_save").style.display="block",Vb("aq_exam_save").style.display="none",Vb("aq_exams").style.display="none",Vb("aq_all").style.display="flex",Vb("aq_ans_hold").style.display="flex"):4==t&&(e="quarkz",n="exams",Vb("fu_topic_title").innerText="Add/Edit Exams",Vb("aq_mode").innerHTML='<option value="exam">Exam</option>',Vb("aq_tpc_save").style.display="none",Vb("aq_qbc_save").style.display="none",Vb("aq_test_extra").style.display="none",Vb("aq_exam_save").style.display="block",Vb("aq_tst_save").style.display="none",Vb("aq_exams").style.display="flex",Vb("aq_all").style.display="none",Vb("aq_ans_hold").style.display="none");try{let r=await hg(Qp(Nb,e,n));if(r.exists())if(1==t||2==t){var i=r.data();Vb("aq_tpcname").value=i.name,Vb("aq_tpclevel").value=i.level,Vb("aq_tpc_subj").value=i.subject,Vb("aq_tpc_chapterid").value=i.chid,uE=i.qllist,hT(0)}else if(3==t){i=r.data();function s(t){var e=new Date(t);return e.setMinutes(e.getMinutes()-e.getTimezoneOffset()),e.toISOString().slice(0,16)}Vb("aq_tpcname").value=i.title,Vb("aq_tpclevel").value=i.level,Vb("aq_tpc_subj").value=i.subject,Vb("aq_tst_batches").value=i.batch.toString(),Vb("aq_tst_stron").value=s(1e3*i.strton.seconds),Vb("aq_tst_endon").value=s(1e3*i.endon.seconds),Vb("aq_tst_timealotted").value=i.timeallotted,Vb("aq_tst_syllabi").value=i.syllabus;let o=await hg(Qp(Nb,"tests",n,"questions","questions")),a=await hg(Qp(Nb,"tests",n,"questions","answers")),c=[],l=[];if(o.exists())c=o.data().questions;if(a.exists())l=a.data().questions;uE=Bb(c,l),hT(0)}else if(4==t){i=r.data();uE=i.examinfo,hT(0)}}catch{}}function fT(){for(var t=0;t<uE.length;t++)uE[t].qid!=lE&&uE.id!=lE||(uE.splice(t,1),hT(0),null==(lE=uE[t-1].qid||uE[t-1].id)&&(lE=""))}async function pT(t){for(var e=0;e<uE.length;e++)uE[e].qid!=lE&&uE.id!=lE||(uE[e]=cT());var n,i;if(1==t?(n="topic",i=window.location.hash.split("edit_tpc/")[1]):2==t?(n="qbank",i=window.location.hash.split("edit_qubank/")[1]):3==t?(n="tests",i=window.location.hash.split("edit_tests/")[1]):4==t&&(n="quarkz",i="exams"),1==t||2==t)try{await mg(Qp(Nb,n,i),{name:Vb("aq_tpcname").value,qllist:uE,level:Vb("aq_tpclevel").value,chid:Vb("aq_tpc_chapterid").value,subject:Vb("aq_tpc_subj").value})}catch{}else if(3==t){try{var s=new Date(Vb("aq_tst_stron").value),r=new Date(Vb("aq_tst_endon").value),o=Vb("aq_tst_batches").value.split(",");await mg(Qp(Nb,n,i),{title:Vb("aq_tpcname").value,timeallotted:Vb("aq_tst_timealotted").value,syllabus:Vb("aq_tst_syllabi").value,strton:s,endon:r,batch:o})}catch{}var a=[],c=[];for(e=0;e<uE.length;e++){var l=uE[e];a.push({qid:l.qid,mode:l.mode,title:l.title,type:l.type,op:l.op,op1:l.op1,op2:l.op2,section:l.section,pm:l.pm,nm:l.nm}),c.push({qid:l.qid,hint:l.hint,expl:l.expl,answer:l.answer,section:l.section,pm:l.pm,nm:l.nm})}try{await mg(Qp(Nb,n,i,"questions","questions"),{questions:a})}catch(t){jb(t)}try{await mg(Qp(Nb,n,i,"questions","answers"),{questions:c})}catch{}}else if(4==t){await mg(Qp(Nb,n,i),{examinfo:uE})}}function mT(){window.location.hash="#/qbanks/"+atob(this.id.split("chpqbk")[1])}function gT(){window.location.hash="#/topic/"+atob(this.id.split("chptpc")[1])}async function yT(t){var e="",n="";1==t?(e="topic",n="topic"):2==t?(n="qbanks",e="qbank"):e="topic";var i=n+"/",s=window.location.hash.split(i)[1],r=Qp(Nb,e,s),o=await hg(r);if(!o.exists())throw Qb("error_page",1),new Error;var a=o.data();(iE={}).title=a.name,iE.qllist=a.qllist,ET(3)}function vT(){window.location.hash="#/chapter/"+atob(this.id.split("qb")[1])}function _T(t){Vb("qb_cont_2").innerHTML="";for(var e=0;e<oE.length;e++){var n=oE[e];n.subject==t&&(Vb("qb_cont_2").insertAdjacentHTML("beforeend",'<span class="tlinks rpl" style = "color:pink" id="qb'+btoa(n.id)+'">'+n.name+"</span>"),Vb("qb"+btoa(n.id)).addEventListener("click",vT))}}async function wT(t){var e="";1==t?(e="qbank",Vb("pe_tst_info").style.display="flex",Vb("eqb_instr").style.display="none"):2==t?(e="topic",Vb("pe_tst_info").style.display="none",Vb("eqb_instr").style.display="none"):e=3==t?"tests":"qbank";var n,i,s,r,o=window.location.hash.split("printable/"+e+"/")[1],a=Vb("qb_title"),c=Qp(Nb,e,o),l=await hg(c);if(!l.exists())throw Qb("error_page",1),new Error;n=(b=l.data()).qllist,a.innerText=b.name,Vb("eqb_add").innerHTML="";for(let t of n)if("question"==t.mode){i=(b=t).title,s=b.type,null==(r=b.img)&&(r="");var u='<div class = "q_ans_expl" style = "font-weight:bold;color:green;font-size:10px;flex-direction:row;display:none;">Explaination:'+b.expl+"</div>",h="<div style = 'font-weight:bold;color:green;font-size:10px;flex-direction:row;display:none' class = 'q_ans_1'>Answer:",d='<div class = "qbtp_q"><div id = "'+t.id+'">'+i+'<div class = "qb_q_ty">('+s+")</div></div>";if(Vb("eqb_add").insertAdjacentHTML("beforeend",d),""!=r){var f='<div class = "qb_img"><img src = "'+r+'"></div>';Vb(t.id).insertAdjacentHTML("beforeend",f)}var p="";if("mcq"==s||"mcq_multiple"==s){var m=b.op;for(let t of m)p+="<div class = 'qb_mcq_opt'>"+t+"</div>";var g='<div class = "qb_mcq_exp" type = "a">'+p+"</div>";for(let t of b.answer)h+="<div class = 'qb_mcq_ans'>"+t+"</div>"}if("taf"==s&&(g='<ol class = "qb_mcq_exp" type = "a"><li>True</li><li>False</li></ol>'),"explain"!=s&&"numerical"!=s&&"fill"!=s||(g=""),"matrix"==s){for(var y=b.op1,v=b.op2,_=y.length,w=0;w<_;w++)p+="<tr><td>"+y[w]+"</td><td>"+v[w]+"</td>";g="<table>"+p+"</table>"}Vb(t.id).insertAdjacentHTML("beforeend",g),Vb(t.id).insertAdjacentHTML("beforeend",h+"</div>"),Vb(t.id).insertAdjacentHTML("beforeend",u),renderMathInElement(Vb("eqb_add"))}else if("lesson"==t.mode){var b;i=(b=t).title,s=b.type,r=b.img;d='<div class = "les_q"><div id = "'+t.id+'"><div style = "font-size:3vh;">'+i+'</div><hr color="white" width="100%"></div>';Vb("eqb_add").insertAdjacentHTML("beforeend",d);u='<div class = "les_expl" style = "">'+b.expl+'</div><hr color="white" width="100%">';Vb(t.id).insertAdjacentHTML("beforeend",u),renderMathInElement(Vb("eqb_add"))}Vb("printable").insertAdjacentHTML("beforeend","<br></br>")}function bT(t){1==t?Vb("mainsformulas").innerHTML='\n    <span style="font-size: 5vh;color:yellow" id="fm_title">Mains Formula Sheet</span>\n    <hr color="white" width="100%">\n    <div style="overflow-y: scroll;height:50vh;" class="flex_type">\n    <span class="tlinks rpl" onclick = "window.location.hash = \'/notes/PHYFORMULAS\'">Physics Formula Sheet</span>\n    <span class="tlinks rpl" onclick = "window.location.hash = \'/notes/MATHFORMULAS\'">Maths Formula Sheet</span>\n    <span class="tlinks rpl" onclick = "window.location.hash = \'/notes/PCHEMNOTES\'">Physical Chemistry Formula Sheet</span>\n    <span class="tlinks rpl" onclick = "window.location.hash = \'/notes/OCHEMNOTES\'">Organic Chemistry Formula Sheet</span>\n    <span class="tlinks rpl" onclick = "window.location.hash = \'/notes/ICHEMNOTES\'">Inorganic Chemistry Formula Sheet</span>\n    </div>\n    <span style="font-size: 8px;">All PDF\'s Are Owned by their Respective Owners</span>\n    ':2==t&&(Vb("downloads").innerHTML='\n    <span style="font-size: 5vh;color:yellow" id="fm_title">Downloads</span>\n    <hr color="white" width="100%">\n    <div style="overflow-y: scroll;height:50vh;" class="flex_type">\n      \n    </div>\n    ')}async function TT(t){var e;Vb("tp_question").style.display="none",Vb("tp_lesson").style.display="block",""==t.y_url?Vb("tp_full_vid").style.display="none":(Vb("tp_full_vid").style.display="flex",e=t.y_url,window.player.loadVideoById(e)),Vb("tp_lsno").innerText=t.title,Vb("tp_expl").innerHTML=t.expl}async function ET(t){var e;e=1==t?-1:1,(sE<iE.qllist.length&&2==t||1==t&&sE>0)&&(sE+=e),3==t&&(sE=0);var n=iE.title;Vb("tp_title").innerText=n;var i=iE.qllist[sE];"lesson"==i.mode?TT(i):"question"==i.mode&&async function(t,e){function n(t){t.style.display="none"}function i(t){t.style.display="block"}function s(t){t.style.display="flex"}n(Vb("tp_hint")),n(Vb("tp_a_expl")),n(Vb("tp_e_answer")),n(Vb("tp_status"));var r=Vb("tp_mcq_con"),o=Vb("tp_matrix"),a=Vb("tp_answer");if(Vb("tp_lsno").innerText="Question",Vb("tp_question").style.display="flex",Vb("tp_lesson").style.display="none",Vb("tp_question").setAttribute("dataid",t.id),Vb("tp_question").setAttribute("qtype",t.type),r.innerHTML="",Vb("tp_qtext").innerHTML=t.title,Vb("tp_img").src="","mcq"==t.type||"mcq_multiple"==t.type){s(r),n(o),n(a);var c=t.op,l="";for(let t of c)l+='<div class="tp_mcq_p rpl" onclick = "mcqchose(this)">'+t+"</div>";Vb("tp_mcq_con").insertAdjacentHTML("beforeend",l)}else if("matrix"==t.type){n(r),i(o),n(a);for(var u=t.op1,h=t.op2,d=u.length,f=0;f<d;f++)document.getElementsByClassName("tp_i1")[f].innerText=u[f];for(f=0;f<d;f++)document.getElementsByClassName("tp_i2")[f].innerText=h[f]}else"numerical"==t.type||"fill"==t.type?(n(r),n(o),i(a)):"taf"==t.type?(s(r),n(o),n(a),l='<div class="tp_mcq_p rpl">True</div><div class="tp_mcq_p rpl">False</div>',Vb("tp_mcq_con").insertAdjacentHTML("beforeend",l)):(n(r),n(o),n(a));renderMathInElement(Vb("tp_ans_hold")),renderMathInElement(Vb("tp_qtext"))}(i),zT()}function kT(){Vb("aq_mcq_con").insertAdjacentHTML("beforeend",'<div class="aq_mcq_p" onclick="changeColor(this)"><input class="aq_mcq"></div>')}function IT(){document.getElementsByClassName("aq_mcq_p")[document.getElementsByClassName("aq_mcq").length-1].remove()}function AT(){for(var t=Vb("eqb_add"),e=t.children.length;e>=0;e--)t.appendChild(t.children[Math.random()*e|0])}function CT(){On(Rb,WT.email).then((()=>{jb("Success","Password Reset Email sent.")})).catch((t=>{t.code;jb("Failure",t.message)}))}async function ST(t){Vb("prf_pphoto");var e,n,i=Vb("prf_name"),s=Vb("prf_phone"),r=Vb("prf_email"),o=Vb("prf_class"),a=Vb("prf_batch"),c=Vb("prf_gender"),l=Vb("prf_crton"),u=Vb("tmt_frame"),h=Vb("spoints");if(t){var d=Qp(Nb,"users",t.uid);if((g=await hg(d)).exists()){var f=g.data();(WT=f).uuid=t.uid,Vb("dshd_uname").innerText=f.email,Vb("dshd_name").innerText=f.name,i.textContent=f.name,s.textContent=f.mblno,r.textContent=f.email,o.textContent=f.class,l.textContent=new Date(1e3*f.sgndon.seconds).toDateString(),c.textContent=f.gen,e=f.batch,f.course,h.textContent=f.spoints,YT=f.roles.user,QT=f.roles.editor,XT=f.roles.admin,WT.usernotes=f.usernotes}1==f.deleted&&(jb("Warning","User Account Has Been Deleted"),Gb()),"Male"==f.gen?(Vb("prf_tab_img").classList.remove("prf_male","prf_female"),Vb("prf_tab_img").classList.add("prf_male"),Vb("prf_tab_t_t_img").classList.remove("prf_male","prf_female"),Vb("prf_tab_t_t_img").classList.add("prf_male")):"Female"==f.gen&&(Vb("prf_tab_img").classList.remove("prf_male","prf_female"),Vb("prf_tab_img").classList.add("prf_female"),Vb("prf_tab_t_t_img").classList.remove("prf_male","prf_female"),Vb("prf_tab_t_t_img").classList.add("prf_female"));try{d=Qp(Nb,"batch",e);if((g=await hg(d)).exists()){f=g.data();a.textContent=f.name,Vb("dshd_batch").innerText=f.name,n=f.timetable,async function(t,e){if(dE!=[]){var n=Qp(Nb,"batch",t,"info","tests"),i=await hg(n);if(i.exists()){var s=i.data();dE=s.tests}}if(mE!=[]){const t=Km(Wp(Nb,"tests"),Wm("finished","array-contains",e),Zm(5));(await fg(t)).forEach((t=>{var e=t.data(),n={title:e.title,testid:t.id,finished:!0,strton:e.strton,endon:e.endon};mE.push(n);var i=0;for(let t of dE)t.testid==n.testid?dE[i].finished=!0:dE[i].finished=!1,i+=1}))}for(var r=parseInt(Date.now()/1e3),o=0;o<dE.length;o++)r>dE[o].strton.seconds&&r<dE[o].endon.seconds?fE.push(dE[o]):r<dE[o].strton.seconds&&pE.push(dE[o])}(e,t.uid);var p="https://calendar.google.com/calendar/embed??height=600&wkst=2&bgcolor=%23ffffff&ctz=Asia%2FKolkata&showTitle=0&showCalendars=0&showTabs=0&showPrint=0&showDate=1&src="+n+"%40group.calendar.google.com&amp;ctz=Asia%2FKolkata";if(u.src=p,f.delon.seconds<=parseInt(Date.now()/1e3))throw jb("Warning","This Batch Has Been Deleted"),Gb(),window.reload(),new Error("DENIED");for(var m=0;m<f.chlist.length;m++)oE.push({name:f.chlist[m].name,id:f.chlist[m].id,subject:f.chlist[m].subject})}}catch{}Vb("lg_uname").value="",Vb("lg_pass").value="",h.style.display="block",Vb("dsh_btn").style.display="block",""!=window.location.hash&&null!=window.location.hash&&null!=window.location.hash||(window.location.hash="#/dashboard",hE=1);var g;d=Qp(Nb,"quarkz","exams");if((g=await hg(d)).exists()){f=g.data();Vb("db_exam_list").innerHTML="",""!=f.warning&&jb("Notice",f.warning,(function(){window.location.hash="#/usernotes/releasenotes"}),"Release Notes");for(m=0;m<f.examinfo.length;m++){var y=f.examinfo[m];Vb("db_exam_list").insertAdjacentHTML("beforeend",'<div class = "tlinks_min rpl"><span style="font-size: 16px;" onclick = "examlog(\''+y.name+"','"+y.date+"','"+y.info+"','"+y.syllabus+"')\">"+y.name+"</span></div>")}}Qb(window.location.hash.split("#/")[1],1),async function(){for(var t=0;t<WT.usernotes.length;t++)Vb("un_list").insertAdjacentHTML("beforeend","<div class='t_notes' id='uno"+WT.usernotes[t].id+"' style='background-color: "+WT.usernotes[t].color+"'><span class='tntc2' id='"+WT.usernotes[t].id+"'>"+WT.usernotes[t].title+"</span></div>"),Vb("uno"+WT.usernotes[t].id).addEventListener("click",Jb)}()}else i.textContent="",s.textContent="",r.textContent="",o.textContent="",h.textContent="",h.style.display="none",Vb("dsh_btn").style.display="none",Vb("tp_pnt").style.display="none",Vb("tp_edt").style.display="none",Qb("login",1),1==hE&&document.location.reload()}function xT(){for(var t,e,n,i,s=Vb("tp_question").getAttribute("dataid"),r=Vb("tp_question").getAttribute("qtype"),o=0;o<iE.qllist.length;o++)if(iE.qllist[o].id==s){e=iE.qllist[o].answer,n=iE.qllist[o].expl,i=iE.qllist[o].hint;break}if("numerical"!=r&&"fill"!=r||(e==(t=Vb("tp_answer").value)?(Vb("tp_status").innerText="Correct Answer",1):(Vb("tp_status").innerText="Wrong Answer",0)),"mcq"==r||"mcq_multiple"==r||"taf"==r){t=[];for(var a=0;a<document.getElementsByClassName("tp_mcq_p").length;a++)document.getElementsByClassName("tp_mcq_p")[a].classList.contains("aq_mcq_ans")&&t.push(document.getElementsByClassName("tp_mcq_p")[a].innerText);Mb(t,e)?(Vb("tp_status").innerText="Correct Answer",1):(Vb("tp_status").innerText="Wrong Answer",0)}Vb("tp_status").style.display="block",Vb("tp_hint").style.display="block",Vb("tp_a_expl").style.display="block",Vb("tp_e_answer").style.display="block",Vb("tp_a_expl").innerHTML=n,Vb("tp_hint").innerHTML=i,Vb("tp_e_answer").innerHTML="Answer:"+e}function NT(){window.location.hash.includes("topic")?qT("printable/topic/"+window.location.hash.split("topic/")[1],1):window.location.hash.includes("qbanks")&&qT("printable/qbank/"+window.location.hash.split("qbanks/")[1],1),window.location.hash.includes("edit_tpc/")?qT("printable/topic/"+window.location.hash.split("edit_tpc/")[1],1):window.location.hash.includes("edit_qubank/")&&qT("printable/qbank/"+window.location.hash.split("edit_qubank/")[1],1)}function RT(){window.location.hash.includes("topic")?qT("edit_tpc/"+window.location.hash.split("topic/")[1],1):window.location.hash.includes("qbanks")&&qT("edit_qubank/"+window.location.hash.split("qbanks/")[1],1)}function qT(t,e){window.location.hash="#/"+t,"dashboard"==t&&Qb("dashboard",1)}function LT(){window.location.hash="#/instructions/"+this.id}function DT(){window.location.hash="#/finished/"+this.id}function OT(t){var e;for(var n of("active"==t?e=fE:"upcoming"==t?e=pE:"finished"==t&&(e=mE),Vb("testlinks").innerHTML="",e)){var i=new Date(1e3*n.strton.seconds),s=new Date(1e3*n.endon.seconds),r='<div class="tlinks" id = "'+n.testid+'"><span class = "t_title">'+n.title+'</span><span class = "t_stron">Starts At:'+i+'</span><span class ="t_endon">Ends At:'+s+"</div>";"finished"!=t&&0==n.finished?(Vb("testlinks").insertAdjacentHTML("beforeend",r),Vb(n.testid).addEventListener("click",LT)):"finished"==t&&(Vb("testlinks").insertAdjacentHTML("beforeend",r),Vb(n.testid).addEventListener("click",DT))}}async function MT(t){var e;if(1==t){var n=window.location.hash.split("/finished/")[1],i=Qp(Nb,"tests",n,"questions","questions"),s=await hg(i);s.exists()&&(e=s.data().questions)}else 2==t&&(e=[],e=vE);for(var r={},o=0;o<bE.length;o++)bE[o].time=bE[o].time.seconds;var a,c,l,u,h,d,f=(a="time",c="type",0==(l=0)?u=(t,e)=>(n,i)=>n[t]===i[t]?n[e]>i[e]?1:-1:n[t]>i[t]?1:-1:1==l&&(u=(t,e)=>(n,i)=>n[t]===i[t]?n[e]>i[e]?-1:1:n[t]>i[t]?-1:1),bE.sort(u(a,c))),p="";for(o=0;o<f.length;o++)"b"==f[o].type?(h=f[o].time,p=f[o].value):"a"==f[o].type&&p==f[o].value&&(d=f[o].time,null==r[f[o].value]&&(r[f[o].value]={},r[f[o].value].time=0),r[f[o].value].time+=d-h,h=d,d=0);var m={Physics:{correct:0,unattempted:0,incorrect:0,total:0},Chemistry:{correct:0,unattempted:0,incorrect:0,total:0},Math:{correct:0,unattempted:0,incorrect:0,total:0},Biology:{correct:0,unattempted:0,incorrect:0,total:0},Computer:{correct:0,unattempted:0,incorrect:0,total:0},Statistics:{correct:0,unattempted:0,incorrect:0,total:0},Unfiled:{correct:0,unattempted:0,incorrect:0,total:0}},g=0,y=0,v=0;for(o=0;o<e.length;o++)for(var _=0;_<JT.length;_++)if(e[o].qid==JT[_].qid){var w=r[e[o].qid];null==r[e[o].qid]?(r[e[o].section]={},r[e[o].section].time=0):(m[e[o].section].total+=w.time,0==JT[o].marks?(m[e[o].section].unattempted+=w.time,v+=w.time):JT[o].marks==e[o].pm?(m[e[o].section].correct+=w.time,g+=w.time):(m[e[o].section].incorrect+=w.time,y+=w.time))}ZT={questions:r,subject:m,correct:g,incorrect:y,unattempted:v}}function PT(){FT(this.id,this.innerText)}async function UT(t){var e,n=[],i=[],s=[],r="";window.location.hash.includes("/attempt/")?(r=window.location.hash.split("#/attempt/")[1],jb("Warning","Submitting Tests Answers: Please Do Not Close The Tab.")):window.location.hash.includes("/finished/")?r=window.location.hash.split("#/finished/")[1]:window.location.hash.includes("/testreport/")&&(r=window.location.hash.split("#/testreport/")[1]);var o=Qp(Nb,"tests",r,"responses",Rb.currentUser.uid),a=await hg(o);if(a.exists()){var c=a.data().answers;for(var l in s=a.data().info,c)n.push({qid:l,ans:c[l].ans,type:c[l].type,time:c[l].time})}o=Qp(Nb,"tests",r,"questions","answers"),(a=await hg(o)).exists()&&(e=a.data().questions);for(var u=0,h=0,d=0,f={Physics:{correct:0,unattempted:0,incorrect:0,total:0},Chemistry:{correct:0,unattempted:0,incorrect:0,total:0},Math:{correct:0,unattempted:0,incorrect:0,total:0},Biology:{correct:0,unattempted:0,incorrect:0,total:0},Computer:{correct:0,unattempted:0,incorrect:0,total:0},Statistics:{correct:0,unattempted:0,incorrect:0,total:0},Unfiled:{correct:0,unattempted:0,incorrect:0,total:0}},p=0;p<e.length;p++)for(var m=0;m<n.length;m++)if(e[p].qid==n[m].qid){var g=n[m];null==g.ans&&(g.ans=[]),0==g.ans.length?(i.push({qid:e[p].qid,marks:0,type:"unattempted"}),u+=parseFloat(e[p].pm),f[e[p].section].unattempted+=parseFloat(e[p].pm),f[e[p].section].total+=parseFloat(e[p].pm)):Mb(e[p].answer,g.ans)?(i.push({qid:e[p].qid,marks:parseFloat(e[p].pm),type:"correct"}),h+=parseFloat(e[p].pm),f[e[p].section].correct+=parseFloat(e[p].pm),f[e[p].section].total+=parseFloat(e[p].pm)):(i.push({qid:e[p].qid,marks:parseFloat(e[p].nm),type:"incorrect"}),d+=parseFloat(e[p].nm),f[e[p].section].incorrect+=parseFloat(e[p].nm),f[e[p].section].total+=parseFloat(e[p].pm))}var y={correct:h,incorrect:d,unattempted:u,mList:i,total:f.Physics.total+f.Chemistry.total+f.Math.total+f.Biology.total+f.Computer.total+f.Statistics.total+f.Unfiled.total,usermarks:h+d,subjectmarks:f};1==t?Pb(y,s)||(jb("NOTICE","Please Wait, Marks Are Being Updated"),await mg(Qp(Nb,"tests",r,"responses",Rb.currentUser.uid),{info:y}),await mg(Qp(Nb,"tests",r,"responses","finished"),{leaderboard:bg({uid:WT.uuid,marks:y.usermarks,name:WT.name})}),Qb()):0==t&&(await mg(Qp(Nb,"tests",r,"responses",Rb.currentUser.uid),{info:y}),await mg(Qp(Nb,"tests",r,"responses","finished"),{leaderboard:bg({uid:WT.uuid,marks:y.usermarks,name:WT.name})}),Qb("testend",1)),document.getElementById("msg_popup").style.visibility="hidden",document.getElementById("msg_popup").style.opacity="0"}function FT(t,e){var n=new Date;yE=0,window.location.hash.includes("/attempt/")&&wE!=t&&bE.push({type:"a",time:n,value:wE}),Vb("tt_qno").innerText=e;try{Vb(wE).style.border=""}catch{}wE=t,window.location.hash.includes("/attempt/")&&bE.push({type:"b",time:n,value:wE}),Vb(wE).style.border="purple 3px solid";for(let e of vE.questions)if(t==e.qid){Vb("tt_qtitle").innerHTML="";var i='<div class = "qb_q" id = "Q'+e.qid+'"><div class = "qb_ttl">'+e.title+'<div id = "qb_q_ty" class = "qb_q_ty qb_qt_ty" >('+e.type+")</div></div></div>";Vb("tt_qtitle").insertAdjacentHTML("beforeend",i);var s,r,o="";if("mcq"==e.type){var a=e.op;for(let t of a)o+='<li><input type="radio" class = "q_ans" value = "'+t+'" name = "q_op">'+t+"</input></li>";var c='<ol class = "qb_mcq" type = "A">'+o+"</ol>"}if("mcq_multiple"==e.type){a=e.op;for(let t of a)o+='<li><input type="checkbox" class = "q_ans" value = "'+t+'" name = "q_op">'+t+"</input></li>";c='<ol class = "qb_mcq" type = "A">'+o+"</ol>"}if("taf"==e.type&&(c='<ol class = "qb_mcq" type = "A"><li>True</li><li>False</li></ol>'),"explain"!=e.type&&"numerical"!=e.type||(c=""),"matrix"==e.type){for(var l=e.op1,u=e.op2,h=l.length,d=0;d<h;d++)o+="<tr><td>"+l[d]+"</td><td>"+u[d]+"</td>";c="<table>"+o+"</table>"}switch(Vb("tt_qtitle").insertAdjacentHTML("beforeend",c),e.type){case"mcq":case"mcq_multiple":s="";break;case"taf":s='<div id = "tt_mcq"><span><input type="radio" value="a" class = "q_ans" name = "q_op">True</span><span><input type="radio" value="b" class = "q_ans" name = "q_op">False</span></div> ';break;case"numerical":s='<div id = "tt_num"><input type = "number" class="q_ans"></div>';break;case"matrix":s='<div id = "tt_matrix"><div>A<span><input type="checkbox" value="a" id="q_ans_a" name = "q_op">1</span><span><input type="checkbox" value="b" id="q_ans_a" name = "q_op">2</span><span><input type="checkbox" value="c" id="q_ans_a" name = "q_op">3</span><span><input type="checkbox" value="d" id="q_ans_a" name = "q_op">4</span></div><div>B<span><input type="checkbox" value="a" id="q_ans_a" name = "q_op">1</span><span><input type="checkbox" value="b" id="q_ans_a" name = "q_op">2</span><span><input type="checkbox" value="c" id="q_ans_a" name = "q_op">3</span><span><input type="checkbox" value="d" id="q_ans_a" name = "q_op">4</span></div><div>C<span><input type="checkbox" value="a" id="q_ans_a" name = "q_op">1</span><span><input type="checkbox" value="b" id="q_ans_a" name = "q_op">2</span><span><input type="checkbox" value="c" id="q_ans_a" name = "q_op">3</span><span><input type="checkbox" value="d" id="q_ans_a" name = "q_op">4</span></div><div>D<span><input type="checkbox" value="a" id="q_ans_a" name = "q_op">1</span><span><input type="checkbox" value="b" id="q_ans_a" name = "q_op">2</span><span><input type="checkbox" value="c" id="q_ans_a" name = "q_op">3</span><span><input type="checkbox" value="d" id="q_ans_a" name = "q_op">4</span></div></div>';break;case"fill":s='<div id="tt_fill"><input type = "text" class = "q_ans"></div>'}if(Vb("tt_qtitle").insertAdjacentHTML("beforeend",s),!window.location.hash.includes("attempt"))for(let e of TE.questions)if(t==e.qid){r=e.answer,null!=ZT&&(null==ZT.questions[e.qid]?Vb("tt_timespent").innerText="0 seconds":Vb("tt_timespent").innerText=Ob(ZT.questions[e.qid].time));var f='<div id="tg_answer">Answer: '+e.answer+'</div><div id="tg_expl">Explanation: '+e.expl+"</div>";Vb("tt_qtitle").insertAdjacentHTML("beforeend",f)}renderMathInElement(Vb("tt_qtitle"));for(let n of _E)if(n.qid==t){for(d=0;d<document.getElementsByClassName("q_ans").length;d++){var p=document.getElementsByClassName("q_ans")[d];if("mcq"==e.type||"mcq_multiple"==e.type){null==n.ans&&(n.ans=[]);for(let t of n.ans)if(p.value==t){p.checked=!0,1;break}}else p.value=n.ans,1}window.location.hash.includes("attempt")||(Mb(n.ans,r)?Vb("tt_marksaward").innerHTML='<div style="color:lime">Correct(+4)</div>':0==n.ans.length?Vb("tt_marksaward").innerHTML='<div style="color:orange">Unanswered(0)</div>':Vb("tt_marksaward").innerHTML='<div style="color:red">Incorrect(-1)</div>')}for(var m=0;m<_E.length;m++)_E[m].qid==wE&&"tts_notvisit"==_E[m].type&&window.location.hash.includes("attempt")&&(_E[m].type="tts_notanswer",jT("tts_notanswer"),_E[m].ans=[],Vb(wE).classList.remove("tts_notanswer","tts_notvisit","tts_answered","tts_review","tts_ansreview"),Vb(wE).classList.add("tts_notanswer"));break}}function VT(){var t=1;for(let t of["tw_Physics","tw_Chemistry","tw_Math","tw_Computer","tw_Statistics","tw_Biology","tw_Unfiled"])Vb(t+"_c").innerHTML="",Vb(t).style.display="none";for(let n of vE.questions){var e='<span class = "tts_notvisit" id = "'+n.qid+'">'+t+"</span>";t+=1,Vb("tw_"+n.section+"_c").insertAdjacentHTML("beforeend",e),Vb("tw_"+n.section).style.display="flex",Vb(n.qid).addEventListener("click",PT)}if(window.location.hash.includes("attempt"))Vb("tt_sub").style.display="block";else{for(let t of _E){var n=t.qid;for(let e of TE.questions)if(n==e.qid){var i=e.answer;null==t.ans&&(t.ans=[]),Mb(t.ans,i)?Vb(n).classList.add("t_crr"):0==t.ans.length?Vb(n).classList.add("t_unat"):Vb(n).classList.add("t_incrr")}}MT(2)}for(let t of _E)Vb(t.qid).classList.replace("tts_notvisit",t.type);FT(vE.questions[0].qid,1)}async function jT(t){if(!window.location.hash.includes("attempt"))return jb("Error","Performing Test Operations in Test Reports Is Prohibited"),1;var e="answers."+wE,n=window.location.hash.split("#/attempt/")[1],i=Vb("qb_q_ty").innerText.split("(")[1];if("tts_notanswer"==t){await mg(Qp(Nb,"tests",n,"responses",Rb.currentUser.uid),{[`${e}`]:{ans:"",type:"tts_notanswer",time:wg()}});var s=0;for(let t of _E){if(t.qid==wE){for(var r=0;r<document.getElementsByClassName("q_ans").length;r++){var o=document.getElementsByClassName("q_ans")[r];if("mcq"==i||"mcq_multiple"==i)for(var a=0;a<t.ans.length;a++){var c=t.ans[a];o.value==c&&(o.checked=!1)}else t.value=""}_E.splice(s,1)}s+=1}}else{var l=[];for(r=0;r<document.getElementsByClassName("q_ans").length;r++){o=document.getElementsByClassName("q_ans")[r];"mcq)"==i||"mcq_multiple)"==i?1==o.checked&&l.push(o.value):l.push(o.value)}"tts_review"==t&&(l=""),await mg(Qp(Nb,"tests",n,"responses",Rb.currentUser.uid),{[`${e}`]:{ans:l,type:t,time:wg()}});var u=0;for(let e of _E)e.qid==wE&&(e.ans=l,e.type=t,u=1);0==u&&_E.push({qid:wE,ans:l,type:t})}Vb(wE).classList.remove("tts_notanswer","tts_notvisit","tts_answered","tts_review","tts_ansreview"),Vb(wE).classList.add(t)}async function BT(){if(!window.location.hash.includes("attempt"))return jb("Error","Performing Test Operations in Test Reports Is Prohibited"),1;var t=new Date;bE.push({type:"a",time:t,value:wE}),bE.push({type:"end",time:t,value:"1"});var e=window.location.hash.split("#/attempt/")[1];window.onbeforeunload=function(){},window.onhashchange=Qb,await mg(Qp(Nb,"tests",e,"responses",Rb.currentUser.uid),{endon:wg(),actions:bE,warning:[]}).then((function(){_E=[]})),await mg(Qp(Nb,"tests",e,"responses","finished"),{finished:bg(Rb.currentUser.uid)}).then(UT(0));var n=new Date(1e3*gE.endon.seconds);Vb("te_endtime").innerText=n,dE=[],fE=[],pE=[],mE=[],gE=[],vE=[],wE="",Vb("dsh_btn").style.display="block",Vb("tp_pnt").style.display="none",clearInterval(eT)}function $T(t){1==t?(document.getElementById("msg_popup").style.visibility="hidden",document.getElementById("msg_popup").style.opacity="0"):0==t&&jb("WARNING","You Are Currently Offline.")}function HT(){Vb("un_preview").style.display="none",Vb("un_edit").style.display="none","preview"==Vb("un_rendermode").value?(Vb("un_preview").style.display="block",Vb("un_preview").innerHTML="<h1 style = 'text-align:center'>"+Vb("un_title").value+"</h1><br>"+KT("un_editable")):"edit"==Vb("un_rendermode").value&&(Vb("un_edit").style.display="flex"),Vb("uno"+window.location.hash.split("usernotes/")[1]).style.backgroundColor=Vb("un_colorpicker").value}function zT(){try{window.player.stopVideo()}catch{}}function GT(t,e){!function(t,e){$("#"+t).summernote("code",e)}(t,e)}function KT(t){return $("#"+t).summernote("code")}tT(),async function(){var t=Qp(Nb,"forum","pinned"),e=await hg(t);if(e.exists()){t=e.data();Vb("pinnedtxt").innerText=t.message}}(),window.onbeforeunload=function(t){updatePoints()},window.addEventListener("online",(()=>$T(1))),window.addEventListener("offline",(()=>$T(0))),Vb("te_title").innerText="The Test Has Ended",$(document).ready((function(){$(".summernote").summernote({toolbar:[["style",["style"]],["font",["bold","italic","underline","clear"]],["fontname",["fontname"]],["color",["color"]],["para",["ul","ol","paragraph"]],["height",["height"]],["table",["table"]],["insert",["link","picture","hr"]],["view",["fullscreen","codeview"]],["help",["help"]]]})}));var WT,QT,XT,YT,JT,ZT,tE={copyright:"Mr Techtroid 2021-23",vno:"v0.4.1",author:"Mr Techtroid","last-updated":"10/02/2023(IST)",serverstatus:"firebase-online"},eE="login",nE=window.location.hash.split("#/")[1],iE={},sE=0,rE=[],oE=[],aE=[],cE=0,lE="",uE=[],hE=0,dE=[],fE=[],pE=[],mE=[],gE=[],yE=0,vE=[],_E=[],wE="",bE=[],TE=[];window.onhashchange=Qb,function(t,e,n,i){z(t).onAuthStateChanged(e,n,i)}(cs(),ST),function(){function t(){jb("Note","By Clicking on 'Accept And Register' you agree that you accept all Terms And Conditions and Privacy Policy of Quarkz!",Wb,"Accept And Register")}Vb("sim_btn").addEventListener("click",(function(){qT("simlist")})),Vb("sgn_in").addEventListener("click",Kb),Vb("reg_in").addEventListener("click",(function(){qT("register")}));var t=Vb("rg_in").addEventListener("click",t);Vb("lgt_btn").addEventListener("click",Gb),Vb("tmt_btn").addEventListener("click",(function(){qT("timetable")})),Vb("prf_btn").addEventListener("click",(function(){qT("profile")})),Vb("abt_btn").addEventListener("click",(function(){qT("about")})),Vb("shf_btn").addEventListener("click",AT),Vb("aq_ao").addEventListener("click",kT),Vb("aq_ro").addEventListener("click",IT),Vb("aq_re").addEventListener("click",fT),Vb("aq_mode").addEventListener("change",lT),Vb("aq_type").addEventListener("change",lT),Vb("dsh_btn").addEventListener("click",(function(){qT("dashboard")})),Vb("adi_btn").addEventListener("click",(function(){qT("functions")})),Vb("aq_tpc_save").addEventListener("click",(function(){pT(1)})),Vb("aq_qbc_save").addEventListener("click",(function(){pT(2)})),Vb("aq_tst_save").addEventListener("click",(function(){pT(3)})),Vb("aq_exam_save").addEventListener("click",(function(){pT(4)})),Vb("un_save").addEventListener("click",Xb),Vb("un_print").addEventListener("click",Yb),Vb("tstinf_btn").addEventListener("click",(function(){qT("testinfo")})),Vb("tpc_btn").addEventListener("click",(function(){qT("tpclist")})),Vb("usc_btn").addEventListener("click",(function(){qT("users")})),Vb("lvq_btn").addEventListener("click",(function(){qT("livequiz")})),Vb("frm_btn").addEventListener("click",(function(){qT("forum")})),Vb("tp_nxt").addEventListener("click",(function(){ET(2)})),Vb("tp_prv").addEventListener("click",(function(){ET(1)})),Vb("tp_sbm").addEventListener("click",xT),Vb("lgl_btn").addEventListener("click",(function(){qT("legal")})),Vb("qba_btn").addEventListener("click",(function(){qT("qblist")})),Vb("tp_pnt").addEventListener("click",NT),Vb("aq_export").addEventListener("click",NT),Vb("tp_edt").addEventListener("click",RT),Vb("cyb_btn").addEventListener("click",(function(){qT("cyberhunt")})),Vb("ti_act").addEventListener("click",(function(){OT("active")})),Vb("ti_upc").addEventListener("click",(function(){OT("upcoming")})),Vb("ti_fin").addEventListener("click",(function(){OT("finished")})),Vb("tt_save").addEventListener("click",(function(){jT("tts_answered")})),Vb("tt_clear").addEventListener("click",(function(){jT("tts_notanswer")})),Vb("tt_review").addEventListener("click",(function(){jT("tts_review")})),Vb("tt_ansreview").addEventListener("click",(function(){jT("tts_ansreview")})),Vb("psims").addEventListener("click",(function(){aT("physics")})),Vb("csims").addEventListener("click",(function(){aT("chemistry")})),Vb("msims").addEventListener("click",(function(){aT("maths")})),Vb("bsims").addEventListener("click",(function(){aT("biology")})),Vb("cosims").addEventListener("click",(function(){aT("computer")})),Vb("ssims").addEventListener("click",(function(){aT("statistics")})),Vb("usims").addEventListener("click",(function(){aT("unfiled")})),Vb("pchb").addEventListener("click",(function(){_T("physics")})),Vb("cchb").addEventListener("click",(function(){_T("chemistry")})),Vb("mchb").addEventListener("click",(function(){_T("maths")})),Vb("bchb").addEventListener("click",(function(){_T("biology")})),Vb("cochb").addEventListener("click",(function(){_T("computer")})),Vb("schb").addEventListener("click",(function(){_T("statistics")})),Vb("uchb").addEventListener("click",(function(){_T("unfiled")})),Vb("tt_sub").addEventListener("click",(function(){var t,e,n,i;t="Warning",e="Are You Sure You Want To End The Test",n=BT,i="Yes,Submit",Vb("t1_msg_popup").style.visibility="visible",Vb("t1_msg_popup").style.opacity="1",Vb("t1_msg_action").style.display="none",document.getElementById("t1_msg_popup_txt").innerText=t,document.getElementById("t1_msg_popup_content").innerText=e,null==n?n=function(){}:Vb("t1_msg_action").style.display="block",null==i&&(i=""),Vb("t1_msg_action").onclick=n,Vb("t1_msg_action").innerText=i})),Vb("chp_btn").addEventListener("click",(function(){qT("chplist")})),Vb("pass_rst_btn").addEventListener("click",CT),Vb("aq_sims_save").addEventListener("click",rT),Vb("un_rendermode").addEventListener("change",HT),Vb("un_viewership").addEventListener("change",HT),Vb("un_print").addEventListener("click",(function(){Vb("un_preview").style.display="block",Vb("un_preview").innerHTML="<h1 style = 'text-align:center;margin:0px'>"+Vb("un_title").value+"</h1><br>"+KT("un_editable"),window.idElementPrint(Vb("un_preview"),WT.name)})),Vb("qbnk_vid_btn_e").addEventListener("click",(function(){Vb("watermark").style.display="flex",Fb(Vb("qbnk_vid"))})),Vb("qbnk_vid_btn").addEventListener("click",(function(){sT()}))}();
//# sourceMappingURL=index.581dd14f.js.map
