 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function bg(){return new Am("serverTimestamp")}function Tg(...t){return new Cm("arrayUnion",t)}!function(t,e=!0){mc=Ot,Rt(new K("firestore",((t,{instanceIdentifier:n,options:i})=>{const s=t.getProvider("app").getImmediate(),r=new cm(new Rc(t.getProvider("auth-internal")),new Oc(t.getProvider("app-check-internal")),function(t,e){if(!Object.prototype.hasOwnProperty.apply(t.options,["projectId"]))throw new Ac(Ic.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new rl(t.options.projectId,e)}(s,n),s);return i=Object.assign({useFetchStreams:e},i),r._setSettings(i),r}),"PUBLIC").setMultipleInstances(!0)),Ut(fc,"3.8.3",t),Ut(fc,"3.8.3","esm2017")}();
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
var Lb,Db;(Lb=qb,Db=Bn,z(Lb).setPersistence(Db)).then((()=>Pn(qb,email,password))).catch((t=>{}));const Ob=function(t=Pt(),e){const n=qt(t=z(t),vy).getImmediate({identifier:e}),i=E("storage");return i&&function(t,e,n,i={}){!function(t,e,n,i={}){t.host=`${e}:${n}`,t._protocol="http";const{mockUserToken:s}=i;s&&(t._overrideAuthToken="string"==typeof s?s:C(s,t.app.options.projectId))}(t,e,n,i)}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(n,...i),n}();function Mb(t){t=Number(t);var e=Math.floor(t/86400),n=Math.floor(t%86400/3600),i=Math.floor(t%3600/60),s=Math.floor(t%60);return(e>0?e+(1==e?" day, ":" days, "):"")+(n>0?n+(1==n?" hour, ":" hours, "):"")+(i>0?i+(1==i?" minute, ":" minutes, "):"")+(s>0?s+(1==s?" second":" seconds"):"")}function Pb(t,e){let n=t.length;if(n!=e.length)return!1;t.sort(),e.sort();for(let i=0;i<n;i++)if(t[i]!=e[i])return!1;return!0}function Ub(t,e){const n=Object.keys,i=typeof t;return t&&e&&"object"===i&&i===typeof e?n(t).length===n(e).length&&n(t).every((n=>Ub(t[n],e[n]))):t===e}function Fb(t){fetch(t).then((t=>{var e;for(var n of t.headers.entries())"date"===n[0]&&(e=new Date(n[1]).getTime());return e}))}function Vb(t){t.requestFullscreen?t.requestFullscreen():t.mozRequestFullScreen?t.mozRequestFullScreen():t.webkitRequestFullscreen?t.webkitRequestFullscreen():t.msRequestFullscreen&&t.msRequestFullscreen()}function jb(t){return document.getElementById(t)}function Bb(t,e,n,i){jb("msg_popup").style.visibility="visible",jb("msg_popup").style.opacity="1",jb("msg_action").style.display="none",document.getElementById("msg_popup_txt").innerText=t,document.getElementById("msg_popup_content").innerText=e,null==n?n=function(){}:jb("msg_action").style.display="block",null==i&&(i=""),jb("msg_action").onclick=n,jb("msg_action").innerText=i}const $b=(t,e)=>t.map((t=>({...e.find((e=>e.qid===t.qid&&e)),...t})));let Hb,zb;function Kb(t,e){let n=[];const i=new MediaRecorder(t);return i.ondataavailable=function(t){t.data.size>0&&n.push(t.data)},i.onstop=function(){!function(t){const e=new Blob(t,{type:"video/webm"});let n=window.prompt("Enter file name"),i=document.createElement("a");i.href=URL.createObjectURL(e),i.download=`${n}.webm`,document.body.appendChild(i),i.click(),URL.revokeObjectURL(e),document.body.removeChild(i)}(n),n=[]},i.start(200),i}async function Gb(){var t=jb("lg_uname").value,e=jb("lg_pass").value;Pn(qb,t,e).then((e=>{e.user;cE.email=t,Xb("dashboard",1)})).catch((t=>{t.code,t.message;jb("lgn_err").style.display="block",jb("lg_pass").value=""}))}function Wb(){Un(cs()),cE=[]}function Qb(){var t=jb("rg_uname").value,e=jb("rg_pass").value,n=jb("rg_name").value,i=jb("rg_mbleno").value,s=jb("rg_class").value,r=jb("rg_gender").value;""!=t&&""!=e&&""!=n&&""!=i&&""!=s||alert("Details Cannot Be Empty"),e!=jb("rg_pass1").value||Mn(qb,t,e).then((e=>{const o=e.user;!async function(){try{await pg(Qp(Rb,"users",o.uid),{name:n,class:s,mblno:i,email:t,spoints:0,gen:r,sgndon:bg(),roles:{user:!0}}).then((function(){window.location.hash="#/dashboard",window.location.reload()}))}catch(t){console.error("Error Adding New User",t)}}()})).catch((t=>{t.code,t.message}))}function Xb(t,e){var n=1==YT||1==XT;switch(n?(jb("adminonly").style.display="flex",jb("tp_pnt").style.display="block",jb("tp_edt").style.display="block",jb("sms_edit").style.display="block"):(jb("adminonly").style.display="none",jb("sms_edit").style.display="none"),jb(nE).classList.remove("_open"),1==e&&(window.location.hash="#/"+t),nE=t,iE=window.location.hash.split("#/")[1]){case"profile":nE="profile";break;case"about":nE="aboutus";break;case"login":nE="login";break;case"dashboard":nE="dashboard";break;case"timetable":nE="schedule";break;case"logout":Un();break;case"mainsformulas":nE="mainsformulas",TT(1);break;case"downloads":nE="downloads",TT(2);break;case"livequiz":nE="livequiz";break;case"register":nE="register";break;case"testinfo":nE="testinfo",MT("active");break;case"legal":nE="legal";break;case"appinfo":nE="appinfo",jb("ren_appinf").textContent=JSON.stringify(eE,void 0,2);break;case"forum":nE="forum";break;case"testing":nE="testing";break;case"bugreport":nE="bugreport";break;case"simlist":nE="simlist",cT();break;case"testend":nE="test_end";break;case"add/question":nE="fu_question";break;case"add/lesson":nE="fu_lesson",newLesson();break;case"add/tpc":nE="fu_topic",async function(){try{Xb("edit_tpc/"+(await yg(Wp(Rb,"topic"),{name:"",qllist:[],level:"jee",chid:"",chname:"",subject:""})).id,1)}catch{}}();break;case"add/images":nE="fu_images";break;case"add/qubank":nE="fu_topic",async function(){try{Xb("edit_qubank/"+(await yg(Wp(Rb,"qbank"),{name:"",qllist:[],level:"jee",chid:"",chname:"",subject:""})).id,1)}catch{}}();break;case"add/simulation":nE="fu_simulation",async function(){try{Xb("edit_sim/"+(await yg(Wp(Rb,"sims"),{name:"",license:"",provider:"",url:""})).id,1)}catch{}}();break;case"add/tests":nE="fu_topic",async function(){try{const t=await yg(Wp(Rb,"tests"),{title:"",totalmarks:0,timeallotted:0,syllabus:"",strton:bg(),endon:bg(),questionnos:0,finished:[],batch:[]});await pg(Qp(Rb,"tests",t.id,"questions","questions"),{questions:[]}),await pg(Qp(Rb,"tests",t.id,"questions","answers"),{questions:[]}),await pg(Qp(Rb,"tests",t.id,"responses","finished"),{finished:[],leaderboard:[]});Xb("edit_tests/"+t.id,1)}catch{}}();break;case"chplist":nE="chapterlist",wT();break;default:nE="error_page"}iE.includes("instructions")&&(nE="test_instructions"),iE.includes("cyberhunt")&&(nE="cyberhunt",async function(){""==window.location.hash.split("/cyberhunt/")[1]||""==window.location.hash.split("/cyberhunt")[1]?(jb("cyb_code").style.display="flex",jb("cyb_viewer").style.display="none",jb("cyb_edit").style.display="none"):(jb("cyb_code").style.display="none",jb("cyb_viewer").style.display="flex",jb("cyb_edit").style.display="none")}()),iE.includes("notes")&&!iE.includes("usernotes")&&(nE="notes",async function(){var t=window.location.hash.split("notes/")[1];_y(wy(Ob,"public/"+t+".pdf")).then((t=>{jb("nt_id").src=t+""})).catch((t=>{switch(t.code){case"storage/object-not-found":jb("nt_id").src="https://firebasestorage.googleapis.com/v0/b/quarkz.appspot.com/o/public%2F404.pdf?alt=media&token=8cc8f23a-6e24-41d6-984b-6d2cc9b89d11";break;case"storage/unauthorized":Bb("Unauthorised","You dont have necessary permissions to The file you requested.")}}))}()),iE.includes("sims")&&(nE="simulations",async function(){var t=window.location.hash.split("sims/")[1],e=Qp(Rb,"sims",t),n=await hg(e);if(!n.exists())throw Xb("error_page",1),new Error;var i=n.data();jb("sms_name").innerText=i.name,jb("sms_prov").innerText=i.provider,jb("sim_frame").src=i.url}()),iE.includes("chapter")&&(nE="chapter",async function(){jb("chp_chaptername").innerHTML="",jb("chp_qbk_list").innerHTML="",jb("chp_tpc_list").innerHTML="";var t=Qp(Rb,"chapter",window.location.hash.split("#/chapter/")[1]),e=await hg(t);if(e.exists()){var n=e.data();jb("chp_chaptername").innerText=n.name;try{for(let t of n.qbanks)jb("chp_qbk_list").insertAdjacentHTML("beforeend",'<span class="tlinks rpl" style = "color:pink" id="chpqbk'+btoa(t.id)+'">'+t.title+"</span>"),jb("chpqbk"+btoa(t.id)).addEventListener("click",gT)}catch{}try{for(let t of n.topics)jb("chp_tpc_list").insertAdjacentHTML("beforeend",'<span class="tlinks rpl" style = "color:pink" id="chptpc'+btoa(t.id)+'">'+t.title+"</span>"),jb("chptpc"+btoa(t.id)).addEventListener("click",yT)}catch{}}}()),iE.includes("qbanks")&&(nE="topic",vT(2)),iE.includes("usernotes")&&(nE="usernotes",async function(){try{zT()}catch{}if(window.location.hash.includes("usernotes/add")){var t=await yg(Wp(Rb,"usernotes"),{title:"Notes Title",notes:"",uuid:QT.uuid,crton:bg(),type:"private",lastupdated:bg()});await mg(Qp(Rb,"users",QT.uuid),{usernotes:Tg({color:"black",id:t.id,title:"Notes Title"})}),Xb("#/usernotes/"+t.id,1)}else if(window.location.hash.includes("usernotes/delete"))await gg(Qp(Rb,"usernotes",window.location.hash.split("usernotes/delete/")[1]));else if("#/usernotes/"==window.location.hash);else{t=Qp(Rb,"usernotes",window.location.hash.split("usernotes/")[1]);var e=await hg(t);if(e.exists()){t=e.data();jb("un_title").value=t.title,WT("un_editable",t.notes),jb("un_viewership").value=t.type,"public_view"==t.type&&QT.uuid!=t.uuid?(jb("un_rendermode").innerHTML='<option value="preview">preview</option>',jb("un_rendermode").value="preview",jb("un_save").style.display="none",jb("un_colorpicker").style.display="none",jb("un_viewership").style.display="none",jb("un_title").style.display="none"):(jb("un_rendermode").innerHTML='<option value="edit">edit</option><option value="preview">preview</option>',jb("un_rendermode").value="edit",jb("un_save").style.display="block",jb("un_colorpicker").style.display="block",jb("un_viewership").style.display="block",jb("un_title").style.display="block"),zT()}}}()),iE.includes("qbnk_vid")&&(nE="qbnk_vid",jb("qbnk_vid_btn").style.display="block"),iE.includes("attempt")&&(nE="testv1",async function(){jb("tt_footer").style.display="flex",jb("tt_sub").style.display="block",jb("tt_timeleft").style.display="block",jb("tt_marksaward").style.display="none";var t=window.location.hash.split("#/attempt/")[1],e=Qp(Rb,"tests",t),n=await hg(e);if(n.exists()&&(yE=n.data(),e=Qp(Rb,"tests",t,"responses","finished"),(n=await hg(e)).exists()))for(var i of n.data().finished)if(qb.currentUser.uid==i)return Xb("testend",1),jb("te_title").innerText="You Have Already Attempted This Test",0;try{e=Qp(Rb,"tests",t,"questions","questions"),(n=await hg(e)).exists()&&(_E=n.data())}catch{return jb("te_title").innerText="The Test Hasnt Started Yet",Xb("testend",1),0}if(e=Qp(Rb,"tests",t,"responses",qb.currentUser.uid),(n=await hg(e)).exists()){var s=n.data().answers;for(var r in TE=n.data().actions,s)wE.push({qid:r,ans:s[r].ans,type:s[r].type,time:s[r].time})}else{for(var o={},a=0;a<_E.questions.length;a++)o[`${_E.questions[a].qid}`]={type:"tts_notvisit",answer:[]},wE.push({qid:_E.questions[a].qid,type:"tts_notvisit",answer:[],timetaken:0});var c=new Date;await pg(Qp(Rb,"tests",t,"responses",qb.currentUser.uid),{answers:o,strton:bg(),warning:[],actions:[{type:"start",time:c,value:"1"}],testversion:"1"}),TE.push({type:"start",time:c,value:"1"})}window.location.hash.includes("/attempt/")&&(nT=setInterval((function(){var t=yE.timeallotted-1;yE.timeallotted-=1,jb("tt_timeleft").innerText=Math.floor(t%86400/3600)+":"+Math.floor(t%3600/60)+":"+Math.floor(t%60),vE+=1,jb("tt_timespent").innerText=Math.floor(vE%86400/3600)+":"+Math.floor(vE%3600/60)+":"+Math.floor(vE%60),0==t&&$T()}),1e3));window.onbeforeunload=function(t){t.preventDefault,$T()},window.onhashchange=function(t){Xb(),$T()},jb("tt_testname").innerText=yE.title,jb("dsh_btn").style.display="none",jb("tp_pnt").style.display="none",jb("tp_pnt").style.display="none";var l=jb("testv1");try{Vb(l)}catch{}jT()}()),iE.includes("finished")&&(nE="finishedtestinfo",async function(){var t=window.location.hash.split("#/finished/")[1],e=Qp(Rb,"tests",t),n=await hg(e);if(n.exists()){yE=n.data();var i=0;if(jb("fti_title").innerText=yE.title,e=Qp(Rb,"tests",t,"responses","finished"),(n=await hg(e)).exists())for(var s of n.data().finished)if(qb.currentUser.uid==s){i=1;break}if(0==i)Xb("testend",1),jb("te_title").innerText="You Have NOT Attempted This Test";else try{try{FT(1)}catch{}try{e=Qp(Rb,"tests",t,"responses",qb.currentUser.uid);var r=(n=await hg(e)).data();if(n.exists()){function o(t,e,n,i,s){var r=s-(e-4*n);return"<div><span>"+t+"("+(e+n)+' Marks)</span><div style = "width:40vw;height:30px;display:flex;flex-direction:row;"><div style="width:'+e/s*40+'vw;background-color:green;height:30px;text-align:center;color:white">'+e+"/"+s+'</div><div style="width:'+Math.abs(4*n/s*40)+'vw;background-color:red;height:30px;text-align:center;color:white">'+n+"/"+s+'</div><div style="width:'+40*(1-(e-4*n)/s)+'vw;background-color:orange;height:30px;text-align:center;color:black">'+r+"/"+s+"</div></div></div>"}jb("fto_total").innerText=r.info.usermarks+"/"+r.info.total,jb("fto_correct").innerText=r.info.correct,jb("fto_incorrect").innerText=r.info.incorrect,jb("fto_unanswered").innerText=r.info.unattempted,TE=r.actions,ZT=r.info.mList,jb("fto_rank").innerText="0";var a=["Physics","Chemistry","Math","Biology","Statistics","Computer","Unfiled"];for(var c of(jb("fto_percents").innerHTML="",a)){var l=r.info.subjectmarks[c];Ub(l,{correct:0,unattempted:0,incorrect:0,total:0})||jb("fto_percents").insertAdjacentHTML("beforeend",o(c,l.correct,l.incorrect,l.unattempted,l.total))}PT(1).then((function(){function t(t,e,n,i,s){var r=s-(e+n);return"<div><span>"+t+"("+Mb(s)+')</span><div style = "width:80vw;height:30px;display:flex;flex-direction:row;"><div style="width:'+e/s*80+'vw;background-color:green;height:30px;text-align:center;color:white">'+Mb(e)+'</div><div style="width:'+n/s*80+'vw;background-color:red;height:30px;text-align:center;color:white">'+Mb(n)+'</div><div style="width:'+80*(1-(e+n)/s)+'vw;background-color:orange;height:30px;text-align:center;color:black">'+Mb(r)+"</div></div></div>"}var e=["Physics","Chemistry","Math","Biology","Statistics","Computer","Unfiled"];for(var n of(jb("fto_time").innerHTML="",e)){var i=tE.subject[n];Ub(i,{correct:0,unattempted:0,incorrect:0,total:0})||jb("fto_time").insertAdjacentHTML("beforeend",t(n,i.correct,i.incorrect,i.unattempted,i.total))}}))}try{var u;e=Qp(Rb,"tests",t,"responses","finished"),(n=await hg(e)).exists()&&(u=n.data().leaderboard),jb("fto_leaderboard").innerHTML="",p="marks",0==(m=1)&&(g=t=>(e,n)=>e[t]>n[t]?1:-1),1==m&&(g=t=>(e,n)=>e[t]>n[t]?-1:1),u=u.sort(g(p));for(var h=0;h<u.length;h++){var d=h+1;QT.uuid==u[h].uid&&(jb("fto_rank").innerText=d),jb("fto_leaderboard").insertAdjacentHTML("beforeend",'<div class = "tlinks" style = "flex-direction:row;width:25vw;justify-content:space-between;"><span class = "t_gre">&nbsp;'+d+'</span><span class = "t_name">'+u[h].name+'</span><span class = "t_gre">&nbsp;&nbsp;'+u[h].marks+"</span></div>")}}catch{}var f=[];for(h=0;h<ZT.length;h++)null==tE.questions[ZT[h].qid]?f.push({qid:ZT[h].qid,type:ZT[h].type,time:0,no:h+1}):f.push({qid:ZT[h].qid,type:ZT[h].type,time:tE.questions[ZT[h].qid].time,no:h+1});!function(t,e){try{const i={top:20,right:20,bottom:50,left:50},s=800-i.left-i.right,r=400-i.top-i.bottom;jb(t).innerHTML="";const o=$60335d5fa2b61a3a$exports.select("#"+t).append("svg").attr("width",s+i.left+i.right).attr("height",r+i.top+i.bottom).append("g").attr("transform",`translate(${i.left}, ${i.top})`),a=$60335d5fa2b61a3a$exports.scaleOrdinal().domain(["correct","incorrect","unattempted"]).range(["#2ecc71","#e74c3c","#f39c12"]),c=$60335d5fa2b61a3a$exports.scaleLinear().domain([0,$60335d5fa2b61a3a$exports.max(e,(t=>t.time))]).range([5,30]),l=$60335d5fa2b61a3a$exports.scaleLinear().domain([1,e.length]).range([0,s]),u=$60335d5fa2b61a3a$exports.scaleLinear().domain([0,$60335d5fa2b61a3a$exports.max(e,(t=>t.time))]).range([r,0]);o.append("text").attr("class","axis-label").attr("text-anchor","middle").attr("x",s-120).attr("y",r+40).attr("color","white").text("Question Number"),o.append("text").attr("class","axis-label").attr("text-anchor","middle").attr("transform","rotate(-90)").attr("x",-innerHeight/2+40).attr("y",25-i.left).text("Time Taken(in s)").attr("color","white"),o.append("g").attr("transform",`translate(0, ${r})`).call(Ly(Iy,l)),o.append("g").call(function(t){return Ly(Ay,t)}(u)),o.selectAll("circle").data(e).enter().append("circle").attr("cx",((t,e)=>l(e+1))).attr("cy",(t=>u(t.time))).attr("r",(t=>c(t.time))).attr("fill",(t=>a(t.type))).append("text").text((function(t){return t.no}));var n=o.selectAll("g").data(e).enter().append("g").attr("transform",(function(t){return"translate("+l(t.time)+","+u(t.questionNumber)+")"}));n.append("circle").attr("r",(function(t){return sizeScale(t.time)})).attr("fill",(function(t){return"correct"==t.result?"green":"incorrect"==t.result?"red":"gray"})),n.append("text").text((function(t){return"Q"+t.no})).attr("x",(function(t){return sizeScale(t.time)+5})).attr("y",5)}catch{}}("fto_draw",f)}catch{return jb("te_title").innerText="ERROR",Xb("testend",1),0}}catch{}}var p,m,g}()),iE.includes("testreport")&&(nE="testv1",async function(){jb("tt_footer").style.display="none",jb("tt_sub").style.display="none",jb("tt_timeleft").style.display="none",jb("tt_marksaward").style.display="block";var t=window.location.hash.split("#/testreport/")[1],e=Qp(Rb,"tests",t),n=await hg(e);if(n.exists()){yE=n.data();var i=0;if(jb("tt_testname").innerText=yE.title,e=Qp(Rb,"tests",t,"responses","finished"),(n=await hg(e)).exists())for(var s of n.data().finished)if(qb.currentUser.uid==s){i=1;break}if(0==i)Xb("testend",1),jb("te_title").innerText="You Have NOT Attempted This Test";else if(Date.now()/1e3<=yE.endon.seconds&&0==yE.noresult)Xb("testend",1),jb("te_title").innerText="Detailed Test Reports will be available after deadline";else{try{if(e=Qp(Rb,"tests",t,"questions","questions"),(n=await hg(e)).exists()&&(_E=n.data()),e=Qp(Rb,"tests",t,"responses",qb.currentUser.uid),(n=await hg(e)).exists()){var r=n.data().answers;for(var o in TE=n.data().actions,r)wE.push({qid:o,ans:r[o].ans,type:r[o].type,time:r[o].time})}e=Qp(Rb,"tests",t,"questions","answers"),(n=await hg(e)).exists()&&(EE=n.data())}catch{return jb("te_title").innerText="ERROR",Xb("testend",1),0}jT()}}}()),iE.includes("printable/qbank")&&1==n&&(nE="printable",bT(1)),iE.includes("ARIEL")&&1==n&&(nE="Ariel"),iE.includes("printable/tests")&&1==n&&(nE="printable",bT(3)),"functions"==iE&&1==n&&(nE="functions",uT()),iE.includes("users")&&1==n&&(nE="users",userUpdate()),iE.includes("topic")&&(nE="topic",vT(1)),iE.includes("printable/topic")&&1==n&&(nE="printable",bT(2)),iE.includes("livequiz")&&(nE="livequiz",async function(){lquizcode=iE.split("livequiz")[1];var t=Qp(Rb,"livequiz",lquizcode),e=await hg(t);if(!e.exists())throw new Error;e.data()}()),iE.includes("edit_sim")&&1==n&&(nE="fu_simulation",async function(){try{let e=await hg(Qp(Rb,"sims",window.location.hash.split("edit_sim/")[1]));if(e.exists()){var t=e.data();jb("aq_simname").value=t.name,jb("aq_simprov").value=t.provider,jb("aq_simurl").value=t.url,jb("aq_simlicense").value=t.license,jb("aq_simsubj").value=t.subject}}catch{}}()),iE.includes("edit_lesson")&&1==n&&(nE="fu_simulation",prepareLesson()),iE.includes("edit_tpc")&&1==n&&(nE="fu_topic",fT(1)),iE.includes("edit_test")&&1==n&&(nE="fu_topic",fT(3)),iE.includes("edit_qubank")&&1==n&&(nE="fu_topic",fT(2)),iE.includes("edit_exams")&&1==n&&(nE="fu_topic",fT(4)),0!=JT&&null!=JT&&null!=JT||"login"==iE||"register"==iE||iE.includes("notes")||"legal"==iE||"about"==iE||"bugreport"==iE||"appinfo"==iE||"mainsformulas"==iE||"downloads"==iE||(nE="error_page"),jb(nE).classList.add("_open"),KT(),hE=[],"forum"==iE?eT(1):(eT(2),iT=1,sT="afterbegin"),_E=[],wE=[],yE=[],bE=""}async function Yb(){await mg(Qp(Rb,"usernotes",window.location.hash.split("usernotes/")[1]),{title:jb("un_title").value,notes:GT("un_editable"),lastupdated:bg(),type:jb("un_viewership").value})}function Jb(){}function Zb(){window.location.hash="#/usernotes/"+this.id.split("uno")[1]}let tT=function(){};async function eT(t){1==t?(jb("forum_live").innerHTML="",zb=Km(Wp(lm(),"forum"),Ym("sgndon","desc"),Zm(10)),tT=vg(zb,(function(t){t.docChanges().forEach((function(t){if("removed"===t.type)jb("dM"+t.doc.id).remove();else if("added"==t.type){iT>=11&&(sT="beforeend");var e=t.doc.data();!function(t,e,n,i,s){if("shh5oUIhRpdBkEKQ3GCZwoKE9u42"==s){var r="<div id = 'dM"+t+"'><span class = 'dmName'>"+n+"👑: </span><span class = 'dmText'>"+i+"</span><span class = 'dmtime'>"+e+"</span></div>";jb("forum_live").insertAdjacentHTML(sT,r)}else r="<div id = 'dM"+t+"'><span class = 'dmName'>"+n+": </span><span class = 'dmText'>"+i+"</span><span class = 'dmtime'>"+e+"</span></div>",jb("forum_live").insertAdjacentHTML(sT,r)}(t.doc.id,"",e.name,e.message,e.userid),iT+=1}}))}))):2==t&&(tT(),tT=function(){})}jb("fm_send").addEventListener("click",(async function(){var t=jb("fm_message").value;if(t.includes("/pinned")){t=t.split("/pinned")[1];try{await mg(Qp(Rb,"forum","pinned"),{message:t})}catch{alert("You Dont Have The Privilages For This Command")}var e=await Fb("http://localhost:5500/time.html").then(async function(e){await mg(Qp(Rb,"forum","ppinned"),{ppinned:Tg({message:t,user:QT.uuid,time:e})})}(e))}else""!=t&&null!=t?(await yg(Wp(Rb,"forum"),{name:QT.name,message:t,userid:QT.uuid,sgndon:bg()}),jb("fm_message").value=""):alert("Message Cannot Be Empty")}));var nT,iT=1,sT="afterbegin";async function rT(){jb("qbnk_vid_btn").style.display="none",jb("qbnk_vid_btn_e").style.display="none";try{let o=await hg(Qp(Rb,"qbank",window.location.hash.split("qbnk_vid/")[1]));if(o.exists()){var t=o.data();jb("tb_q_title").innerText=t.name,jb("qb_vid_ti").innerText=t.name,jb("qbnk_vid_q").style.display="none",jb("qbnk_vid_ans").style.display="none",jb("qbnk_vid_title").style.display="flex",jb("qbnk_vid_end").style.display="none",jb("watermark").style.display="none";let a=t.qllist,c=await async function(){return await navigator.mediaDevices.getDisplayMedia({audio:!0,video:{mediaSource:"screen"}})}();Vb(jb("qbnk_vid")),Hb=Kb(c);var e,n=0,i=0,s=0,r=setInterval((function(){if(jb("qbnk_vid_q").style.display="none",jb("qbnk_vid_ans").style.display="none",jb("qbnk_vid_title").style.display="none",jb("qbnk_vid_end").style.display="none",0==i)jb("qbnk_vid_title").style.display="flex",i++;else if(s==a.length-1)jb("qbnk_vid_end").style.display="flex",setTimeout((function(){Hb.stop(),jb("qbnk_vid_btn").style.display="block"}),5e3),clearInterval(r);else if(0==n||1==n){!function(t){function e(t){t.style.display="none"}function n(t){t.style.display="block"}function i(t){t.style.display="flex"}var s=jb("tb_q_mcq_con"),r=jb("tb_q_matrix"),o=jb("tb_q_answer");if(s.innerHTML="",jb("tb_q_qtext").innerHTML=t.title+"<span class = 'sp_txt'>("+t.type+")</span>","mcq"==t.type||"mcq_multiple"==t.type){i(s),e(r),e(o);var a=t.op,c="";for(let t of a)c+='<div class="tb_q_mcq_p rpl">'+t+"</div>";jb("tb_q_mcq_con").insertAdjacentHTML("beforeend",c)}else if("matrix"==t.type){e(s),n(r),e(o);for(var l=t.op1,u=t.op2,h=l.length,d=0;d<h;d++)document.getElementsByClassName("tp_i1")[d].innerHTML=l[d];for(d=0;d<h;d++)document.getElementsByClassName("tp_i2")[d].innerHTML=u[d]}else"numerical"==t.type||"fill"==t.type?(e(s),e(r),n(o)):"taf"==t.type?(i(s),e(r),e(o),c='<div class="tp_mcq_p rpl">True</div><div class="tp_mcq_p rpl">False</div>',jb("tp_mcq_con").insertAdjacentHTML("beforeend",c)):(e(s),e(r),e(o));renderMathInElement(jb("tp_ans_hold")),renderMathInElement(jb("tp_qtext"))}(a[s]);var t=s+1;0==n&&(jb("qbnk_timer").innerText=10,e=setInterval((function(){jb("qbnk_timer").innerText=jb("qbnk_timer").innerText-1}),1e3)),jb("tb_q_qno").innerText="Question "+t+":",jb("qbnk_vid_q").style.display="flex",n++}else if(2==n){jb("qbnk_vid_ans").style.display="flex",clearInterval(e);for(var o="",c=0;c<a[s].answer.length;c++)o+='<div class="tb_q_mcq_p rpl" style = "background-color:green">'+a[s].answer[c]+"</div>";jb("tb_q_ans").innerHTML=o,jb("tb_q_hint").innerHTML=a[s].hint,jb("tb_q_expl").innerHTML=a[s].expl,n=0,s++}}),5e3)}}catch{}}async function oT(){try{await mg(Qp(Rb,"sims",window.location.hash.split("edit_sim/")[1]),{name:jb("aq_simname").value,license:jb("aq_simlicense").value,provider:jb("aq_simprov").value,url:jb("aq_simurl").value,subject:jb("aq_simsubj").value});var t=jb("aq_simsubj").value;"physics"==t&&await mg(Qp(Rb,"sims","sims"),{physics:Tg(jb("aq_simname").value)}),"chemistry"==t&&await mg(Qp(Rb,"sims","sims"),{chemistry:Tg(jb("aq_simname").value)}),"maths"==t&&await mg(Qp(Rb,"sims","sims"),{maths:Tg(jb("aq_simname").value)}),"computer"==t&&await mg(Qp(Rb,"sims","sims"),{computer:Tg(jb("aq_simname").value)}),"biology"==t&&await mg(Qp(Rb,"sims","sims"),{biology:Tg(jb("aq_simname").value)}),"statistics"==t&&await mg(Qp(Rb,"sims","sims"),{statistics:Tg(jb("aq_simname").value)}),"unfiled"==t&&await mg(Qp(Rb,"sims","sims"),{unfiled:Tg(jb("aq_simname").value)}),function(){WT("aq_qtext",""),WT("aq_expl",""),jb("aq_answer").value="",jb("aq_yurl").value="",jb("aq_hint").value="";for(var t=0;t<document.getElementsByClassName("aq_mcq").length;t++)document.getElementsByClassName("aq_mcq")[t].value="";for(t=0;t<document.getElementsByClassName("aq_i1").length;t++)document.getElementsByClassName("aq_i1")[t].value="";for(t=0;t<document.getElementsByClassName("aq_i2").length;t++)document.getElementsByClassName("aq_i2")[t].value=""}()}catch(t){console.error("Error writing new message to Firebase Database",t)}}function aT(){!async function(t){var e;const n=Km(Wp(Rb,"sims"),Wm("name","==",t));(await fg(n)).forEach((t=>{e=t.id})),Xb("sims/"+e,1)}(this.innerText)}async function cT(t){if(jb("sim_cont").innerHTML="",0==oE.length){var e=Qp(Rb,"sims","sims"),n=await hg(e);if(!n.exists())throw Xb("error_page",1),new Error;var i=n.data();oE=i}if("physics"==t)try{for(let t of oE.physics)""!=t&&(jb("sim_cont").insertAdjacentHTML("beforeend",'<span class="tlinks rpl" style = "color:pink" id="sim'+btoa(t)+'">'+t+"</span>"),jb("sim"+btoa(t)).addEventListener("click",aT))}catch{}if("chemistry"==t)try{for(let t of oE.chemistry)""!=t&&(jb("sim_cont").insertAdjacentHTML("beforeend",'<span class="tlinks rpl" style = "color:crimson" id="sim'+btoa(t)+'">'+t+"</span>"),jb("sim"+btoa(t)).addEventListener("click",aT))}catch{}if("maths"==t)try{for(let t of oE.maths)""!=t&&(jb("sim_cont").insertAdjacentHTML("beforeend",'<span class="tlinks rpl" style = "color:turquoise" id="sim'+btoa(t)+'">'+t+"</span>"),jb("sim"+btoa(t)).addEventListener("click",aT))}catch{}if("biology"==t)try{for(let t of oE.biology)""!=t&&(jb("sim_cont").insertAdjacentHTML("beforeend",'<span class="tlinks rpl" style = "color:lime" id="sim'+btoa(t)+'">'+t+"</span>"),jb("sim"+btoa(t)).addEventListener("click",aT))}catch{}if("computer"==t)try{for(let t of oE.computer)""!=t&&(jb("sim_cont").insertAdjacentHTML("beforeend",'<span class="tlinks rpl" style = "color:violet" id="sim'+btoa(t)+'">'+t+"</span>"),jb("sim"+btoa(t)).addEventListener("click",aT))}catch{}if("statistics"==t)try{for(let t of oE.statistics)""!=t&&(jb("sim_cont").insertAdjacentHTML("beforeend",'<span class="tlinks rpl" style = "color:orange" id="sim'+btoa(t)+'">'+t+"</span>"),jb("sim"+btoa(t)).addEventListener("click",aT))}catch{}if("unfiled"==t)try{for(let t of oE.unfiled)""!=t&&(jb("sim_cont").insertAdjacentHTML("beforeend",'<span class="tlinks rpl" style = "color:white" id="sim'+btoa(t)+'">'+t+"</span>"),jb("sim"+btoa(t)).addEventListener("click",aT))}catch{}}function lT(){var t=[jb("aq_answer").value],e=jb("aq_type").value,n=[],i=[],s=[];if("mcq"==e||"mcq_multiple"==e)for(t=[],o=0;o<document.getElementsByClassName("aq_mcq_ans").length;o++){var r=document.getElementsByClassName("aq_mcq_ans")[o].value;t[o]=r}for(var o=0;o<document.getElementsByClassName("aq_mcq").length;o++)n.push(document.getElementsByClassName("aq_mcq")[o].value);for(o=0;o<document.getElementsByClassName("aq_i1").length;o++)i.push(document.getElementsByClassName("aq_i1")[o].value);for(o=0;o<document.getElementsByClassName("aq_i2").length;o++)s.push(document.getElementsByClassName("aq_i2")[o].value);if(iE.includes("edit_test"))var a={qid:uE,mode:jb("aq_mode").value,title:GT("aq_qtext"),y_url:jb("aq_yurl").value,hint:jb("aq_hint").value,expl:GT("aq_expl"),type:e,answer:t,op:n,op1:i,op2:s,section:jb("aq_section").value,pm:jb("aq_posmrks").value,nm:jb("aq_negmrks").value};else if(iE.includes("edit_exams"))a={id:uE,name:jb("aq_examname").value,date:jb("aq_examdate").value,info:jb("aq_examinfo").value,syllabus:jb("aq_examsyllabus").value,mode:"exams"};else a={id:uE,mode:jb("aq_mode").value,title:GT("aq_qtext"),y_url:jb("aq_yurl").value,hint:jb("aq_hint").value,expl:GT("aq_expl"),type:e,answer:t,op:n,op1:i,op2:s,section:jb("aq_section").value,pm:jb("aq_posmrks").value,nm:jb("aq_negmrks").value};return a}async function uT(t){function e(t){t.style.display="none"}function n(t){t.style.display="block"}function i(t){t.style.display="flex"}var s=jb("aq_mode").value,r=jb("aq_ans_hold"),o=jb("aq_type"),a=jb("aq_answer"),c=jb("aq_yurl"),l=jb("aq_mcq_con"),u=jb("aq_matrix"),h=(jb("aq_upl"),jb("aq_all"));jb("aq_tpc"),jb("aq_qbk"),jb("aq_sims");"question"==s?(e(c),n(r),n(o),n(a),i(h)):"lesson"==s?(n(c),e(r),e(o),e(a),i(h)):"exams"==s&&(e(c),e(r),e(o),e(a),e(h)),"mcq"==o.value||"mcq_multiple"==o.value?(i(l),e(u),e(a)):"matrix"==o.value?(n(u),e(l),e(a)):(e(u),e(l),n(a))}function hT(t){dT(this.innerText)}function dT(t){if("+"==t){let e=hE.length;window.location.hash.includes("edit_exams")?hE[e]={id:Date.now()+Math.random().toString(36).substr(2),name:"",date:"",info:"",syllabus:"",mode:"exams"}:hE[e]={id:Date.now()+Math.random().toString(36).substr(2),mode:"",title:"",y_url:"",img:"",hint:"",expl:"",type:"mcq",answer:["1"],op:["1","2","3","4"],op1:[],op2:[],section:"Unfiled",pm:4,nm:-1},(window.location.hash.includes("edit_qubank")||window.location.hash.includes("edit_test"))&&(hE[e].mode="question"),iE.includes("edit_test")&&(hE[e].qid=hE[e].id),t=e}jb("question_list").innerHTML="";for(var e=1;e<hE.length+1;e++)jb("question_list").insertAdjacentHTML("beforeend",'<span class = "t_no_qno" id = "t_no_qno_'+e+'">'+e+"</span>"),jb("t_no_qno_"+e).addEventListener("click",hT);jb("question_list").insertAdjacentHTML("beforeend",'<span class = "t_no_qno" id = "t_no_qno_add">+</span>'),jb("t_no_qno_add").addEventListener("click",hT),0!=t&&(hE[lE-1]=lT(),lE=t);var n=hE[lE-1];if(window.location.href.includes("edit_exams"))return jb("aq_examname").value=n.name,jb("aq_examdate").value=n.date,jb("aq_examinfo").value=n.info,jb("aq_examsyllabus").value=n.syllabus,void uT();if(uE=iE.includes("edit_test")?n.qid:n.id,jb("aq_mode").value=n.mode,WT("aq_qtext",n.title),jb("aq_yurl").value=n.y_url,jb("aq_type").value=n.type,jb("aq_hint").value=n.hint,jb("aq_section").value=n.section,jb("aq_posmrks").value=n.pm,jb("aq_negmrks").value=n.nm,WT("aq_expl",n.expl),"mcq"==n.type||"mcq_multiple"==n.type){jb("aq_mcq_con").innerHTML="";for(var i=0;i<n.op.length;i++){IT(),document.getElementsByClassName("aq_mcq")[i].value=n.op[i];for(var s=0;s<n.answer.length;s++)n.op[i]==n.answer[s]&&(document.getElementsByClassName("aq_mcq")[i].classList.add("aq_mcq_ans"),document.getElementsByClassName("aq_mcq_p")[i].style.borderColor="lime")}}else"numerical"!=n.type&&"explain"!=n.type&&"fill"!=n.type&&"taf"!=n.type||(jb("aq_answer").value=n.answer[0]);uT()}async function fT(t){var e,n;1==t?(e="topic",n=window.location.hash.split("edit_tpc/")[1],jb("fu_topic_title").innerText="Add/Edit Topic",jb("aq_mode").innerHTML='<option value="question">Question</option><option value="lesson">Lesson</option>',jb("aq_tpc_save").style.display="block",jb("aq_qbc_save").style.display="none",jb("aq_tst_save").style.display="none",jb("aq_test_extra").style.display="none",jb("aq_exam_save").style.display="none",jb("aq_exams").style.display="none",jb("aq_all").style.display="flex",jb("aq_ans_hold").style.display="flex"):2==t?(e="qbank",n=window.location.hash.split("edit_qubank/")[1],jb("fu_topic_title").innerText="Add/Edit QBank",jb("aq_mode").innerHTML='<option value="question">Question</option>',jb("aq_tpc_save").style.display="none",jb("aq_tst_save").style.display="none",jb("aq_test_extra").style.display="none",jb("aq_qbc_save").style.display="block",jb("aq_exam_save").style.display="none",jb("aq_exams").style.display="none",jb("aq_all").style.display="flex",jb("aq_ans_hold").style.display="flex"):3==t?(e="tests",n=window.location.hash.split("edit_tests/")[1],jb("fu_topic_title").innerText="Add/Edit Tests",jb("aq_mode").innerHTML='<option value="question">Question</option>',jb("aq_tpc_save").style.display="none",jb("aq_qbc_save").style.display="none",jb("aq_test_extra").style.display="flex",jb("aq_tst_save").style.display="block",jb("aq_exam_save").style.display="none",jb("aq_exams").style.display="none",jb("aq_all").style.display="flex",jb("aq_ans_hold").style.display="flex"):4==t&&(e="quarkz",n="exams",jb("fu_topic_title").innerText="Add/Edit Exams",jb("aq_mode").innerHTML='<option value="exam">Exam</option>',jb("aq_tpc_save").style.display="none",jb("aq_qbc_save").style.display="none",jb("aq_test_extra").style.display="none",jb("aq_exam_save").style.display="block",jb("aq_tst_save").style.display="none",jb("aq_exams").style.display="flex",jb("aq_all").style.display="none",jb("aq_ans_hold").style.display="none");try{let r=await hg(Qp(Rb,e,n));if(r.exists())if(1==t||2==t){var i=r.data();jb("aq_tpcname").value=i.name,jb("aq_tpclevel").value=i.level,jb("aq_tpc_subj").value=i.subject,jb("aq_tpc_chapterid").value=i.chid,hE=i.qllist,dT(0)}else if(3==t){i=r.data();function s(t){var e=new Date(t);return e.setMinutes(e.getMinutes()-e.getTimezoneOffset()),e.toISOString().slice(0,16)}jb("aq_tpcname").value=i.title,jb("aq_tpclevel").value=i.level,jb("aq_tpc_subj").value=i.subject,jb("aq_tst_batches").value=i.batch.toString(),jb("aq_tst_stron").value=s(1e3*i.strton.seconds),jb("aq_tst_endon").value=s(1e3*i.endon.seconds),jb("aq_tst_timealotted").value=i.timeallotted,jb("aq_tst_syllabi").value=i.syllabus;let o=await hg(Qp(Rb,"tests",n,"questions","questions")),a=await hg(Qp(Rb,"tests",n,"questions","answers")),c=[],l=[];if(o.exists())c=o.data().questions;if(a.exists())l=a.data().questions;hE=$b(c,l),dT(0)}else if(4==t){i=r.data();hE=i.examinfo,dT(0)}}catch{}}function pT(){for(var t=0;t<hE.length;t++)hE[t].qid!=uE&&hE.id!=uE||(hE.splice(t,1),dT(0),null==(uE=hE[t-1].qid||hE[t-1].id)&&(uE=""))}async function mT(t){for(var e=0;e<hE.length;e++)hE[e].qid!=uE&&hE.id!=uE||(hE[e]=lT());var n,i;if(1==t?(n="topic",i=window.location.hash.split("edit_tpc/")[1]):2==t?(n="qbank",i=window.location.hash.split("edit_qubank/")[1]):3==t?(n="tests",i=window.location.hash.split("edit_tests/")[1]):4==t&&(n="quarkz",i="exams"),1==t||2==t)try{await mg(Qp(Rb,n,i),{name:jb("aq_tpcname").value,qllist:hE,level:jb("aq_tpclevel").value,chid:jb("aq_tpc_chapterid").value,subject:jb("aq_tpc_subj").value})}catch{}else if(3==t){try{var s=new Date(jb("aq_tst_stron").value),r=new Date(jb("aq_tst_endon").value),o=jb("aq_tst_batches").value.split(",");await mg(Qp(Rb,n,i),{title:jb("aq_tpcname").value,timeallotted:jb("aq_tst_timealotted").value,syllabus:jb("aq_tst_syllabi").value,strton:s,endon:r,batch:o})}catch{}var a=[],c=[];for(e=0;e<hE.length;e++){var l=hE[e];a.push({qid:l.qid,mode:l.mode,title:l.title,type:l.type,op:l.op,op1:l.op1,op2:l.op2,section:l.section,pm:l.pm,nm:l.nm}),c.push({qid:l.qid,hint:l.hint,expl:l.expl,answer:l.answer,section:l.section,pm:l.pm,nm:l.nm})}try{await mg(Qp(Rb,n,i,"questions","questions"),{questions:a})}catch(t){Bb(t)}try{await mg(Qp(Rb,n,i,"questions","answers"),{questions:c})}catch{}}else if(4==t){await mg(Qp(Rb,n,i),{examinfo:hE})}}function gT(){window.location.hash="#/qbanks/"+atob(this.id.split("chpqbk")[1])}function yT(){window.location.hash="#/topic/"+atob(this.id.split("chptpc")[1])}async function vT(t){var e="",n="";1==t?(e="topic",n="topic"):2==t?(n="qbanks",e="qbank"):e="topic";var i=n+"/",s=window.location.hash.split(i)[1],r=Qp(Rb,e,s),o=await hg(r);if(!o.exists())throw Xb("error_page",1),new Error;var a=o.data();(sE={}).title=a.name,sE.qllist=a.qllist,kT(3)}function _T(){window.location.hash="#/chapter/"+atob(this.id.split("qb")[1])}function wT(t){jb("qb_cont_2").innerHTML="";for(var e=0;e<aE.length;e++){var n=aE[e];n.subject==t&&(jb("qb_cont_2").insertAdjacentHTML("beforeend",'<span class="tlinks rpl" style = "color:pink" id="qb'+btoa(n.id)+'">'+n.name+"</span>"),jb("qb"+btoa(n.id)).addEventListener("click",_T))}}async function bT(t){var e="";1==t?(e="qbank",jb("pe_tst_info").style.display="flex",jb("eqb_instr").style.display="none"):2==t?(e="topic",jb("pe_tst_info").style.display="none",jb("eqb_instr").style.display="none"):e=3==t?"tests":"qbank";var n,i,s,r,o=window.location.hash.split("printable/"+e+"/")[1],a=jb("qb_title"),c=Qp(Rb,e,o),l=await hg(c);if(!l.exists())throw Xb("error_page",1),new Error;n=(b=l.data()).qllist,a.innerText=b.name,jb("eqb_add").innerHTML="";for(let t of n)if("question"==t.mode){i=(b=t).title,s=b.type,null==(r=b.img)&&(r="");var u='<div class = "q_ans_expl" style = "font-weight:bold;color:green;font-size:10px;flex-direction:row;display:none;">Explaination:'+b.expl+"</div>",h="<div style = 'font-weight:bold;color:green;font-size:10px;flex-direction:row;display:none' class = 'q_ans_1'>Answer:",d='<div class = "qbtp_q"><div id = "'+t.id+'">'+i+'<div class = "qb_q_ty">('+s+")</div></div>";if(jb("eqb_add").insertAdjacentHTML("beforeend",d),""!=r){var f='<div class = "qb_img"><img src = "'+r+'"></div>';jb(t.id).insertAdjacentHTML("beforeend",f)}var p="";if("mcq"==s||"mcq_multiple"==s){var m=b.op;for(let t of m)p+="<div class = 'qb_mcq_opt'>"+t+"</div>";var g='<div class = "qb_mcq_exp" type = "a">'+p+"</div>";for(let t of b.answer)h+="<div class = 'qb_mcq_ans'>"+t+"</div>"}if("taf"==s&&(g='<ol class = "qb_mcq_exp" type = "a"><li>True</li><li>False</li></ol>'),"explain"!=s&&"numerical"!=s&&"fill"!=s||(g=""),"matrix"==s){for(var y=b.op1,v=b.op2,_=y.length,w=0;w<_;w++)p+="<tr><td>"+y[w]+"</td><td>"+v[w]+"</td>";g="<table>"+p+"</table>"}jb(t.id).insertAdjacentHTML("beforeend",g),jb(t.id).insertAdjacentHTML("beforeend",h+"</div>"),jb(t.id).insertAdjacentHTML("beforeend",u),renderMathInElement(jb("eqb_add"))}else if("lesson"==t.mode){var b;i=(b=t).title,s=b.type,r=b.img;d='<div class = "les_q"><div id = "'+t.id+'"><div style = "font-size:3vh;">'+i+'</div><hr color="white" width="100%"></div>';jb("eqb_add").insertAdjacentHTML("beforeend",d);u='<div class = "les_expl" style = "">'+b.expl+'</div><hr color="white" width="100%">';jb(t.id).insertAdjacentHTML("beforeend",u),renderMathInElement(jb("eqb_add"))}jb("printable").insertAdjacentHTML("beforeend","<br></br>")}function TT(t){1==t?jb("mainsformulas").innerHTML='\n    <span style="font-size: 5vh;color:yellow" id="fm_title">Mains Formula Sheet</span>\n    <hr color="white" width="100%">\n    <div style="overflow-y: scroll;height:50vh;" class="flex_type">\n    <span class="tlinks rpl" onclick = "window.location.hash = \'/notes/PHYFORMULAS\'">Physics Formula Sheet</span>\n    <span class="tlinks rpl" onclick = "window.location.hash = \'/notes/MATHFORMULAS\'">Maths Formula Sheet</span>\n    <span class="tlinks rpl" onclick = "window.location.hash = \'/notes/PCHEMNOTES\'">Physical Chemistry Formula Sheet</span>\n    <span class="tlinks rpl" onclick = "window.location.hash = \'/notes/OCHEMNOTES\'">Organic Chemistry Formula Sheet</span>\n    <span class="tlinks rpl" onclick = "window.location.hash = \'/notes/ICHEMNOTES\'">Inorganic Chemistry Formula Sheet</span>\n    </div>\n    <span style="font-size: 8px;">All PDF\'s Are Owned by their Respective Owners</span>\n    ':2==t&&(jb("downloads").innerHTML='\n    <span style="font-size: 5vh;color:yellow" id="fm_title">Downloads</span>\n    <hr color="white" width="100%">\n    <div style="overflow-y: scroll;height:50vh;" class="flex_type">\n      \n    </div>\n    ')}async function ET(t){var e;jb("tp_question").style.display="none",jb("tp_lesson").style.display="block",""==t.y_url?jb("tp_full_vid").style.display="none":(jb("tp_full_vid").style.display="flex",e=t.y_url,window.player.loadVideoById(e)),jb("tp_lsno").innerText=t.title,jb("tp_expl").innerHTML=t.expl}async function kT(t){var e;e=1==t?-1:1,(rE<sE.qllist.length&&2==t||1==t&&rE>0)&&(rE+=e),3==t&&(rE=0);var n=sE.title;jb("tp_title").innerText=n;var i=sE.qllist[rE];"lesson"==i.mode?ET(i):"question"==i.mode&&async function(t,e){function n(t){t.style.display="none"}function i(t){t.style.display="block"}function s(t){t.style.display="flex"}n(jb("tp_hint")),n(jb("tp_a_expl")),n(jb("tp_e_answer")),n(jb("tp_status"));var r=jb("tp_mcq_con"),o=jb("tp_matrix"),a=jb("tp_answer");if(jb("tp_lsno").innerText="Question",jb("tp_question").style.display="flex",jb("tp_lesson").style.display="none",jb("tp_question").setAttribute("dataid",t.id),jb("tp_question").setAttribute("qtype",t.type),r.innerHTML="",jb("tp_qtext").innerHTML=t.title,jb("tp_img").src="","mcq"==t.type||"mcq_multiple"==t.type){s(r),n(o),n(a);var c=t.op,l="";for(let t of c)l+='<div class="tp_mcq_p rpl" onclick = "mcqchose(this)">'+t+"</div>";jb("tp_mcq_con").insertAdjacentHTML("beforeend",l)}else if("matrix"==t.type){n(r),i(o),n(a);for(var u=t.op1,h=t.op2,d=u.length,f=0;f<d;f++)document.getElementsByClassName("tp_i1")[f].innerText=u[f];for(f=0;f<d;f++)document.getElementsByClassName("tp_i2")[f].innerText=h[f]}else"numerical"==t.type||"fill"==t.type?(n(r),n(o),i(a)):"taf"==t.type?(s(r),n(o),n(a),l='<div class="tp_mcq_p rpl">True</div><div class="tp_mcq_p rpl">False</div>',jb("tp_mcq_con").insertAdjacentHTML("beforeend",l)):(n(r),n(o),n(a));renderMathInElement(jb("tp_ans_hold")),renderMathInElement(jb("tp_qtext"))}(i),KT()}function IT(){jb("aq_mcq_con").insertAdjacentHTML("beforeend",'<div class="aq_mcq_p" onclick="changeColor(this)"><input class="aq_mcq"></div>')}function AT(){document.getElementsByClassName("aq_mcq_p")[document.getElementsByClassName("aq_mcq").length-1].remove()}function CT(){for(var t=jb("eqb_add"),e=t.children.length;e>=0;e--)t.appendChild(t.children[Math.random()*e|0])}function ST(){On(qb,QT.email).then((()=>{Bb("Success","Password Reset Email sent.")})).catch((t=>{t.code;Bb("Failure",t.message)}))}async function xT(t){jb("prf_pphoto");var e,n,i=jb("prf_name"),s=jb("prf_phone"),r=jb("prf_email"),o=jb("prf_class"),a=jb("prf_batch"),c=jb("prf_gender"),l=jb("prf_crton"),u=jb("tmt_frame"),h=jb("spoints");if(t){var d=Qp(Rb,"users",t.uid);if((g=await hg(d)).exists()){var f=g.data();(QT=f).uuid=t.uid,jb("dshd_uname").innerText=f.email,jb("dshd_name").innerText=f.name,i.textContent=f.name,s.textContent=f.mblno,r.textContent=f.email,o.textContent=f.class,l.textContent=new Date(1e3*f.sgndon.seconds).toDateString(),c.textContent=f.gen,e=f.batch,f.course,h.textContent=f.spoints,JT=f.roles.user,XT=f.roles.editor,YT=f.roles.admin,QT.usernotes=f.usernotes,null==f.usernotes&&(QT.usernotes=[])}1==f.deleted&&(Bb("Warning","User Account Has Been Deleted"),Wb()),"Male"==f.gen?(jb("prf_tab_img").classList.remove("prf_male","prf_female"),jb("prf_tab_img").classList.add("prf_male"),jb("prf_tab_t_t_img").classList.remove("prf_male","prf_female"),jb("prf_tab_t_t_img").classList.add("prf_male")):"Female"==f.gen&&(jb("prf_tab_img").classList.remove("prf_male","prf_female"),jb("prf_tab_img").classList.add("prf_female"),jb("prf_tab_t_t_img").classList.remove("prf_male","prf_female"),jb("prf_tab_t_t_img").classList.add("prf_female"));try{d=Qp(Rb,"batch",e);if((g=await hg(d)).exists()){f=g.data();a.textContent=f.name,jb("dshd_batch").innerText=f.name,n=f.timetable,async function(t,e){if(fE!=[]){var n=Qp(Rb,"batch",t,"info","tests"),i=await hg(n);if(i.exists()){var s=i.data();fE=s.tests}}if(gE!=[]){const t=Km(Wp(Rb,"tests"),Wm("finished","array-contains",e),Zm(5));(await fg(t)).forEach((t=>{var e=t.data(),n={title:e.title,testid:t.id,finished:!0,strton:e.strton,endon:e.endon};gE.push(n);var i=0;for(let t of fE)t.testid==n.testid?fE[i].finished=!0:fE[i].finished=!1,i+=1}))}for(var r=parseInt(Date.now()/1e3),o=0;o<fE.length;o++)r>fE[o].strton.seconds&&r<fE[o].endon.seconds?pE.push(fE[o]):r<fE[o].strton.seconds&&mE.push(fE[o])}(e,t.uid);var p="https://calendar.google.com/calendar/embed??height=600&wkst=2&bgcolor=%23ffffff&ctz=Asia%2FKolkata&showTitle=0&showCalendars=0&showTabs=0&showPrint=0&showDate=1&src="+n+"%40group.calendar.google.com&amp;ctz=Asia%2FKolkata";if(u.src=p,f.delon.seconds<=parseInt(Date.now()/1e3))throw Bb("Warning","This Batch Has Been Deleted"),Wb(),window.reload(),new Error("DENIED");for(var m=0;m<f.chlist.length;m++)aE.push({name:f.chlist[m].name,id:f.chlist[m].id,subject:f.chlist[m].subject})}}catch{}jb("lg_uname").value="",jb("lg_pass").value="",h.style.display="block",jb("dsh_btn").style.display="block",""!=window.location.hash&&null!=window.location.hash&&null!=window.location.hash||(window.location.hash="#/dashboard",dE=1);var g;d=Qp(Rb,"quarkz","exams");if((g=await hg(d)).exists()){f=g.data();jb("db_exam_list").innerHTML="",""!=f.warning&&Bb("Notice",f.warning,(function(){window.location.hash="#/usernotes/releasenotes"}),"Release Notes");for(m=0;m<f.examinfo.length;m++){var y=f.examinfo[m];jb("db_exam_list").insertAdjacentHTML("beforeend",'<div class = "tlinks_min rpl"><span style="font-size: 16px;" onclick = "examlog(\''+y.name+"','"+y.date+"','"+y.info+"','"+y.syllabus+"')\">"+y.name+"</span></div>")}}Xb(window.location.hash.split("#/")[1],1),async function(){for(var t=0;t<QT.usernotes.length;t++)jb("un_list").insertAdjacentHTML("beforeend","<div class='t_notes' id='uno"+QT.usernotes[t].id+"' style='background-color: "+QT.usernotes[t].color+"'><span class='tntc2' id='"+QT.usernotes[t].id+"'>"+QT.usernotes[t].title+"</span></div>"),jb("uno"+QT.usernotes[t].id).addEventListener("click",Zb)}()}else i.textContent="",s.textContent="",r.textContent="",o.textContent="",h.textContent="",h.style.display="none",jb("dsh_btn").style.display="none",jb("tp_pnt").style.display="none",jb("tp_edt").style.display="none",Xb("login",1),1==dE&&document.location.reload()}function NT(){for(var t,e,n,i,s=jb("tp_question").getAttribute("dataid"),r=jb("tp_question").getAttribute("qtype"),o=0;o<sE.qllist.length;o++)if(sE.qllist[o].id==s){e=sE.qllist[o].answer,n=sE.qllist[o].expl,i=sE.qllist[o].hint;break}if("numerical"!=r&&"fill"!=r||(e==(t=jb("tp_answer").value)?(jb("tp_status").innerText="Correct Answer",1):(jb("tp_status").innerText="Wrong Answer",0)),"mcq"==r||"mcq_multiple"==r||"taf"==r){t=[];for(var a=0;a<document.getElementsByClassName("tp_mcq_p").length;a++)document.getElementsByClassName("tp_mcq_p")[a].classList.contains("aq_mcq_ans")&&t.push(document.getElementsByClassName("tp_mcq_p")[a].innerText);Pb(t,e)?(jb("tp_status").innerText="Correct Answer",1):(jb("tp_status").innerText="Wrong Answer",0)}jb("tp_status").style.display="block",jb("tp_hint").style.display="block",jb("tp_a_expl").style.display="block",jb("tp_e_answer").style.display="block",jb("tp_a_expl").innerHTML=n,jb("tp_hint").innerHTML=i,jb("tp_e_answer").innerHTML="Answer:"+e}function RT(){window.location.hash.includes("topic")?LT("printable/topic/"+window.location.hash.split("topic/")[1],1):window.location.hash.includes("qbanks")&&LT("printable/qbank/"+window.location.hash.split("qbanks/")[1],1),window.location.hash.includes("edit_tpc/")?LT("printable/topic/"+window.location.hash.split("edit_tpc/")[1],1):window.location.hash.includes("edit_qubank/")&&LT("printable/qbank/"+window.location.hash.split("edit_qubank/")[1],1)}function qT(){window.location.hash.includes("topic")?LT("edit_tpc/"+window.location.hash.split("topic/")[1],1):window.location.hash.includes("qbanks")&&LT("edit_qubank/"+window.location.hash.split("qbanks/")[1],1)}function LT(t,e){window.location.hash="#/"+t,"dashboard"==t&&Xb("dashboard",1)}function DT(){window.location.hash="#/instructions/"+this.id}function OT(){window.location.hash="#/finished/"+this.id}function MT(t){var e;for(var n of("active"==t?e=pE:"upcoming"==t?e=mE:"finished"==t&&(e=gE),jb("testlinks").innerHTML="",e)){var i=new Date(1e3*n.strton.seconds),s=new Date(1e3*n.endon.seconds),r='<div class="tlinks" id = "'+n.testid+'"><span class = "t_title">'+n.title+'</span><span class = "t_stron">Starts At:'+i+'</span><span class ="t_endon">Ends At:'+s+"</div>";"finished"!=t&&0==n.finished?(jb("testlinks").insertAdjacentHTML("beforeend",r),jb(n.testid).addEventListener("click",DT)):"finished"==t&&(jb("testlinks").insertAdjacentHTML("beforeend",r),jb(n.testid).addEventListener("click",OT))}}async function PT(t){var e;if(1==t){var n=window.location.hash.split("/finished/")[1],i=Qp(Rb,"tests",n,"questions","questions"),s=await hg(i);s.exists()&&(e=s.data().questions)}else 2==t&&(e=[],e=_E);for(var r={},o=0;o<TE.length;o++)TE[o].time=TE[o].time.seconds;var a,c,l,u,h,d,f=(a="time",c="type",0==(l=0)?u=(t,e)=>(n,i)=>n[t]===i[t]?n[e]>i[e]?1:-1:n[t]>i[t]?1:-1:1==l&&(u=(t,e)=>(n,i)=>n[t]===i[t]?n[e]>i[e]?-1:1:n[t]>i[t]?-1:1),TE.sort(u(a,c))),p="";for(o=0;o<f.length;o++)"b"==f[o].type?(h=f[o].time,p=f[o].value):"a"==f[o].type&&p==f[o].value&&(d=f[o].time,null==r[f[o].value]&&(r[f[o].value]={},r[f[o].value].time=0),r[f[o].value].time+=d-h,h=d,d=0);var m={Physics:{correct:0,unattempted:0,incorrect:0,total:0},Chemistry:{correct:0,unattempted:0,incorrect:0,total:0},Math:{correct:0,unattempted:0,incorrect:0,total:0},Biology:{correct:0,unattempted:0,incorrect:0,total:0},Computer:{correct:0,unattempted:0,incorrect:0,total:0},Statistics:{correct:0,unattempted:0,incorrect:0,total:0},Unfiled:{correct:0,unattempted:0,incorrect:0,total:0}},g=0,y=0,v=0;for(o=0;o<e.length;o++)for(var _=0;_<ZT.length;_++)if(e[o].qid==ZT[_].qid){var w=r[e[o].qid];null==r[e[o].qid]?(r[e[o].section]={},r[e[o].section].time=0):(m[e[o].section].total+=w.time,0==ZT[o].marks?(m[e[o].section].unattempted+=w.time,v+=w.time):ZT[o].marks==e[o].pm?(m[e[o].section].correct+=w.time,g+=w.time):(m[e[o].section].incorrect+=w.time,y+=w.time))}tE={questions:r,subject:m,correct:g,incorrect:y,unattempted:v}}function UT(){VT(this.id,this.innerText)}async function FT(t){var e,n=[],i=[],s=[],r="";window.location.hash.includes("/attempt/")?(r=window.location.hash.split("#/attempt/")[1],Bb("Warning","Submitting Tests Answers: Please Do Not Close The Tab.")):window.location.hash.includes("/finished/")?r=window.location.hash.split("#/finished/")[1]:window.location.hash.includes("/testreport/")&&(r=window.location.hash.split("#/testreport/")[1]);var o=Qp(Rb,"tests",r,"responses",qb.currentUser.uid),a=await hg(o);if(a.exists()){var c=a.data().answers;for(var l in s=a.data().info,c)n.push({qid:l,ans:c[l].ans,type:c[l].type,time:c[l].time})}o=Qp(Rb,"tests",r,"questions","answers"),(a=await hg(o)).exists()&&(e=a.data().questions);for(var u=0,h=0,d=0,f={Physics:{correct:0,unattempted:0,incorrect:0,total:0},Chemistry:{correct:0,unattempted:0,incorrect:0,total:0},Math:{correct:0,unattempted:0,incorrect:0,total:0},Biology:{correct:0,unattempted:0,incorrect:0,total:0},Computer:{correct:0,unattempted:0,incorrect:0,total:0},Statistics:{correct:0,unattempted:0,incorrect:0,total:0},Unfiled:{correct:0,unattempted:0,incorrect:0,total:0}},p=0;p<e.length;p++)for(var m=0;m<n.length;m++)if(e[p].qid==n[m].qid){var g=n[m];null==g.ans&&(g.ans=[]),0==g.ans.length?(i.push({qid:e[p].qid,marks:0,type:"unattempted"}),u+=parseFloat(e[p].pm),f[e[p].section].unattempted+=parseFloat(e[p].pm),f[e[p].section].total+=parseFloat(e[p].pm)):Pb(e[p].answer,g.ans)?(i.push({qid:e[p].qid,marks:parseFloat(e[p].pm),type:"correct"}),h+=parseFloat(e[p].pm),f[e[p].section].correct+=parseFloat(e[p].pm),f[e[p].section].total+=parseFloat(e[p].pm)):(i.push({qid:e[p].qid,marks:parseFloat(e[p].nm),type:"incorrect"}),d+=parseFloat(e[p].nm),f[e[p].section].incorrect+=parseFloat(e[p].nm),f[e[p].section].total+=parseFloat(e[p].pm))}var y={correct:h,incorrect:d,unattempted:u,mList:i,total:f.Physics.total+f.Chemistry.total+f.Math.total+f.Biology.total+f.Computer.total+f.Statistics.total+f.Unfiled.total,usermarks:h+d,subjectmarks:f};1==t?Ub(y,s)||(Bb("NOTICE","Please Wait, Marks Are Being Updated"),await mg(Qp(Rb,"tests",r,"responses",qb.currentUser.uid),{info:y}),await mg(Qp(Rb,"tests",r,"responses","finished"),{leaderboard:Tg({uid:QT.uuid,marks:y.usermarks,name:QT.name})}),Xb()):0==t&&(await mg(Qp(Rb,"tests",r,"responses",qb.currentUser.uid),{info:y}),await mg(Qp(Rb,"tests",r,"responses","finished"),{leaderboard:Tg({uid:QT.uuid,marks:y.usermarks,name:QT.name})}),Xb("testend",1)),document.getElementById("msg_popup").style.visibility="hidden",document.getElementById("msg_popup").style.opacity="0"}function VT(t,e){var n=new Date;vE=0,window.location.hash.includes("/attempt/")&&bE!=t&&TE.push({type:"a",time:n,value:bE}),jb("tt_qno").innerText=e;try{jb(bE).style.border=""}catch{}bE=t,window.location.hash.includes("/attempt/")&&TE.push({type:"b",time:n,value:bE}),jb(bE).style.border="purple 3px solid";for(let e of _E.questions)if(t==e.qid){jb("tt_qtitle").innerHTML="";var i='<div class = "qb_q" id = "Q'+e.qid+'"><div class = "qb_ttl">'+e.title+'<div id = "qb_q_ty" class = "qb_q_ty qb_qt_ty" >('+e.type+")</div></div></div>";jb("tt_qtitle").insertAdjacentHTML("beforeend",i);var s,r,o="";if("mcq"==e.type){var a=e.op;for(let t of a)o+='<li><input type="radio" class = "q_ans" value = "'+t+'" name = "q_op">'+t+"</input></li>";var c='<ol class = "qb_mcq" type = "A">'+o+"</ol>"}if("mcq_multiple"==e.type){a=e.op;for(let t of a)o+='<li><input type="checkbox" class = "q_ans" value = "'+t+'" name = "q_op">'+t+"</input></li>";c='<ol class = "qb_mcq" type = "A">'+o+"</ol>"}if("taf"==e.type&&(c='<ol class = "qb_mcq" type = "A"><li>True</li><li>False</li></ol>'),"explain"!=e.type&&"numerical"!=e.type||(c=""),"matrix"==e.type){for(var l=e.op1,u=e.op2,h=l.length,d=0;d<h;d++)o+="<tr><td>"+l[d]+"</td><td>"+u[d]+"</td>";c="<table>"+o+"</table>"}switch(jb("tt_qtitle").insertAdjacentHTML("beforeend",c),e.type){case"mcq":case"mcq_multiple":s="";break;case"taf":s='<div id = "tt_mcq"><span><input type="radio" value="a" class = "q_ans" name = "q_op">True</span><span><input type="radio" value="b" class = "q_ans" name = "q_op">False</span></div> ';break;case"numerical":s='<div id = "tt_num"><input type = "number" class="q_ans"></div>';break;case"matrix":s='<div id = "tt_matrix"><div>A<span><input type="checkbox" value="a" id="q_ans_a" name = "q_op">1</span><span><input type="checkbox" value="b" id="q_ans_a" name = "q_op">2</span><span><input type="checkbox" value="c" id="q_ans_a" name = "q_op">3</span><span><input type="checkbox" value="d" id="q_ans_a" name = "q_op">4</span></div><div>B<span><input type="checkbox" value="a" id="q_ans_a" name = "q_op">1</span><span><input type="checkbox" value="b" id="q_ans_a" name = "q_op">2</span><span><input type="checkbox" value="c" id="q_ans_a" name = "q_op">3</span><span><input type="checkbox" value="d" id="q_ans_a" name = "q_op">4</span></div><div>C<span><input type="checkbox" value="a" id="q_ans_a" name = "q_op">1</span><span><input type="checkbox" value="b" id="q_ans_a" name = "q_op">2</span><span><input type="checkbox" value="c" id="q_ans_a" name = "q_op">3</span><span><input type="checkbox" value="d" id="q_ans_a" name = "q_op">4</span></div><div>D<span><input type="checkbox" value="a" id="q_ans_a" name = "q_op">1</span><span><input type="checkbox" value="b" id="q_ans_a" name = "q_op">2</span><span><input type="checkbox" value="c" id="q_ans_a" name = "q_op">3</span><span><input type="checkbox" value="d" id="q_ans_a" name = "q_op">4</span></div></div>';break;case"fill":s='<div id="tt_fill"><input type = "text" class = "q_ans"></div>'}if(jb("tt_qtitle").insertAdjacentHTML("beforeend",s),!window.location.hash.includes("attempt"))for(let e of EE.questions)if(t==e.qid){r=e.answer,null!=tE&&(null==tE.questions[e.qid]?jb("tt_timespent").innerText="0 seconds":jb("tt_timespent").innerText=Mb(tE.questions[e.qid].time));var f='<div id="tg_answer">Answer: '+e.answer+'</div><div id="tg_expl">Explanation: '+e.expl+"</div>";jb("tt_qtitle").insertAdjacentHTML("beforeend",f)}renderMathInElement(jb("tt_qtitle"));for(let n of wE)if(n.qid==t){for(d=0;d<document.getElementsByClassName("q_ans").length;d++){var p=document.getElementsByClassName("q_ans")[d];if("mcq"==e.type||"mcq_multiple"==e.type){null==n.ans&&(n.ans=[]);for(let t of n.ans)if(p.value==t){p.checked=!0,1;break}}else p.value=n.ans,1}window.location.hash.includes("attempt")||(Pb(n.ans,r)?jb("tt_marksaward").innerHTML='<div style="color:lime">Correct(+4)</div>':0==n.ans.length?jb("tt_marksaward").innerHTML='<div style="color:orange">Unanswered(0)</div>':jb("tt_marksaward").innerHTML='<div style="color:red">Incorrect(-1)</div>')}for(var m=0;m<wE.length;m++)wE[m].qid==bE&&"tts_notvisit"==wE[m].type&&window.location.hash.includes("attempt")&&(wE[m].type="tts_notanswer",BT("tts_notanswer"),wE[m].ans=[],jb(bE).classList.remove("tts_notanswer","tts_notvisit","tts_answered","tts_review","tts_ansreview"),jb(bE).classList.add("tts_notanswer"));break}}function jT(){var t=1;for(let t of["tw_Physics","tw_Chemistry","tw_Math","tw_Computer","tw_Statistics","tw_Biology","tw_Unfiled"])jb(t+"_c").innerHTML="",jb(t).style.display="none";for(let n of _E.questions){var e='<span class = "tts_notvisit" id = "'+n.qid+'">'+t+"</span>";t+=1,jb("tw_"+n.section+"_c").insertAdjacentHTML("beforeend",e),jb("tw_"+n.section).style.display="flex",jb(n.qid).addEventListener("click",UT)}if(window.location.hash.includes("attempt"))jb("tt_sub").style.display="block";else{for(let t of wE){var n=t.qid;for(let e of EE.questions)if(n==e.qid){var i=e.answer;null==t.ans&&(t.ans=[]),Pb(t.ans,i)?jb(n).classList.add("t_crr"):0==t.ans.length?jb(n).classList.add("t_unat"):jb(n).classList.add("t_incrr")}}PT(2)}for(let t of wE)jb(t.qid).classList.replace("tts_notvisit",t.type);VT(_E.questions[0].qid,1)}async function BT(t){if(!window.location.hash.includes("attempt"))return Bb("Error","Performing Test Operations in Test Reports Is Prohibited"),1;var e="answers."+bE,n=window.location.hash.split("#/attempt/")[1],i=jb("qb_q_ty").innerText.split("(")[1];if("tts_notanswer"==t){await mg(Qp(Rb,"tests",n,"responses",qb.currentUser.uid),{[`${e}`]:{ans:"",type:"tts_notanswer",time:bg()}});var s=0;for(let t of wE){if(t.qid==bE){for(var r=0;r<document.getElementsByClassName("q_ans").length;r++){var o=document.getElementsByClassName("q_ans")[r];if("mcq"==i||"mcq_multiple"==i)for(var a=0;a<t.ans.length;a++){var c=t.ans[a];o.value==c&&(o.checked=!1)}else t.value=""}wE.splice(s,1)}s+=1}}else{var l=[];for(r=0;r<document.getElementsByClassName("q_ans").length;r++){o=document.getElementsByClassName("q_ans")[r];"mcq)"==i||"mcq_multiple)"==i?1==o.checked&&l.push(o.value):l.push(o.value)}"tts_review"==t&&(l=""),await mg(Qp(Rb,"tests",n,"responses",qb.currentUser.uid),{[`${e}`]:{ans:l,type:t,time:bg()}});var u=0;for(let e of wE)e.qid==bE&&(e.ans=l,e.type=t,u=1);0==u&&wE.push({qid:bE,ans:l,type:t})}jb(bE).classList.remove("tts_notanswer","tts_notvisit","tts_answered","tts_review","tts_ansreview"),jb(bE).classList.add(t)}async function $T(){if(!window.location.hash.includes("attempt"))return Bb("Error","Performing Test Operations in Test Reports Is Prohibited"),1;var t=new Date;TE.push({type:"a",time:t,value:bE}),TE.push({type:"end",time:t,value:"1"});var e=window.location.hash.split("#/attempt/")[1];window.onbeforeunload=function(){},window.onhashchange=Xb,await mg(Qp(Rb,"tests",e,"responses",qb.currentUser.uid),{endon:bg(),actions:TE,warning:[]}).then((function(){wE=[]})),await mg(Qp(Rb,"tests",e,"responses","finished"),{finished:Tg(qb.currentUser.uid)}).then(FT(0));var n=new Date(1e3*yE.endon.seconds);jb("te_endtime").innerText=n,fE=[],pE=[],mE=[],gE=[],yE=[],_E=[],bE="",jb("dsh_btn").style.display="block",jb("tp_pnt").style.display="none",clearInterval(nT)}function HT(t){1==t?(document.getElementById("msg_popup").style.visibility="hidden",document.getElementById("msg_popup").style.opacity="0"):0==t&&Bb("WARNING","You Are Currently Offline.")}function zT(){"preview"==jb("un_rendermode").value?(jb("un_preview").style.display="block",jb("un_preview").innerHTML="<h1 style = 'text-align:center'>"+jb("un_title").value+"</h1><br>"+GT("un_editable"),jb("un_edit").style.display="none"):"edit"==jb("un_rendermode").value&&(jb("un_edit").style.display="flex",jb("un_preview").style.display="none");try{jb("uno"+window.location.hash.split("usernotes/")[1]).style.backgroundColor=jb("un_colorpicker").value}catch{}}function KT(){try{window.player.stopVideo()}catch{}}function GT(t){return $("#"+t).summernote("code")}function WT(t,e){$("#"+t).summernote("code",e)}eT(),async function(){var t=Qp(Rb,"forum","pinned"),e=await hg(t);if(e.exists()){t=e.data();jb("pinnedtxt").innerText=t.message}}(),window.onbeforeunload=function(t){updatePoints()},window.addEventListener("online",(()=>HT(1))),window.addEventListener("offline",(()=>HT(0))),jb("te_title").innerText="The Test Has Ended",$(document).ready((function(){$(".summernote").summernote({toolbar:[["style",["style"]],["font",["bold","italic","underline","clear"]],["fontname",["fontname"]],["color",["color"]],["para",["ul","ol","paragraph"]],["height",["height"]],["table",["table"]],["insert",["link","picture","hr"]],["view",["fullscreen","codeview"]],["help",["help"]]]})}));var QT,XT,YT,JT,ZT,tE,eE={copyright:"Mr Techtroid 2021-23",vno:"v0.4.1",author:"Mr Techtroid","last-updated":"10/02/2023(IST)",serverstatus:"firebase-online"},nE="login",iE=window.location.hash.split("#/")[1],sE={},rE=0,oE=[],aE=[],cE=[],lE=0,uE="",hE=[],dE=0,fE=[],pE=[],mE=[],gE=[],yE=[],vE=0,_E=[],wE=[],bE="",TE=[],EE=[];window.onhashchange=Xb,function(t,e,n,i){z(t).onAuthStateChanged(e,n,i)}(cs(),xT),function(){function t(){Bb("Note","By Clicking on 'Accept And Register' you agree that you accept all Terms And Conditions and Privacy Policy of Quarkz!",Qb,"Accept And Register")}jb("sim_btn").addEventListener("click",(function(){LT("simlist")})),jb("sgn_in").addEventListener("click",Gb),jb("reg_in").addEventListener("click",(function(){LT("register")}));var t=jb("rg_in").addEventListener("click",t);jb("lgt_btn").addEventListener("click",Wb),jb("tmt_btn").addEventListener("click",(function(){LT("timetable")})),jb("prf_btn").addEventListener("click",(function(){LT("profile")})),jb("abt_btn").addEventListener("click",(function(){LT("about")})),jb("shf_btn").addEventListener("click",CT),jb("aq_ao").addEventListener("click",IT),jb("aq_ro").addEventListener("click",AT),jb("aq_re").addEventListener("click",pT),jb("aq_mode").addEventListener("change",uT),jb("aq_type").addEventListener("change",uT),jb("dsh_btn").addEventListener("click",(function(){LT("dashboard")})),jb("adi_btn").addEventListener("click",(function(){LT("functions")})),jb("aq_tpc_save").addEventListener("click",(function(){mT(1)})),jb("aq_qbc_save").addEventListener("click",(function(){mT(2)})),jb("aq_tst_save").addEventListener("click",(function(){mT(3)})),jb("aq_exam_save").addEventListener("click",(function(){mT(4)})),jb("un_save").addEventListener("click",Yb),jb("un_print").addEventListener("click",Jb),jb("tstinf_btn").addEventListener("click",(function(){LT("testinfo")})),jb("tpc_btn").addEventListener("click",(function(){LT("tpclist")})),jb("usc_btn").addEventListener("click",(function(){LT("users")})),jb("lvq_btn").addEventListener("click",(function(){LT("livequiz")})),jb("frm_btn").addEventListener("click",(function(){LT("forum")})),jb("tp_nxt").addEventListener("click",(function(){kT(2)})),jb("tp_prv").addEventListener("click",(function(){kT(1)})),jb("tp_sbm").addEventListener("click",NT),jb("lgl_btn").addEventListener("click",(function(){LT("legal")})),jb("qba_btn").addEventListener("click",(function(){LT("qblist")})),jb("tp_pnt").addEventListener("click",RT),jb("aq_export").addEventListener("click",RT),jb("tp_edt").addEventListener("click",qT),jb("cyb_btn").addEventListener("click",(function(){LT("cyberhunt")})),jb("ti_act").addEventListener("click",(function(){MT("active")})),jb("ti_upc").addEventListener("click",(function(){MT("upcoming")})),jb("ti_fin").addEventListener("click",(function(){MT("finished")})),jb("tt_save").addEventListener("click",(function(){BT("tts_answered")})),jb("tt_clear").addEventListener("click",(function(){BT("tts_notanswer")})),jb("tt_review").addEventListener("click",(function(){BT("tts_review")})),jb("tt_ansreview").addEventListener("click",(function(){BT("tts_ansreview")})),jb("psims").addEventListener("click",(function(){cT("physics")})),jb("csims").addEventListener("click",(function(){cT("chemistry")})),jb("msims").addEventListener("click",(function(){cT("maths")})),jb("bsims").addEventListener("click",(function(){cT("biology")})),jb("cosims").addEventListener("click",(function(){cT("computer")})),jb("ssims").addEventListener("click",(function(){cT("statistics")})),jb("usims").addEventListener("click",(function(){cT("unfiled")})),jb("pchb").addEventListener("click",(function(){wT("physics")})),jb("cchb").addEventListener("click",(function(){wT("chemistry")})),jb("mchb").addEventListener("click",(function(){wT("maths")})),jb("bchb").addEventListener("click",(function(){wT("biology")})),jb("cochb").addEventListener("click",(function(){wT("computer")})),jb("schb").addEventListener("click",(function(){wT("statistics")})),jb("uchb").addEventListener("click",(function(){wT("unfiled")})),jb("tt_sub").addEventListener("click",(function(){var t,e,n,i;t="Warning",e="Are You Sure You Want To End The Test",n=$T,i="Yes,Submit",jb("t1_msg_popup").style.visibility="visible",jb("t1_msg_popup").style.opacity="1",jb("t1_msg_action").style.display="none",document.getElementById("t1_msg_popup_txt").innerText=t,document.getElementById("t1_msg_popup_content").innerText=e,null==n?n=function(){}:jb("t1_msg_action").style.display="block",null==i&&(i=""),jb("t1_msg_action").onclick=n,jb("t1_msg_action").innerText=i})),jb("chp_btn").addEventListener("click",(function(){LT("chplist")})),jb("pass_rst_btn").addEventListener("click",ST),jb("aq_sims_save").addEventListener("click",oT),jb("un_rendermode").addEventListener("change",zT),jb("un_viewership").addEventListener("change",zT),jb("un_print").addEventListener("click",(function(){jb("un_preview").style.display="none",jb("un_preview").innerHTML="<h1 style = 'text-align:center;margin:0px'>"+jb("un_title").value+"</h1><br>"+GT("un_editable"),window.idElementPrint(jb("un_preview"),QT.name)})),jb("qbnk_vid_btn_e").addEventListener("click",(function(){jb("watermark").style.display="flex",Vb(jb("qbnk_vid"))})),jb("qbnk_vid_btn").addEventListener("click",(function(){rT()}))}();
//# sourceMappingURL=index.77bfcba3.js.map
